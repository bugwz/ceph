...
template<class Iter_type> bool is_eq(Iter_type first, Iter_type last, const char* c_str)
{
...
template<class Char_type, class Iter_type> Char_type hex_str_to_char(Iter_type& begin)
{
...
template<class String_type, class Iter_type> String_type unicode_str_to_utf8(Iter_type& begin);

template<> std::string unicode_str_to_utf8(std::string::const_iterator& begin)
{
    ...
    unsigned long uc = (hex_to_num(c1) << 12) + (hex_to_num(c2) << 8) + (hex_to_num(c3) << 4) + hex_to_num(c4);
...
template<class String_type, class Iter_type> String_type get_str(Iter_type begin, Iter_type end)
{
...
template<typename Iter_type> void throw_error(Iter_type i, const std::string& reason)
{
    throw reason;
}
...
Iter_type read_range_or_throw(Iter_type begin, Iter_type end, Value_type& value)
{
    ...
    const spirit_namespace::parse_info<Iter_type> info = spirit_namespace::parse(
        begin, end, Json_grammer<Value_type, Iter_type>(semantic_actions), spirit_namespace::space_p);
...
// last one read.
//
template<class Iter_type, class Value_type> bool read_range(Iter_type& begin, Iter_type end, Value_type& value)
{
    try {
...
//
template<class String_type, class Value_type> bool read_string(const String_type& s, Value_type& value)
{
...
//
template<class String_type, class Value_type> void read_string_or_throw(const String_type& s, Value_type& value)
{
...
//
template<class Istream_type, class Value_type> bool read_stream(Istream_type& is, Value_type& value)
{
...
//
template<class Istream_type, class Value_type> void read_stream_or_throw(Istream_type& is, Value_type& value)
{
