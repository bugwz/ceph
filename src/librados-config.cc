...
int main(int argc, const char** argv)
{
    ...
    desc.add_options()("help,h", "print this help message")("version", "library version")(
        "vernum", "library version code")("release", "print release name");
    ...
    if (vm.count("help")) {
        ...
        std::cout << CEPH_RELEASE_NAME << ' ' << '(' << CEPH_RELEASE_TYPE << ')' << std::endl;
    }
    else {
