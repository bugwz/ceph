...
int main(int argc, char** argv)
{
    ...
    printf("layout:\n stripe_unit %lld\n stripe_count %lld\n object_size %lld\n data_pool %lld\n",
           ...
           (long long)l.stripe_count,
           (long long)l.object_size,
           (long long)l.data_pool);
    ...
    printf(" object '%s'\n object_offset %lld\n object_size %lld object_no %lld\n",
           dl.object_name,
           (long long)dl.object_offset,
           (long long)dl.object_size,
    ...
    snprintf(new_file_name, sizeof(new_file_name), "%s/testfile", argv[3]);
