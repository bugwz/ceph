...
public:
     ...
     * the states.
     */
    bool is_state_satisfied() const { return satisfied; }
     ...
     */
    bool is_first_writer() const { return first_writer; }
    ...
    ~RWRef()
    {
         ...
         */
        if (--S.reader_cnt == 0) S.cond.notify_all();
    }
