...
public:
    ...
    action_id_t pending_io_id() { return id() + 1; }

    // There's probably a better way to do this, but oh well.
    virtual bool is_start_thread() { return false; }
...
template<typename ActionType> class TypedAction : public Action
{
public:
    explicit TypedAction(const ActionType& action)
        : m_action(action)
    {}

    action_id_t id() const override { return m_action.id; }

    thread_id_t thread_id() const override { return m_action.thread_id; }

    const action::Dependencies& predecessors() const override { return m_action.dependencies; }
...
public:
    ...
    bool is_start_thread() override { return true; }
    void perform(ActionCtx& ctx) override;

protected:
    const char* get_action_name() const override { return "StartThreadAction"; }
};
...
protected:
    const char* get_action_name() const override { return "AioReadAction"; }
};
...
protected:
    const char* get_action_name() const override { return "ReadAction"; }
};
...
protected:
    const char* get_action_name() const override { return "AioWriteAction"; }
};
...
protected:
    const char* get_action_name() const override { return "WriteAction"; }
};
...
protected:
    const char* get_action_name() const override { return "AioDiscardAction"; }
};
...
protected:
    const char* get_action_name() const override { return "DiscardAction"; }
};
...
protected:
    const char* get_action_name() const override { return "OpenImageAction"; }
};
...
protected:
    const char* get_action_name() const override { return "CloseImageAction"; }
};
...
protected:
    const char* get_action_name() const override { return "AioOpenImageAction"; }
};
...
protected:
    const char* get_action_name() const override { return "AioCloseImageAction"; }
};
