...
public:
    ...
    librbd::RBD* get_rbd() { return m_rbd; }

    librados::IoCtx* get_ioctx() { return m_ioctx; }
    ...
    void set_image_name_map(const ImageNameMap& map) { m_image_name_map = map; }

    void set_dump_perf_counters(bool dump_perf_counters) { m_dump_perf_counters = dump_perf_counters; }

    const ImageNameMap& image_name_map() const { return m_image_name_map; }
