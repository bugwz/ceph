...
struct ActionBase
{
    ...
    ActionBase()
        ...
        , thread_id(0)
    {}
    ActionBase(action_id_t id, thread_id_t thread_id, const Dependencies& dependencies)
        : id(id)
        , thread_id(thread_id)
        , dependencies(dependencies)
    {}
...
struct StartThreadAction : public ActionBase
{
    ...
    StartThreadAction() {}
    StartThreadAction(action_id_t id, thread_id_t thread_id, const Dependencies& dependencies)
...
struct StopThreadAction : public ActionBase
{
    ...
    StopThreadAction() {}
    StopThreadAction(action_id_t id, thread_id_t thread_id, const Dependencies& dependencies)
        : ActionBase(id, thread_id, dependencies)
    {}
};
...
struct ImageActionBase : public ActionBase
{
    ...
    ImageActionBase()
        : imagectx_id(0)
    {}
    ImageActionBase(action_id_t id, thread_id_t thread_id, const Dependencies& dependencies, imagectx_id_t imagectx_id)
        : ActionBase(id, thread_id, dependencies)
        , imagectx_id(imagectx_id)
    {}
...
struct IoActionBase : public ImageActionBase
{
    ...
    IoActionBase()
        ...
        , length(0)
    {}
    IoActionBase(action_id_t id, thread_id_t thread_id, const Dependencies& dependencies, imagectx_id_t imagectx_id,
...
struct ReadAction : public IoActionBase
{
    ...
    ReadAction() {}
    ReadAction(action_id_t id, thread_id_t thread_id, const Dependencies& dependencies, imagectx_id_t imagectx_id,
               uint64_t offset, uint64_t length)
...
struct WriteAction : public IoActionBase
{
    ...
    WriteAction() {}
    WriteAction(action_id_t id, thread_id_t thread_id, const Dependencies& dependencies, imagectx_id_t imagectx_id,
                uint64_t offset, uint64_t length)
        : IoActionBase(id, thread_id, dependencies, imagectx_id, offset, length)
    {}
};
...
struct DiscardAction : public IoActionBase
{
    ...
    DiscardAction() {}
    DiscardAction(action_id_t id, thread_id_t thread_id, const Dependencies& dependencies, imagectx_id_t imagectx_id,
                  uint64_t offset, uint64_t length)
        : IoActionBase(id, thread_id, dependencies, imagectx_id, offset, length)
    {}
};
...
struct AioReadAction : public IoActionBase
{
    ...
    AioReadAction() {}
    AioReadAction(action_id_t id, thread_id_t thread_id, const Dependencies& dependencies, imagectx_id_t imagectx_id,
                  uint64_t offset, uint64_t length)
        : IoActionBase(id, thread_id, dependencies, imagectx_id, offset, length)
    {}
};
...
struct AioWriteAction : public IoActionBase
{
    ...
    AioWriteAction() {}
    AioWriteAction(action_id_t id, thread_id_t thread_id, const Dependencies& dependencies, imagectx_id_t imagectx_id,
                   uint64_t offset, uint64_t length)
        : IoActionBase(id, thread_id, dependencies, imagectx_id, offset, length)
    {}
};
...
struct AioDiscardAction : public IoActionBase
{
    ...
    AioDiscardAction() {}
    AioDiscardAction(action_id_t id, thread_id_t thread_id, const Dependencies& dependencies, imagectx_id_t imagectx_id,
                     uint64_t offset, uint64_t length)
        : IoActionBase(id, thread_id, dependencies, imagectx_id, offset, length)
    {}
};
...
struct OpenImageAction : public ImageActionBase
{
    ...
    OpenImageAction()
        : read_only(false)
    {}
    OpenImageAction(action_id_t id, thread_id_t thread_id, const Dependencies& dependencies, imagectx_id_t imagectx_id,
                    const std::string& name, const std::string& snap_name, bool read_only)
        : ImageActionBase(id, thread_id, dependencies, imagectx_id)
        , name(name)
        , snap_name(snap_name)
        , read_only(read_only)
...
struct CloseImageAction : public ImageActionBase
{
    ...
    CloseImageAction() {}
    CloseImageAction(action_id_t id, thread_id_t thread_id, const Dependencies& dependencies, imagectx_id_t imagectx_id)
        : ImageActionBase(id, thread_id, dependencies, imagectx_id)
    {}
};
...
struct AioOpenImageAction : public ImageActionBase
{
    ...
    AioOpenImageAction()
        : read_only(false)
    {}
    AioOpenImageAction(action_id_t id, thread_id_t thread_id, const Dependencies& dependencies,
                       imagectx_id_t imagectx_id, const std::string& name, const std::string& snap_name, bool read_only)
        : ImageActionBase(id, thread_id, dependencies, imagectx_id)
        , name(name)
        , snap_name(snap_name)
        , read_only(read_only)
...
struct AioCloseImageAction : public ImageActionBase
{
    ...
    AioCloseImageAction() {}
    AioCloseImageAction(action_id_t id, thread_id_t thread_id, const Dependencies& dependencies,
                        imagectx_id_t imagectx_id)
        : ImageActionBase(id, thread_id, dependencies, imagectx_id)
    {}
};
...
typedef boost::variant<StartThreadAction, StopThreadAction, ReadAction, WriteAction, DiscardAction, AioReadAction,
                       AioWriteAction, AioDiscardAction, OpenImageAction, CloseImageAction, AioOpenImageAction,
                       AioCloseImageAction, UnknownAction>
    Action;
...
std::ostream& operator<<(std::ostream& out, const rbd_replay::action::ActionType& type);
