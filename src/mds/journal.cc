...
void EMetaBlob::replay(MDSRank* mds, LogSegment* logseg, MDPeerUpdate* peerup)
{
    ...
    if (sessionmapv) {
        ...
        if (mds->sessionmap.get_version() >= sessionmapv) {
            ...
            dout(10) << "EMetaBlob.replay sessionmap v " << sessionmapv << " - " << diff << " == table "
                     << mds->sessionmap.get_version() << " prealloc " << preallocated_inos << " used "
                     << used_preallocated_ino << dendl;
            ...
            mds->clog->error() << "EMetaBlob.replay sessionmap v " << sessionmapv << " - " << diff << " > table "
