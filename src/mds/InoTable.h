...
public:
    ...
    bool intersects_free(const interval_set<inodeno_t>& other, interval_set<inodeno_t>* intersection);
    ...
    void encode(bufferlist& bl) const { encode_state(bl); }
    void decode(bufferlist::const_iterator& bl) { decode_state(bl); }
