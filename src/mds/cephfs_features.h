...
#define CEPHFS_FEATURES_ALL                                                                                            \
    {                                                                                                                  \
        0, 1, 2, 3, 4, CEPHFS_FEATURE_JEWEL, CEPHFS_FEATURE_KRAKEN, CEPHFS_FEATURE_LUMINOUS, CEPHFS_FEATURE_MIMIC,     \
            CEPHFS_FEATURE_REPLY_ENCODING, CEPHFS_FEATURE_RECLAIM_CLIENT, CEPHFS_FEATURE_LAZY_CAP_WANTED,              \
            CEPHFS_FEATURE_MULTI_RECONNECT, CEPHFS_FEATURE_NAUTILUS, CEPHFS_FEATURE_DELEG_INO, CEPHFS_FEATURE_OCTOPUS, \
            CEPHFS_FEATURE_METRIC_COLLECT, CEPHFS_FEATURE_ALTERNATE_NAME, CEPHFS_FEATURE_NOTIFY_SESSION_STATE,         \
            CEPHFS_FEATURE_OP_GETVXATTR, CEPHFS_FEATURE_32BITS_RETRY_FWD, CEPHFS_FEATURE_NEW_SNAPREALM_INFO,           \
            CEPHFS_FEATURE_HAS_OWNER_UIDGID,                                                                           \
    }

#define CEPHFS_METRIC_FEATURES_ALL                                                                                 \
    {                                                                                                              \
        CLIENT_METRIC_TYPE_CAP_INFO, CLIENT_METRIC_TYPE_READ_LATENCY, CLIENT_METRIC_TYPE_WRITE_LATENCY,            \
            CLIENT_METRIC_TYPE_METADATA_LATENCY, CLIENT_METRIC_TYPE_DENTRY_LEASE, CLIENT_METRIC_TYPE_OPENED_FILES, \
            CLIENT_METRIC_TYPE_PINNED_ICAPS, CLIENT_METRIC_TYPE_OPENED_INODES, CLIENT_METRIC_TYPE_READ_IO_SIZES,   \
            CLIENT_METRIC_TYPE_WRITE_IO_SIZES, CLIENT_METRIC_TYPE_AVG_READ_LATENCY,                                \
            CLIENT_METRIC_TYPE_STDEV_READ_LATENCY, CLIENT_METRIC_TYPE_AVG_WRITE_LATENCY,                           \
            CLIENT_METRIC_TYPE_STDEV_WRITE_LATENCY, CLIENT_METRIC_TYPE_AVG_METADATA_LATENCY,                       \
