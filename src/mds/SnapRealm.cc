...
static ostream& _prefix(std::ostream* _dout, int whoami, const CInode* inode, uint64_t seq, const SnapRealm* realm)
{
...
void SnapRealm::build_snap_trace() const
{
    ...
    if (parent) cached_snap_trace.append(parent->get_snap_trace());
}
