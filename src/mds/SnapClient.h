...
public:
    ...
    void prepare_create(inodeno_t dirino, std::string_view name, utime_t stamp, version_t* pstid, bufferlist* pbl,
                        MDSContext* onfinish)
    {
        bufferlist bl;
    ...
    void prepare_update(inodeno_t ino, snapid_t snapid, std::string_view name, utime_t stamp, version_t* pstid,
                        MDSContext* onfinish)
    {
        bufferlist bl;
