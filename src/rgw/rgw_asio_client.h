...
class ClientIO : public io::RestfulClient, public io::BuffererSink
{
protected:
    parser_type& parser;
...
public:
    ClientIO(parser_type& parser, bool is_ssl, const endpoint_type& local_endpoint,
    ...
    size_t send_body(const char* buf, size_t len) override { return write_data(buf, len); }
