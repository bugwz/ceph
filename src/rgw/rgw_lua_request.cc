...
template<typename MapType> int StringMapWriteableNewIndex(lua_State* L)
{
...
int execute(rgw::sal::RGWRadosStore* store, RGWREST* rest, OpsLogSink* olog, req_state* s, RGWOp* op,
            const std::string& script)
{
    ...
    set_package_path(L, store ? store->get_luarocks_path() : "");
