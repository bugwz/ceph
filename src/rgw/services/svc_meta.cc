...
RGWSI_Meta::RGWSI_Meta(CephContext* cct)
    : RGWServiceInstance(cct)
{}

RGWSI_Meta::~RGWSI_Meta() {}

void RGWSI_Meta::init(RGWSI_SysObj* _sysobj_svc, RGWSI_MDLog* _mdlog_svc, vector<RGWSI_MetaBackend*>& _be_svc)
{
...
int RGWSI_Meta::create_be_handler(RGWSI_MetaBackend::Type be_type, RGWSI_MetaBackend_Handler** phandler)
{
