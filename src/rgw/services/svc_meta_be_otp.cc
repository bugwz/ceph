...
int RGWSI_MetaBackend_OTP::call_with_get_params(ceph::real_time* pmtime,
...
int RGWSI_MetaBackend_OTP::get_entry(RGWSI_MetaBackend::Context* _ctx, const string& key,
                                     RGWSI_MetaBackend::GetParams& _params, RGWObjVersionTracker* objv_tracker,
...
int RGWSI_MetaBackend_OTP::put_entry(const DoutPrefixProvider* dpp, RGWSI_MetaBackend::Context* _ctx, const string& key,
                                     RGWSI_MetaBackend::PutParams& _params, RGWObjVersionTracker* objv_tracker,
                                     optional_yield y)
{
