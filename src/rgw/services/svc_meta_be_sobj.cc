...
RGWSI_MetaBackend_SObj::RGWSI_MetaBackend_SObj(CephContext* cct)
...
int RGWSI_MetaBackend_SObj::pre_modify(const DoutPrefixProvider* dpp, RGWSI_MetaBackend::Context* _ctx,
                                       const string& key, RGWMetadataLogData& log_data,
                                       RGWObjVersionTracker* objv_tracker, RGWMDLogStatus op_type, optional_yield y)
{
    auto ctx = static_cast<Context_SObj*>(_ctx);
    int ret = RGWSI_MetaBackend::pre_modify(dpp, ctx, key, log_data, objv_tracker, op_type, y);
    if (ret < 0) {
        return ret;
    }
...
int RGWSI_MetaBackend_SObj::post_modify(const DoutPrefixProvider* dpp, RGWSI_MetaBackend::Context* _ctx,
                                        const string& key, RGWMetadataLogData& log_data,
                                        RGWObjVersionTracker* objv_tracker, int ret, optional_yield y)
{
    auto ctx = static_cast<Context_SObj*>(_ctx);
    if (ret >= 0)
...
int RGWSI_MetaBackend_SObj::get_shard_id(RGWSI_MetaBackend::Context* _ctx, const std::string& key, int* shard_id)
{
    auto ctx = static_cast<Context_SObj*>(_ctx);
                                 ...
                                 std::function<int(RGWSI_MetaBackend::Context*)> f)
{
    ...
    try {
        ...
        ldout(cct, 0) << "ERROR: possible bug: " << __FILE__ << ":" << __LINE__ << ":" << __func__
...
int RGWSI_MetaBackend_SObj::call_with_get_params(ceph::real_time* pmtime,
                                                 std::function<int(RGWSI_MetaBackend::GetParams&)> cb)
{
    bufferlist bl;
...
int RGWSI_MetaBackend_SObj::get_entry(RGWSI_MetaBackend::Context* _ctx, const string& key, GetParams& _params,
                                      ...
                                      const DoutPrefixProvider* dpp)
{
    ...
    return rgw_get_system_obj(*ctx->obj_ctx,
                              pool,
                              oid,
                              *params.pbl,
                              objv_tracker,
...
int RGWSI_MetaBackend_SObj::put_entry(const DoutPrefixProvider* dpp, RGWSI_MetaBackend::Context* _ctx,
                                      const string& key, PutParams& _params, RGWObjVersionTracker* objv_tracker,
                                      optional_yield y)
{
    RGWSI_MetaBackend_SObj::Context_SObj* ctx = static_cast<RGWSI_MetaBackend_SObj::Context_SObj*>(_ctx);
    ...
    return rgw_put_system_obj(
        dpp, *ctx->obj_ctx, pool, oid, params.bl, params.exclusive, objv_tracker, params.mtime, y, params.pattrs);
}

int RGWSI_MetaBackend_SObj::remove_entry(const DoutPrefixProvider* dpp, RGWSI_MetaBackend::Context* _ctx,
                                         const string& key, RemoveParams& params, RGWObjVersionTracker* objv_tracker,
                                         optional_yield y)
{
    RGWSI_MetaBackend_SObj::Context_SObj* ctx = static_cast<RGWSI_MetaBackend_SObj::Context_SObj*>(_ctx);
...
int RGWSI_MetaBackend_SObj::list_init(const DoutPrefixProvider* dpp, RGWSI_MetaBackend::Context* _ctx,
                                      const string& marker)
{
    RGWSI_MetaBackend_SObj::Context_SObj* ctx = static_cast<RGWSI_MetaBackend_SObj::Context_SObj*>(_ctx);
...
int RGWSI_MetaBackend_SObj::list_next(RGWSI_MetaBackend::Context* _ctx, int max, list<string>* keys, bool* truncated)
{
    RGWSI_MetaBackend_SObj::Context_SObj* ctx = static_cast<RGWSI_MetaBackend_SObj::Context_SObj*>(_ctx);
...
int RGWSI_MetaBackend_SObj::list_get_marker(RGWSI_MetaBackend::Context* _ctx, string* marker)
{
    RGWSI_MetaBackend_SObj::Context_SObj* ctx = static_cast<RGWSI_MetaBackend_SObj::Context_SObj*>(_ctx);
