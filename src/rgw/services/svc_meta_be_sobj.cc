                                      ...
                                      const DoutPrefixProvider* dpp, bool get_raw_attrs)
{
    ...
    int ret = 0;
    ret = rgw_get_system_obj(sysobj_svc,
                             pool,
                             oid,
                             *params.pbl,
                             objv_tracker,
                                      ...
                                      optional_yield y)
{
    ...
    return rgw_put_system_obj(
        dpp, sysobj_svc, pool, oid, params.bl, params.exclusive, objv_tracker, params.mtime, y, params.pattrs);
}
...
int RGWSI_MetaBackend_SObj::list_next(const DoutPrefixProvider* dpp, RGWSI_MetaBackend::Context* _ctx, int max,
