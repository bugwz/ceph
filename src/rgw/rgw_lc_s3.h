...
public:
    LCExpiration_S3() {}
    LCExpiration_S3(std::string _days, std::string _date, bool _dm_expiration)
        : LCExpiration(_days, _date)
    ...
    bool get_dm_expiration() { return dm_expiration; }
};
...
{
public:
    explicit RGWLifecycleConfiguration_S3(CephContext* _cct)
        : RGWLifecycleConfiguration(_cct)
    {}
    RGWLifecycleConfiguration_S3()
        : RGWLifecycleConfiguration(nullptr)
    {}
