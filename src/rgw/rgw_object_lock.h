...
public:
    int get_days() const { return defaultRetention.get_days(); }

    int get_years() const { return defaultRetention.get_years(); }

    std::string get_mode() const { return defaultRetention.get_mode(); }
...
public:
    ...
    int get_days() const { return rule.get_days(); }

    int get_years() const { return rule.get_years(); }

    std::string get_mode() const { return rule.get_mode(); }
...
public:
    RGWObjectRetention() {}
    RGWObjectRetention(std::string _mode, ceph::real_time _date)
        : mode(_mode)
        , retain_until_date(_date)
    {}

    void set_mode(std::string _mode) { mode = _mode; }

    std::string get_mode() const { return mode; }

    void set_retain_until_date(ceph::real_time _retain_until_date) { retain_until_date = _retain_until_date; }

    ceph::real_time get_retain_until_date() const { return retain_until_date; }
...
public:
    RGWObjectLegalHold() {}
    RGWObjectLegalHold(std::string _status)
        : status(_status)
    {}
