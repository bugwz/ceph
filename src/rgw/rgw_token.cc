...
void usage()
{
    ...
    cout << "\t(maybe exporting RGW_ACCESS_KEY_ID and RGW_SECRET_ACCESS_KEY)" << std::endl;
...
int main(int argc, char** argv)
{
    ...
    for (auto arg_iter = args.begin(); arg_iter != args.end();) {
        ...
        else if (ceph_argparse_witharg(args, arg_iter, &val, "--ttype", (char*)nullptr)) {
        ...
        else if (ceph_argparse_flag(args, arg_iter, "--encode", (char*)nullptr)) {
            do_encode = true;
        }
        else if (ceph_argparse_flag(args, arg_iter, "--decode", (char*)nullptr)) {
            do_decode = true;
        }
    ...
    if ((!do_encode) || (type == RGWToken::TOKEN_NONE)) {
        return -EINVAL;
    }
