...
int RGWMetadataHandler_GenericMetaBE::list_keys_next(const DoutPrefixProvider* dpp, void* handle, int max,
...
public:
    ...
    int list_keys_next(const DoutPrefixProvider* dpp, void* handle, int max, list<string>& keys,
...
int RGWMetadataManager::list_keys_next(const DoutPrefixProvider* dpp, void* handle, int max, list<string>& keys,
                                       bool* truncated)
{
