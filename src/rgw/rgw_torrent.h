...
public:
    ...
    // single values
    void bencode(const std::string& str, bufferlist& bl) { bencode_key(str, bl); }
...
public:
    ...
    int get_torrent_file(rgw::sal::Object* object, uint64_t& total_len, ceph::bufferlist& bl_data, rgw_obj& obj);
