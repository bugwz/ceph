...
static rgw_pool default_pool(std::string_view name, std::string_view default_name)
{
...
ConfigImpl::ConfigImpl(const ceph::common::ConfigProxy& conf)
    ...
    , period_pool(default_pool(conf->rgw_period_root_pool, default_period_root_pool))
    , zonegroup_pool(default_pool(conf->rgw_zonegroup_root_pool, default_zonegroup_root_pool))
    , zone_pool(default_pool(conf->rgw_zone_root_pool, default_zone_root_pool))
{}

int ConfigImpl::read(const DoutPrefixProvider* dpp, optional_yield y, const rgw_pool& pool, const std::string& oid,
...
int ConfigImpl::write(const DoutPrefixProvider* dpp, optional_yield y, const rgw_pool& pool, const std::string& oid,
...
int ConfigImpl::remove(const DoutPrefixProvider* dpp, optional_yield y, const rgw_pool& pool, const std::string& oid,
...
int ConfigImpl::notify(const DoutPrefixProvider* dpp, optional_yield y, const rgw_pool& pool, const std::string& oid,
