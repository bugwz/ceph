...
int RGWPeriod::update_sync_status(const DoutPrefixProvider* dpp, rgw::sal::Driver* driver, /* for now */
...
int RGWPeriod::commit(const DoutPrefixProvider* dpp, rgw::sal::Driver* driver, RGWRealm& realm,
