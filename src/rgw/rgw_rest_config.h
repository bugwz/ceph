...
public:
    ...
    const char* name() const override { return "get_zone_config"; }
};
...
public:
    ...
    RGWHandler_REST* get_handler(rgw::sal::Driver*, req_state*, const rgw::auth::StrategyRegistry& auth_registry,
