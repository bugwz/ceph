...
{
    req = new RGWAsyncGetSystemObj(
        dpp, this, stack->create_completion_notifier(), svc, objv_tracker, obj, true, raw_attrs);
...
RGWOmapAppend::RGWOmapAppend(RGWAsyncRadosProcessor* _async_rados, rgw::sal::RGWRadosStore* _store,
...
RGWAsyncLockSystemObj::RGWAsyncLockSystemObj(RGWCoroutine* caller, RGWAioCompletionNotifier* cn,
                                             rgw::sal::RGWRadosStore* _store, RGWObjVersionTracker* _objv_tracker,
...
RGWRadosSetOmapKeysCR::RGWRadosSetOmapKeysCR(rgw::sal::RGWRadosStore* _store, const rgw_raw_obj& _obj,
...
RGWRadosGetOmapKeysCR::RGWRadosGetOmapKeysCR(rgw::sal::RGWRadosStore* _store, const rgw_raw_obj& _obj,
...
RGWRadosGetOmapValsCR::RGWRadosGetOmapValsCR(rgw::sal::RGWRadosStore* _store, const rgw_raw_obj& _obj,
                                             const string& _marker, int _max_entries, ResultPtr _result)
    : RGWSimpleCoroutine(_store->ctx())
    , store(_store)
    , obj(_obj)
...
RGWRadosRemoveOmapKeysCR::RGWRadosRemoveOmapKeysCR(rgw::sal::RGWRadosStore* _store, const rgw_raw_obj& _obj,
...
RGWRadosBILogTrimCR::RGWRadosBILogTrimCR(const DoutPrefixProvider* dpp, rgw::sal::RGWRadosStore* store,
...
RGWRadosTimelogAddCR::RGWRadosTimelogAddCR(const DoutPrefixProvider* _dpp, rgw::sal::RGWRadosStore* _store,
...
RGWRadosTimelogTrimCR::RGWRadosTimelogTrimCR(const DoutPrefixProvider* dpp, rgw::sal::RGWRadosStore* store,
...
RGWSyncLogTrimCR::RGWSyncLogTrimCR(const DoutPrefixProvider* dpp, rgw::sal::RGWRadosStore* store,
                                   const std::string& oid, const std::string& to_marker, std::string* last_trim_marker)
...
RGWStatObjCR::RGWStatObjCR(const DoutPrefixProvider* dpp, RGWAsyncRadosProcessor* async_rados,
                           rgw::sal::RGWRadosStore* store, const RGWBucketInfo& _bucket_info, const rgw_obj& obj,
...
RGWRadosNotifyCR::RGWRadosNotifyCR(rgw::sal::RGWRadosStore* store, const rgw_raw_obj& obj, bufferlist& request,
