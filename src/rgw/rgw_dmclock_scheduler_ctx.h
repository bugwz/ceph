...
public:
    ...
    PerfCounters* operator()(client_id client) const { return clients[static_cast<size_t>(client)].get(); }
};
...
public:
    ...
    PerfCounters* operator()() const { return counters.get(); }
};
...
{
public:
    SchedulerCtx(CephContext* const cct)
