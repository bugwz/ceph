...
struct rgw_io_id
{
    ...
    rgw_io_id() {}
    rgw_io_id(int64_t _id, int _channels)
        : id(_id)
        , channels(_channels)
    {}

    bool intersects(const rgw_io_id& rhs) { return (id == rhs.id && ((channels | rhs.channels) != 0)); }
...
public:
    ...
    rgw_io_id get_io_id(int io_type) { return rgw_io_id{id, io_type}; }
