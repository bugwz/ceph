...
inline bool operator==(const bucket_index_normal_layout& l, const bucket_index_normal_layout& r)
{
...
inline bool operator==(const bucket_index_layout& l, const bucket_index_layout& r)
{
...
inline bool operator==(const bucket_index_layout_generation& l, const bucket_index_layout_generation& r)
{
...
{
    switch (log_type) {
    case BucketLogType::InIndex: return out << "InIndex";
...
inline bucket_log_layout_generation log_layout_from_index(uint64_t gen, const bucket_index_layout_generation& index)
{
...
struct BucketLayout
{
    ...
    friend std::ostream& operator<<(std::ostream& out, const BucketLayout& l)
    {
        ...
        out << "resharding=" << to_string(l.resharding) << ", current_index=[" << l.current_index << "], target_index=["
