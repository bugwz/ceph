...
bool CephxAuthorizeHandler::verify_authorizer(CephContext* cct, const KeyStore& keys,
                                              const ceph::bufferlist& authorizer_data,
                                              size_t connection_secret_required_len, ceph::bufferlist* authorizer_reply,
                                              ...
                                              std::unique_ptr<AuthAuthorizerChallenge>* challenge)
{
    ...
    bool isvalid = cephx_verify_authorizer(cct,
                                           keys,
                                           iter,
