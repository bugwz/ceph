...
bool KrbAuthorizeHandler::verify_authorizer(CephContext* ceph_ctx, const KeyStore& keys,
                                            const bufferlist& authorizer_data, size_t connection_secret_required_len,
                                            bufferlist* authorizer_reply, EntityName* entity_name, uint64_t* global_id,
