...
public:
    ...
    KrbClientHandler* clone() const override { return new KrbClientHandler(*this); }
    ...
    int handle_response(int ret, bufferlist::const_iterator& buff_list, CryptoKey* session_key,
                        std::string* connection_secret) override;

    bool build_rotating_request(bufferlist& buff_list) const override { return false; }
