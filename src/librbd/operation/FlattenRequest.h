...
{
public:
    FlattenRequest(ImageCtxT& image_ctx, Context* on_finish, uint64_t start_object_no, uint64_t overlap_objects,
...
protected:
    ...
    journal::Event create_event(uint64_t op_tid) const override { return journal::FlattenEvent(op_tid); }
