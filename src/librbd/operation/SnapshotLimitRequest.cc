...
template<typename I>
SnapshotLimitRequest<I>::SnapshotLimitRequest(I& image_ctx, Context* on_finish, uint64_t limit)
...
template<typename I> bool SnapshotLimitRequest<I>::should_complete(int r)
{
...
template<typename I> void SnapshotLimitRequest<I>::send_limit_snaps()
{
    I& image_ctx = this->m_image_ctx;
