...
template<typename I>
MetadataRemoveRequest<I>::MetadataRemoveRequest(I& image_ctx, Context* on_finish, const std::string& key)
...
template<typename I> bool MetadataRemoveRequest<I>::should_complete(int r)
{
...
template<typename I> void MetadataRemoveRequest<I>::send_metadata_remove()
{
    I& image_ctx = this->m_image_ctx;
