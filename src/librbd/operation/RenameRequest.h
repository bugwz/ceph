...
template<typename ImageCtxT = ImageCtx> class RenameRequest : public Request<ImageCtxT>
{
public:
    /**
    ...
    RenameRequest(ImageCtxT& image_ctx, Context* on_finish, const std::string& dest_name);
...
protected:
    ...
    journal::Event create_event(uint64_t op_tid) const override { return journal::RenameEvent(op_tid, m_dest_name); }
