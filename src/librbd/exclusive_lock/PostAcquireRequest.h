...
{
public:
    static PostAcquireRequest* create(ImageCtxT& image_ctx, Context* on_acquire, Context* on_finish);
...
private:
    ...
    PostAcquireRequest(ImageCtxT& image_ctx, Context* on_acquire, Context* on_finish);
