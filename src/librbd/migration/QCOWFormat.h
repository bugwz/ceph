...
template<typename ImageCtxT> class QCOWFormat : public FormatInterface
{
public:
    static QCOWFormat* create(ImageCtxT* image_ctx, const json_spirit::mObject& json_object,
...
private:
    ...
    void handle_list_snaps(int r, io::Extents&& image_extents, io::SnapIds&& snap_ids,
