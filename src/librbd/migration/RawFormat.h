...
{
public:
    static RawFormat* create(ImageCtxT* image_ctx, const json_spirit::mObject& json_object,
...
private:
    ...
    void handle_list_snaps(int r, io::SnapIds&& snap_ids, io::SnapshotDelta* snapshot_delta, Context* on_finish);
};
