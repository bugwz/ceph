...
std::ostream& operator<<(std::ostream& os, const SnapshotCreateRequest::State& state)
{
    switch (state) {
    case SnapshotCreateRequest::STATE_READ_MAP: os << "READ_MAP"; break;
    case SnapshotCreateRequest::STATE_WRITE_MAP: os << "WRITE_MAP"; break;
    case SnapshotCreateRequest::STATE_ADD_SNAPSHOT: os << "ADD_SNAPSHOT"; break;
...
bool SnapshotCreateRequest::should_complete(int r)
{
    ...
    bool finished = false;
    switch (m_state) {
    case STATE_READ_MAP: send_write_map(); break;
    case STATE_WRITE_MAP: finished = send_add_snapshot(); break;
