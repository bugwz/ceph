...
std::ostream& operator<<(std::ostream& os, const SnapshotRollbackRequest::State& state)
{
    switch (state) {
    case SnapshotRollbackRequest::STATE_READ_MAP: os << "READ_MAP"; break;
    case SnapshotRollbackRequest::STATE_INVALIDATE_MAP: os << "INVALIDATE_MAP"; break;
    case SnapshotRollbackRequest::STATE_WRITE_MAP: os << "WRITE_MAP"; break;
...
bool SnapshotRollbackRequest::should_complete(int r)
{
    ...
    case STATE_INVALIDATE_MAP:
        ...
        break;
    case STATE_WRITE_MAP: finished = Request::should_complete(r); break;
...
void SnapshotRollbackRequest::send_read_map()
{
    ...
    int r = m_image_ctx.md_ctx.aio_operate(snap_oid, rados_completion, &op, &m_read_bl);
    ceph_assert(r == 0);
