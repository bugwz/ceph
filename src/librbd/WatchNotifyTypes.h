...
struct AsyncRequestId
{
    ...
    inline operator bool() const { return (*this != AsyncRequestId()); }
};
...
struct AcquiredLockPayload : public Payload
{
    ...
    AcquiredLockPayload() {}
    AcquiredLockPayload(const ClientId& client_id)
        : client_id(client_id)
    {}

    NotifyOp get_notify_op() const override { return NOTIFY_OP_ACQUIRED_LOCK; }
    bool check_for_refresh() const override { return false; }
...
struct ReleasedLockPayload : public Payload
{
    ...
    ReleasedLockPayload() {}
    ReleasedLockPayload(const ClientId& client_id)
        : client_id(client_id)
    {}

    NotifyOp get_notify_op() const override { return NOTIFY_OP_RELEASED_LOCK; }
    bool check_for_refresh() const override { return false; }
...
struct RequestLockPayload : public Payload
{
    ...
    NotifyOp get_notify_op() const override { return NOTIFY_OP_REQUEST_LOCK; }
    bool check_for_refresh() const override { return false; }
...
{
    NotifyOp get_notify_op() const override { return NOTIFY_OP_HEADER_UPDATE; }
    bool check_for_refresh() const override { return false; }
...
protected:
    ...
    AsyncRequestPayloadBase(const AsyncRequestId& id)
        : async_request_id(id)
    {}
};
...
struct AsyncProgressPayload : public AsyncRequestPayloadBase
{
    ...
    NotifyOp get_notify_op() const override { return NOTIFY_OP_ASYNC_PROGRESS; }
    bool check_for_refresh() const override { return false; }
...
struct AsyncCompletePayload : public AsyncRequestPayloadBase
{
    ...
    NotifyOp get_notify_op() const override { return NOTIFY_OP_ASYNC_COMPLETE; }
    bool check_for_refresh() const override { return false; }
...
{
    FlattenPayload() {}
    FlattenPayload(const AsyncRequestId& id)
        : AsyncRequestPayloadBase(id)
    {}

    NotifyOp get_notify_op() const override { return NOTIFY_OP_FLATTEN; }
    bool check_for_refresh() const override { return true; }
};
...
struct ResizePayload : public AsyncRequestPayloadBase
{
    ...
    NotifyOp get_notify_op() const override { return NOTIFY_OP_RESIZE; }
    bool check_for_refresh() const override { return true; }
...
protected:
    SnapPayloadBase() {}
    SnapPayloadBase(const AsyncRequestId& id, const cls::rbd::SnapshotNamespace& snap_namespace,
...
struct SnapCreatePayload : public SnapPayloadBase
{
    ...
    SnapCreatePayload() {}
    SnapCreatePayload(const AsyncRequestId& id, const cls::rbd::SnapshotNamespace& snap_namespace,
                      const std::string& name, uint64_t flags)
        : SnapPayloadBase(id, snap_namespace, name)
        , flags(flags)
    {}

    NotifyOp get_notify_op() const override { return NOTIFY_OP_SNAP_CREATE; }
...
struct SnapRenamePayload : public SnapPayloadBase
{
    ...
    SnapRenamePayload() {}
    SnapRenamePayload(const AsyncRequestId& id, const uint64_t& src_snap_id, const std::string& dst_name)
        : SnapPayloadBase(id, cls::rbd::UserSnapshotNamespace(), dst_name)
        , snap_id(src_snap_id)
    {}

    NotifyOp get_notify_op() const override { return NOTIFY_OP_SNAP_RENAME; }
...
{
    SnapRemovePayload() {}
    SnapRemovePayload(const AsyncRequestId& id, const cls::rbd::SnapshotNamespace& snap_namespace,
                      const std::string& name)
        : SnapPayloadBase(id, snap_namespace, name)
    {}

    NotifyOp get_notify_op() const override { return NOTIFY_OP_SNAP_REMOVE; }
};

struct SnapProtectPayload : public SnapPayloadBase
{
    SnapProtectPayload() {}
    SnapProtectPayload(const AsyncRequestId& id, const cls::rbd::SnapshotNamespace& snap_namespace,
                       const std::string& name)
        : SnapPayloadBase(id, snap_namespace, name)
    {}

    NotifyOp get_notify_op() const override { return NOTIFY_OP_SNAP_PROTECT; }
};

struct SnapUnprotectPayload : public SnapPayloadBase
{
    SnapUnprotectPayload() {}
    SnapUnprotectPayload(const AsyncRequestId& id, const cls::rbd::SnapshotNamespace& snap_namespace,
                         const std::string& name)
        : SnapPayloadBase(id, snap_namespace, name)
    {}

    NotifyOp get_notify_op() const override { return NOTIFY_OP_SNAP_UNPROTECT; }
};
...
struct RebuildObjectMapPayload : public AsyncRequestPayloadBase
{
    ...
    NotifyOp get_notify_op() const override { return NOTIFY_OP_REBUILD_OBJECT_MAP; }
    bool check_for_refresh() const override { return true; }
};
...
struct RenamePayload : public AsyncRequestPayloadBase
{
    ...
    NotifyOp get_notify_op() const override { return NOTIFY_OP_RENAME; }
    bool check_for_refresh() const override { return true; }
...
struct UpdateFeaturesPayload : public AsyncRequestPayloadBase
{
    ...
    UpdateFeaturesPayload(const AsyncRequestId& id, uint64_t features, bool enabled)
        : AsyncRequestPayloadBase(id)
        , features(features)
        , enabled(enabled)
    {}

    NotifyOp get_notify_op() const override { return NOTIFY_OP_UPDATE_FEATURES; }
    bool check_for_refresh() const override { return true; }
...
{
    MigratePayload() {}
    MigratePayload(const AsyncRequestId& id)
        : AsyncRequestPayloadBase(id)
    {}

    NotifyOp get_notify_op() const override { return NOTIFY_OP_MIGRATE; }
    bool check_for_refresh() const override { return true; }
};
...
struct SparsifyPayload : public AsyncRequestPayloadBase
{
    ...
    NotifyOp get_notify_op() const override { return NOTIFY_OP_SPARSIFY; }
    bool check_for_refresh() const override { return true; }
...
{
    QuiescePayload() {}
    QuiescePayload(const AsyncRequestId& id)
        : AsyncRequestPayloadBase(id)
    {}

    NotifyOp get_notify_op() const override { return NOTIFY_OP_QUIESCE; }
    bool check_for_refresh() const override { return false; }
};
...
{
    UnquiescePayload() {}
    UnquiescePayload(const AsyncRequestId& id)
        : AsyncRequestPayloadBase(id)
    {}

    NotifyOp get_notify_op() const override { return NOTIFY_OP_UNQUIESCE; }
    bool check_for_refresh() const override { return false; }
};
...
struct MetadataUpdatePayload : public AsyncRequestPayloadBase
{
    ...
    MetadataUpdatePayload(const AsyncRequestId& id, std::string key, std::optional<std::string> value)
        : AsyncRequestPayloadBase(id)
        , key(key)
        , value(value)
    {}

    NotifyOp get_notify_op() const override { return NOTIFY_OP_METADATA_UPDATE; }
    bool check_for_refresh() const override { return false; }
...
{
    NotifyOp get_notify_op() const override { return static_cast<NotifyOp>(-1); }
    bool check_for_refresh() const override { return false; }
...
std::ostream& operator<<(std::ostream& out, const AsyncRequestId& request);
