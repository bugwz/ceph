...
template<typename I>
RemoveRequest<I>::RemoveRequest(IoCtx& ioctx, const std::string& image_id, const std::string& client_id,
...
template<typename I> void RemoveRequest<I>::stat_journal()
{
    ldout(m_cct, 20) << this << " " << __func__ << dendl;
...
template<typename I> Context* RemoveRequest<I>::handle_stat_journal(int* result)
{
...
template<typename I> void RemoveRequest<I>::init_journaler()
{
    ldout(m_cct, 20) << this << " " << __func__ << dendl;
...
template<typename I> Context* RemoveRequest<I>::handle_init_journaler(int* result)
{
    ldout(m_cct, 20) << __func__ << ": r=" << *result << dendl;
...
template<typename I> void RemoveRequest<I>::remove_journal()
{
    ldout(m_cct, 20) << this << " " << __func__ << dendl;
...
template<typename I> Context* RemoveRequest<I>::handle_remove_journal(int* result)
{
    ldout(m_cct, 20) << __func__ << ": r=" << *result << dendl;
...
template<typename I> void RemoveRequest<I>::shut_down_journaler(int r)
{
    ldout(m_cct, 20) << this << " " << __func__ << dendl;
...
template<typename I> Context* RemoveRequest<I>::handle_journaler_shutdown(int* result)
{
    ldout(m_cct, 20) << __func__ << ": r=" << *result << dendl;
