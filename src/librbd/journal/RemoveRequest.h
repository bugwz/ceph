...
public:
    ...
    {
        return new RemoveRequest(ioctx, image_id, client_id, op_work_queue, on_finish);
    }
...
private:
    ...
    RemoveRequest(IoCtx& ioctx, const std::string& image_id, const std::string& client_id, ContextWQ* op_work_queue,
                  Context* on_finish);
