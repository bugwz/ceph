                                        ...
                                        Context* on_dispatched)
{
    ...
    CacheGenContextURef ctx = make_gen_lambda_context<ObjectCacheRequest*, std::function<void(ObjectCacheRequest*)>>(
        [this, extents, dispatch_result, on_dispatched, object_no, io_context, &parent_trace](ObjectCacheRequest* ack) {
            handle_read_cache(ack, object_no, extents, io_context, parent_trace, dispatch_result, on_dispatched);
        });
