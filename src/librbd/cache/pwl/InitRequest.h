...
template<typename ImageCtxT = ImageCtx> class InitRequest
{
public:
    static InitRequest* create(ImageCtxT& image_ctx, librbd::cache::ImageWritebackInterface& image_writeback,
                               plugin::Api<ImageCtxT>& plugin_api, Context* on_finish);
...
private:
    ...
    InitRequest(ImageCtxT& image_ctx, librbd::cache::ImageWritebackInterface& image_writeback,
                plugin::Api<ImageCtxT>& plugin_api, Context* on_finish);
