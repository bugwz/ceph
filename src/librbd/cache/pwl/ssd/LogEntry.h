...
public:
    ...
    void writeback_bl(librbd::cache::ImageWritebackInterface& image_writeback, Context* ctx,
                      ceph::bufferlist&& bl) override;
    ...
    unsigned int reader_count() const override { return bl_refs; }
};
