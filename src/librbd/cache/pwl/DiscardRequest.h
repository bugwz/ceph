...
template<typename ImageCtxT = ImageCtx> class DiscardRequest
{
public:
    static DiscardRequest* create(ImageCtxT& image_ctx, plugin::Api<ImageCtxT>& plugin_api, Context* on_finish);
...
private:
    ...
    DiscardRequest(ImageCtxT& image_ctx, plugin::Api<ImageCtxT>& plugin_api, Context* on_finish);
