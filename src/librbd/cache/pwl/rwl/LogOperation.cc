...
#undef dout_prefix
#define dout_prefix *_dout << "librbd::cache::pwl::rwl::LogOperation: " << this << " " << __func__ << ": "
...
void WriteLogOperation::copy_bl_to_cache_buffer(std::vector<WriteBufferAllocation>::iterator allocation)
{
...
void DiscardLogOperation::init_op(uint64_t current_sync_gen, bool persist_on_flush, uint64_t last_op_sequence_num,
