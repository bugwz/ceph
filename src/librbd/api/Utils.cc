...
int create_encryption_format(CephContext* cct, encryption_format_t format, encryption_options_t opts, size_t opts_size,
                             bool c_api, crypto::EncryptionFormat<I>** result_format)
{
    ...
    case RBD_ENCRYPTION_FORMAT_LUKS1:
    {
        if (c_api) {
            ...
            if (expected_opts_size == opts_size) {
                ...
                *result_format = new crypto::luks::LUKS1EncryptionFormat<I>(cpp_opts->alg, cpp_opts->passphrase);
            }
        }
        break;
    }
    case RBD_ENCRYPTION_FORMAT_LUKS2:
    {
        if (c_api) {
            ...
            if (expected_opts_size == opts_size) {
                ...
                *result_format = new crypto::luks::LUKS2EncryptionFormat<I>(cpp_opts->alg, cpp_opts->passphrase);
            }
        }
        break;
    }
    case RBD_ENCRYPTION_FORMAT_LUKS:
    {
        if (c_api) {
            ...
            if (expected_opts_size == opts_size) {
                ...
                *result_format =
                    new crypto::luks::LUKSEncryptionFormat<I>({c_opts->passphrase, c_opts->passphrase_size});
            }
        }
        else {
            ...
            if (expected_opts_size == opts_size) {
                ...
                *result_format = new crypto::luks::LUKSEncryptionFormat<I>(cpp_opts->passphrase);
            }
        }
        break;
    }
#endif
    default: lderr(cct) << "unsupported encryption format: " << format << dendl; return -ENOTSUP;
    }
...
template int librbd::api::util::create_encryption_format(CephContext* cct, encryption_format_t format,
