    ...
    case RBD_ENCRYPTION_FORMAT_LUKS1:
    {
        if (c_api) {
            ...
            if (expected_opts_size == opts_size) {
                ...
                *result_format =
                    new crypto::luks::LUKS1EncryptionFormat<I>(cpp_opts->alg, std::move(cpp_opts->passphrase));
            }
        }
        break;
    }
    case RBD_ENCRYPTION_FORMAT_LUKS2:
    {
        if (c_api) {
            ...
            if (expected_opts_size == opts_size) {
                ...
                *result_format =
                    new crypto::luks::LUKS2EncryptionFormat<I>(cpp_opts->alg, std::move(cpp_opts->passphrase));
            }
        }
        break;
    }
