...
{
public:
    C_AsyncObjectThrottle(AsyncObjectThrottleFinisher& finisher, ImageCtxT& image_ctx)
...
protected:
    ...
    void finish(int r) override { m_finisher.finish_op(r); }
...
{
public:
    typedef boost::function<C_AsyncObjectThrottle<ImageCtxT>*(AsyncObjectThrottle&, uint64_t)> ContextFactory;

    AsyncObjectThrottle(const AsyncRequest<ImageCtxT>* async_request, ImageCtxT& image_ctx,
                        const ContextFactory& context_factory, Context* ctx, ProgressContext* prog_ctx,
