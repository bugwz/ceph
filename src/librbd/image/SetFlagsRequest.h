...
template<typename ImageCtxT = ImageCtx> class SetFlagsRequest
{
public:
    static SetFlagsRequest* create(ImageCtxT* image_ctx, uint64_t flags, uint64_t mask, Context* on_finish)
    {
...
private:
    ...
    SetFlagsRequest(ImageCtxT* image_ctx, uint64_t flags, uint64_t mask, Context* on_finish);
