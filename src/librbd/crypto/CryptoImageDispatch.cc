...
CryptoImageDispatch::CryptoImageDispatch(uint64_t data_offset)
    : m_data_offset(data_offset)
{}

void CryptoImageDispatch::remap_to_physical(io::Extents& image_extents, io::ImageArea area)
{
    switch (area) {
...
io::ImageArea CryptoImageDispatch::remap_to_logical(io::Extents& image_extents)
{
    bool saw_data = false;
