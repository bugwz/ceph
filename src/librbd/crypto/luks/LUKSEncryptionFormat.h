...
template<typename ImageCtxT> class EncryptionFormat : public crypto::EncryptionFormat<ImageCtxT>
{
public:
...
template<typename ImageCtxT> class LUKSEncryptionFormat : public EncryptionFormat<ImageCtxT>
{
public:
    ...
    void load(ImageCtxT* ictx, std::string* detected_format_name, Context* on_finish) override;

private:
    std::string_view m_passphrase;
};

template<typename ImageCtxT> class LUKS1EncryptionFormat : public EncryptionFormat<ImageCtxT>
{
public:
...
template<typename ImageCtxT> class LUKS2EncryptionFormat : public EncryptionFormat<ImageCtxT>
{
public:
...
extern template class librbd::crypto::luks::LUKSEncryptionFormat<librbd::ImageCtx>;
extern template class librbd::crypto::luks::LUKS1EncryptionFormat<librbd::ImageCtx>;
extern template class librbd::crypto::luks::LUKS2EncryptionFormat<librbd::ImageCtx>;
