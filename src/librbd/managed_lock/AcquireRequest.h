...
public:
    static AcquireRequest* create(librados::IoCtx& ioctx, Watcher* watcher, AsioEngine& asio_engine,
...
private:
    ...
    AcquireRequest(librados::IoCtx& ioctx, Watcher* watcher, AsioEngine& asio_engine, const std::string& oid,
                   const std::string& cookie, bool exclusive, bool blocklist_on_break_lock,
