...
template<typename I> struct ImageDispatcher<I>::PreprocessVisitor : public boost::static_visitor<bool>
{
    ...
    {
        int r = util::clip_request(image_dispatcher->m_image_ctx, &image_dispatch_spec->image_extents);
        if (r < 0) {
...
template<typename I> void ImageDispatcher<I>::remap_extents(Extents& image_extents, ImageExtentsMapType type)
{
