...
struct AioCompletion
{
    ...
    template<typename T, void (T::*MF)(int)> static void callback_adapter(completion_t cb, void* arg)
    {
    ...
    static AioCompletion* create(void* cb_arg, callback_t cb_complete, rbd_completion_t rbd_comp)
    {
    ...
    template<typename T, void (T::*MF)(int) = &T::complete> static AioCompletion* create(T* obj)
    {
        AioCompletion* comp = new AioCompletion();
    ...
    static AioCompletion* create_and_start(T* obj, ImageCtx* image_ctx, aio_type_t type)
    {
    ...
    void set_event_notify(bool s) { event_notify = s; }

    void* get_arg() { return complete_arg; }
...
{
public:
    C_AioRequest(AioCompletion* completion)
        : m_completion(completion)
    {
        m_completion->add_request();
    }
    ~C_AioRequest() override {}
    void finish(int r) override { m_completion->complete_request(r); }
