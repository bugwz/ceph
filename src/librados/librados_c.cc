                                                                  ...
                                                                  size_t value_len)
{
    ...
    ((::ObjectOperation*)write_op)->cmpxattr(name, comparison_operator, CEPH_OSD_CMPXATTR_MODE_STRING, bl);
                                                                  ...
                                                                  size_t val_len, int* prval)
{
    ...
    rados_c_omap_cmp((::ObjectOperation*)write_op, key, comparison_operator, val, strlen(key), val_len, prval);
...
{
    tracepoint(librados, rados_write_op_omap_cmp_enter, write_op, key, comparison_operator, val, val_len, prval);
    rados_c_omap_cmp((::ObjectOperation*)write_op, key, comparison_operator, val, key_len, val_len, prval);
    tracepoint(librados, rados_write_op_omap_cmp_exit);
}
                                                                        ...
                                                                        const char* key_end, size_t key_end_len)
{
    ...
    ((::ObjectOperation*)write_op)->omap_rm_range({key_begin, key_begin_len}, {key_end, key_end_len});
                                                                        ...
                                                                        uint64_t expected_write_size)
{
    ...
    ((::ObjectOperation*)write_op)->set_alloc_hint(expected_object_size, expected_write_size, 0);
                                                                         ...
                                                                         uint64_t expected_write_size, uint32_t flags)
{
    ...
    ((::ObjectOperation*)write_op)->set_alloc_hint(expected_object_size, expected_write_size, flags);
