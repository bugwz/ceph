...
#define LIBRADOS_C_API_BASE(fn)         extern __typeof(_##fn##_base) _##fn##_base __attribute__((__symver__(#fn "@")))
#define LIBRADOS_C_API_BASE_DEFAULT(fn) extern __typeof(_##fn) _##fn __attribute__((__symver__(#fn "@@")))
#define LIBRADOS_C_API_DEFAULT(fn, ver) extern __typeof(_##fn) _##fn __attribute__((__symver__(#fn "@@LIBRADOS_" #ver)))
#else
#define LIBRADOS_C_API_BASE(fn)         asm(".symver _" #fn "_base, " #fn "@")
#define LIBRADOS_C_API_BASE_DEFAULT(fn) asm(".symver _" #fn ", " #fn "@@")
#define LIBRADOS_C_API_DEFAULT(fn, ver) asm(".symver _" #fn ", " #fn "@@LIBRADOS_" #ver)
#endif
...
static CephContext* rados_create_cct(const char* const clustername, CephInitParameters* iparams)
{
    // missing things compared to global_init:
    // g_ceph_context, g_conf, g_lockdep, signal handlers
    CephContext* cct = common_preinit(*iparams, CODE_ENVIRONMENT_LIBRARY, 0);
    if (clustername) cct->_conf->cluster = clustername;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_create)(rados_t* pcluster, const char* const id)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_create2)(rados_t* pcluster, const char* const clustername,
 ...
 * their cluster.
 */
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_create_with_context)(rados_t* pcluster, rados_config_t cct_)
{
...
extern "C" uint64_t LIBRADOS_C_API_DEFAULT_F(rados_get_instance_id)(rados_t cluster)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_get_min_compatible_osd)(rados_t cluster, int8_t* require_osd_release)
{
    librados::RadosClient* client = (librados::RadosClient*)cluster;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_get_min_compatible_client)(rados_t cluster, int8_t* min_compat_client,
                                                                         int8_t* require_min_compat_client)
{
    librados::RadosClient* client = (librados::RadosClient*)cluster;
    return client->get_min_compatible_client(min_compat_client, require_min_compat_client);
}
LIBRADOS_C_API_BASE_DEFAULT(rados_get_min_compatible_client);

extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_version)(int* major, int* minor, int* extra)
{
    tracepoint(librados, rados_version_enter, major, minor, extra);
    if (major) *major = LIBRADOS_VER_MAJOR;
    if (minor) *minor = LIBRADOS_VER_MINOR;
    if (extra) *extra = LIBRADOS_VER_EXTRA;
...
// -- config --
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_conf_read_file)(rados_t cluster, const char* path_list)
{
    ...
    if (ret) {
        if (warnings.tellp() > 0) lderr(client->cct) << warnings.str() << dendl;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_conf_parse_argv)(rados_t cluster, int argc, const char** argv)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_conf_parse_argv_remainder)(rados_t cluster, int argc, const char** argv,
                                                                         const char** remargv)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_conf_parse_env)(rados_t cluster, const char* env)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_conf_set)(rados_t cluster, const char* option, const char* value)
{
...
/* cluster info */
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_cluster_stat)(rados_t cluster, rados_cluster_stat_t* result)
{
    ...
    tracepoint(
        librados, rados_cluster_stat_exit, r, result->kb, result->kb_used, result->kb_avail, result->num_objects);
    return r;
}
LIBRADOS_C_API_BASE_DEFAULT(rados_cluster_stat);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_conf_get)(rados_t cluster, const char* option, char* buf, size_t len)
{
...
extern "C" int64_t LIBRADOS_C_API_DEFAULT_F(rados_pool_lookup)(rados_t cluster, const char* name)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_pool_reverse_lookup)(rados_t cluster, int64_t id, char* buf,
                                                                   size_t maxlen)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_cluster_fsid)(rados_t cluster, char* buf, size_t maxlen)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_blocklist_add)(rados_t cluster, char* client_address,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_blacklist_add)(rados_t cluster, char* client_address,
                                                             uint32_t expire_seconds)
{
    return LIBRADOS_C_API_DEFAULT_F(rados_blocklist_add)(cluster, client_address, expire_seconds);
}
LIBRADOS_C_API_BASE_DEFAULT(rados_blacklist_add);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_getaddrs)(rados_t cluster, char** addrs)
{
    librados::RadosClient* radosp = (librados::RadosClient*)cluster;
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_set_osdmap_full_try)(rados_ioctx_t io)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_unset_osdmap_full_try)(rados_ioctx_t io)
{
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
    ctx->extra_op_flags &= ~CEPH_OSD_FLAG_FULL_TRY;
}
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_application_enable)(rados_ioctx_t io, const char* app_name, int force)
{
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_application_list)(rados_ioctx_t io, char* values, size_t* values_len)
{
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_application_metadata_get)(rados_ioctx_t io, const char* app_name,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_application_metadata_set)(rados_ioctx_t io, const char* app_name,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_application_metadata_remove)(rados_ioctx_t io, const char* app_name,
                                                                           const char* key)
{
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_application_metadata_list)(rados_ioctx_t io, const char* app_name,
                                                                         char* keys, size_t* keys_len, char* values,
                                                                         size_t* vals_len)
{
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_pool_list)(rados_t cluster, char* buf, size_t len)
{
    ...
    std::list<std::pair<int64_t, std::string>>::const_iterator p_end = pools.end();
    for (; i != p_end; ++i) {
        int rl = i->second.length() + 1;
        if (len < (unsigned)rl) break;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_inconsistent_pg_list)(rados_t cluster, int64_t pool_id, char* buf,
                                                                    size_t len)
{
...
static void dict_to_map(const char* dict, std::map<std::string, std::string>* dict_map)
{
    while (*dict != '\0') {
        const char* key = dict;
        dict += strlen(key) + 1;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_service_register)(rados_t cluster, const char* service,
                                                                const char* daemon, const char* metadata_dict)
{
    librados::RadosClient* client = (librados::RadosClient*)cluster;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_service_update_status)(rados_t cluster, const char* status_dict)
{
    librados::RadosClient* client = (librados::RadosClient*)cluster;
...
static void do_out_buffer(bufferlist& outbl, char** outbuf, size_t* outbuflen)
{
    ...
    if (outbuflen) *outbuflen = outbl.length();
}
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ping_monitor)(rados_t cluster, const char* mon_id, char** outstr,
                                                            size_t* outstrlen)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_mon_command)(rados_t cluster, const char** cmd, size_t cmdlen,
                                                           const char* inbuf, size_t inbuflen, char** outbuf,
                                                           size_t* outbuflen, char** outs, size_t* outslen)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_mon_command_target)(rados_t cluster, const char* name, const char** cmd,
                                                                  size_t cmdlen, const char* inbuf, size_t inbuflen,
                                                                  char** outbuf, size_t* outbuflen, char** outs,
                                                                  size_t* outslen)
{
    ...
    if ((errno == ERANGE && (rank == LONG_MAX || rank == LONG_MIN)) || (errno != 0 && rank == 0) ||
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_osd_command)(rados_t cluster, int osdid, const char** cmd, size_t cmdlen,
                                                           const char* inbuf, size_t inbuflen, char** outbuf,
                                                           size_t* outbuflen, char** outs, size_t* outslen)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_mgr_command)(rados_t cluster, const char** cmd, size_t cmdlen,
                                                           const char* inbuf, size_t inbuflen, char** outbuf,
                                                           size_t* outbuflen, char** outs, size_t* outslen)
{
    tracepoint(librados, rados_mgr_command_enter, cluster, cmdlen, inbuf, inbuflen);
    ...
    do_out_buffer(outbl, outbuf, outbuflen);
    do_out_buffer(outstring, outs, outslen);
    tracepoint(librados, rados_mgr_command_exit, ret, outbuf, outbuflen, outs, outslen);
    return ret;
}
LIBRADOS_C_API_BASE_DEFAULT(rados_mgr_command);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_mgr_command_target)(rados_t cluster, const char* name, const char** cmd,
                                                                  size_t cmdlen, const char* inbuf, size_t inbuflen,
                                                                  char** outbuf, size_t* outbuflen, char** outs,
                                                                  size_t* outslen)
{
    tracepoint(librados, rados_mgr_command_target_enter, cluster, name, cmdlen, inbuf, inbuflen);
    ...
    do_out_buffer(outbl, outbuf, outbuflen);
    do_out_buffer(outstring, outs, outslen);
    tracepoint(librados, rados_mgr_command_target_exit, ret, outbuf, outbuflen, outs, outslen);
    return ret;
}
LIBRADOS_C_API_BASE_DEFAULT(rados_mgr_command_target);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_pg_command)(rados_t cluster, const char* pgstr, const char** cmd,
                                                          size_t cmdlen, const char* inbuf, size_t inbuflen,
                                                          char** outbuf, size_t* outbuflen, char** outs,
                                                          size_t* outslen)
{
    ...
    inbl.append(inbuf, inbuflen);
    if (!pgid.parse(pgstr)) return -EINVAL;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_monitor_log)(rados_t cluster, const char* level, rados_log_callback_t cb,
                                                           void* arg)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_monitor_log2)(rados_t cluster, const char* level,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_create)(rados_t cluster, const char* name, rados_ioctx_t* io)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_create2)(rados_t cluster, int64_t pool_id, rados_ioctx_t* io)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_pool_stat)(rados_ioctx_t io, struct rados_pool_stat_t* stats)
{
    ...
    uint64_t allocated_bytes = r.get_allocated_data_bytes(per_pool) + r.get_allocated_omap_bytes(per_pool);
    ...
    uint64_t user_bytes = r.get_user_data_bytes(1.0, per_pool) + r.get_user_omap_bytes(1.0, per_pool);
    ...
    stats->num_objects_degraded =
        r.stats.sum.num_objects_degraded + r.stats.sum.num_objects_misplaced;   // FIXME: this is imprecise
...
extern "C" int LIBRADOS_C_API_BASE_F(rados_ioctx_pool_stat)(rados_ioctx_t io,
                                                            struct __librados_base::rados_pool_stat_t* stats)
{
...
extern "C" rados_config_t LIBRADOS_C_API_DEFAULT_F(rados_ioctx_cct)(rados_ioctx_t io)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_ioctx_snap_set_read)(rados_ioctx_t io, rados_snap_t seq)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_selfmanaged_snap_set_write_ctx)(rados_ioctx_t io, rados_snap_t seq,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_write)(rados_ioctx_t io, const char* o, const char* buf, size_t len,
                                                     uint64_t off)
{
    tracepoint(librados, rados_write_enter, io, o, buf, len, off);
    if (len > UINT_MAX / 2) return -E2BIG;
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
    object_t oid(o);
    bufferlist bl;
    bl.append(buf, len);
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_append)(rados_ioctx_t io, const char* o, const char* buf, size_t len)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_write_full)(rados_ioctx_t io, const char* o, const char* buf, size_t len)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_writesame)(rados_ioctx_t io, const char* o, const char* buf,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_trunc)(rados_ioctx_t io, const char* o, uint64_t size)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_remove)(rados_ioctx_t io, const char* o)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_read)(rados_ioctx_t io, const char* o, char* buf, size_t len,
                                                    uint64_t off)
{
    ...
    if (ret >= 0) {
        ...
        if (!bl.is_provided_buffer(buf)) bl.begin().copy(bl.length(), buf);
        ret = bl.length();   // hrm :/
    }
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_checksum)(rados_ioctx_t io, const char* o, rados_checksum_type_t type,
                                                        const char* init_value, size_t init_value_len, size_t len,
                                                        uint64_t off, size_t chunk_size, char* pchecksum,
                                                        size_t checksum_len)
{
    tracepoint(librados, rados_checksum_enter, io, o, type, init_value, init_value_len, len, off, chunk_size);
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
    object_t oid(o);
    ...
    int retval = ctx->checksum(oid, get_checksum_op_type(type), init_value_bl, len, off, chunk_size, &checksum_bl);
    if (retval >= 0) {
...
extern "C" uint64_t LIBRADOS_C_API_DEFAULT_F(rados_get_last_version)(rados_ioctx_t io)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_pool_create)(rados_t cluster, const char* name)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_pool_create_with_auid)(rados_t cluster, const char* name, uint64_t auid)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_pool_create_with_crush_rule)(rados_t cluster, const char* name,
                                                                           __u8 crush_rule_num)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_pool_create_with_all)(rados_t cluster, const char* name, uint64_t auid,
                                                                    __u8 crush_rule_num)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_pool_get_base_tier)(rados_t cluster, int64_t pool_id, int64_t* base_tier)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_pool_set_auid)(rados_ioctx_t io, uint64_t auid)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_pool_get_auid)(rados_ioctx_t io, uint64_t* auid)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_pool_requires_alignment)(rados_ioctx_t io)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_pool_requires_alignment2)(rados_ioctx_t io, int* req)
{
    tracepoint(librados, rados_ioctx_pool_requires_alignment_enter2, io);
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
    bool requires_alignment;
    int retval = ctx->client->pool_requires_alignment2(ctx->get_id(), &requires_alignment);
    tracepoint(librados, rados_ioctx_pool_requires_alignment_exit2, retval, requires_alignment);
    if (req) *req = requires_alignment;
    return retval;
}
LIBRADOS_C_API_BASE_DEFAULT(rados_ioctx_pool_requires_alignment2);

extern "C" uint64_t LIBRADOS_C_API_DEFAULT_F(rados_ioctx_pool_required_alignment)(rados_ioctx_t io)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_pool_required_alignment2)(rados_ioctx_t io, uint64_t* alignment)
{
    tracepoint(librados, rados_ioctx_pool_required_alignment_enter2, io);
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
    int retval = ctx->client->pool_required_alignment2(ctx->get_id(), alignment);
    tracepoint(librados, rados_ioctx_pool_required_alignment_exit2, retval, *alignment);
    return retval;
}
LIBRADOS_C_API_BASE_DEFAULT(rados_ioctx_pool_required_alignment2);

extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_ioctx_locator_set_key)(rados_ioctx_t io, const char* key)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_ioctx_set_namespace)(rados_ioctx_t io, const char* nspace)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_get_namespace)(rados_ioctx_t io, char* s, unsigned maxlen)
{
...
extern "C" int64_t LIBRADOS_C_API_DEFAULT_F(rados_ioctx_get_id)(rados_ioctx_t io)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_get_pool_name)(rados_ioctx_t io, char* s, unsigned maxlen)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_snap_create)(rados_ioctx_t io, const char* snapname)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_snap_remove)(rados_ioctx_t io, const char* snapname)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_snap_rollback)(rados_ioctx_t io, const char* oid,
                                                                   const char* snapname)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_rollback)(rados_ioctx_t io, const char* oid, const char* snapname)
{
    return LIBRADOS_C_API_DEFAULT_F(rados_ioctx_snap_rollback)(io, oid, snapname);
}
LIBRADOS_C_API_BASE_DEFAULT(rados_rollback);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_selfmanaged_snap_create)(rados_ioctx_t io, uint64_t* snapid)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_aio_ioctx_selfmanaged_snap_create)(rados_ioctx_t io,
                                                                                  rados_snap_t* snapid,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_selfmanaged_snap_remove)(rados_ioctx_t io, uint64_t snapid)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_aio_ioctx_selfmanaged_snap_remove)(rados_ioctx_t io, rados_snap_t snapid,
                                                                                  rados_completion_t completion)
{
    tracepoint(librados, rados_ioctx_selfmanaged_snap_remove_enter, io, snapid);
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_selfmanaged_snap_rollback)(rados_ioctx_t io, const char* oid,
                                                                               uint64_t snapid)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_snap_list)(rados_ioctx_t io, rados_snap_t* snaps, int maxlen)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_snap_lookup)(rados_ioctx_t io, const char* name, rados_snap_t* id)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_snap_get_name)(rados_ioctx_t io, rados_snap_t id, char* name,
                                                                   int maxlen)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_ioctx_snap_get_stamp)(rados_ioctx_t io, rados_snap_t id, time_t* t)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_cmpext)(rados_ioctx_t io, const char* o, const char* cmp_buf,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_getxattr)(rados_ioctx_t io, const char* o, const char* name, char* buf,
                                                        size_t len)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_getxattrs)(rados_ioctx_t io, const char* oid, rados_xattrs_iter_t* iter)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_getxattrs_next)(rados_xattrs_iter_t iter, const char** name,
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_getxattrs_end)(rados_xattrs_iter_t iter)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_setxattr)(rados_ioctx_t io, const char* o, const char* name,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_rmxattr)(rados_ioctx_t io, const char* o, const char* name)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_stat)(rados_ioctx_t io, const char* o, uint64_t* psize, time_t* pmtime)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_stat2)(rados_ioctx_t io, const char* o, uint64_t* psize,
...
extern "C" int LIBRADOS_C_API_BASE_F(rados_tmap_update)(rados_ioctx_t io, const char* o, const char* cmdbuf,
                                                        size_t cmdbuflen)
{
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
    object_t oid(o);
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_tmap_update)(rados_ioctx_t io, const char* o, const char* cmdbuf,
                                                           size_t cmdbuflen)
{
    return -ENOTSUP;
}
...
extern "C" int LIBRADOS_C_API_BASE_F(rados_tmap_put)(rados_ioctx_t io, const char* o, const char* buf, size_t buflen)
{
    bufferlist bl;
    ...
    return LIBRADOS_C_API_DEFAULT_F(rados_write_full)(io, o, out_bl.c_str(), out_bl.length());
}
LIBRADOS_C_API_BASE(rados_tmap_put);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_tmap_put)(rados_ioctx_t io, const char* o, const char* buf, size_t buflen)
{
    return -EOPNOTSUPP;
}
LIBRADOS_C_API_DEFAULT(rados_tmap_put, 14.2.0);

extern "C" int LIBRADOS_C_API_BASE_F(rados_tmap_get)(rados_ioctx_t io, const char* o, char* buf, size_t buflen)
{
    return LIBRADOS_C_API_DEFAULT_F(rados_read)(io, o, buf, buflen, 0);
}
LIBRADOS_C_API_BASE(rados_tmap_get);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_tmap_get)(rados_ioctx_t io, const char* o, char* buf, size_t buflen)
{
    return -EOPNOTSUPP;
}
LIBRADOS_C_API_DEFAULT(rados_tmap_get, 14.2.0);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_exec)(rados_ioctx_t io, const char* o, const char* cls,
                                                    const char* method, const char* inbuf, size_t in_len, char* buf,
                                                    size_t out_len)
{
...
extern "C" rados_object_list_cursor LIBRADOS_C_API_DEFAULT_F(rados_object_list_begin)(rados_ioctx_t io)
{
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
...
extern "C" rados_object_list_cursor LIBRADOS_C_API_DEFAULT_F(rados_object_list_end)(rados_ioctx_t io)
{
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_object_list_is_end)(rados_ioctx_t io, rados_object_list_cursor cur)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_object_list_cursor_free)(rados_ioctx_t io, rados_object_list_cursor cur)
{
    hobject_t* hobj = (hobject_t*)cur;
    delete hobj;
}
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_object_list_cursor_cmp)(rados_ioctx_t io,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_object_list)(rados_ioctx_t io, const rados_object_list_cursor start,
                                                           const rados_object_list_cursor finish,
                                                           const size_t result_item_count, const char* filter_buf,
                                                           ...
                                                           rados_object_list_cursor* next)
{
    ...
    ceph::async::waiter<boost::system::error_code, std::vector<librados::ListObjectImpl>, hobject_t> w;
    ctx->objecter->enumerate_objects<librados::ListObjectImpl>(
        ctx->poolid, ctx->oloc.nspace, *((hobject_t*)start), *((hobject_t*)finish), result_item_count, filter_bl, w);
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_object_list_free)(const size_t result_size,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_nobjects_list_open)(rados_ioctx_t io, rados_list_ctx_t* listh)
{
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_nobjects_list_close)(rados_list_ctx_t h)
{
...
extern "C" uint32_t LIBRADOS_C_API_DEFAULT_F(rados_nobjects_list_seek)(rados_list_ctx_t listctx, uint32_t pos)
{
...
extern "C" uint32_t LIBRADOS_C_API_DEFAULT_F(rados_nobjects_list_seek_cursor)(rados_list_ctx_t listctx,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_nobjects_list_get_cursor)(rados_list_ctx_t listctx,
                                                                        rados_object_list_cursor* cursor)
{
    librados::ObjListCtx* lh = (librados::ObjListCtx*)listctx;
...
extern "C" uint32_t LIBRADOS_C_API_DEFAULT_F(rados_nobjects_list_get_pg_hash_position)(rados_list_ctx_t listctx)
{
    librados::ObjListCtx* lh = (librados::ObjListCtx*)listctx;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_nobjects_list_next)(rados_list_ctx_t listctx, const char** entry,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_nobjects_list_next2)(rados_list_ctx_t listctx, const char** entry,
                                                                   const char** key, const char** nspace,
                                                                   size_t* entry_size, size_t* key_size,
                                                                   size_t* nspace_size)
{
    ...
    *entry = h->list.front().oid.c_str();
    ...
    if (nspace) *nspace = h->list.front().nspace.c_str();

    if (entry_size) *entry_size = h->list.front().oid.size();
    if (key_size) *key_size = h->list.front().locator.size();
    if (nspace_size) *nspace_size = h->list.front().nspace.size();

    tracepoint(librados, rados_nobjects_list_next2_exit, 0, entry, key, nspace, entry_size, key_size, nspace_size);
    return 0;
}
 ...
 */
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_objects_list_open)(rados_ioctx_t io, rados_list_ctx_t* ctx)
{
    return -ENOTSUP;
}
LIBRADOS_C_API_BASE_DEFAULT(rados_objects_list_open);

extern "C" uint32_t LIBRADOS_C_API_DEFAULT_F(rados_objects_list_get_pg_hash_position)(rados_list_ctx_t ctx)
{
    return 0;
}
LIBRADOS_C_API_BASE_DEFAULT(rados_objects_list_get_pg_hash_position);

extern "C" uint32_t LIBRADOS_C_API_DEFAULT_F(rados_objects_list_seek)(rados_list_ctx_t ctx, uint32_t pos)
{
    return 0;
}
LIBRADOS_C_API_BASE_DEFAULT(rados_objects_list_seek);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_objects_list_next)(rados_list_ctx_t ctx, const char** entry,
                                                                 const char** key)
{
    return -ENOTSUP;
}
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_objects_list_close)(rados_list_ctx_t ctx) {}
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_create_completion)(void* cb_arg, rados_callback_t cb_complete,
                                                                     rados_callback_t cb_safe, rados_completion_t* pc)
{
    ...
    if (cb_complete) c->set_complete_callback(cb_arg, cb_complete);
    if (cb_safe) c->set_safe_callback(cb_arg, cb_safe);
    *pc = c;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_create_completion2)(void* cb_arg, rados_callback_t cb_complete,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_wait_for_complete)(rados_completion_t c)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_wait_for_safe)(rados_completion_t c)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_is_complete)(rados_completion_t c)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_is_safe)(rados_completion_t c)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_wait_for_complete_and_cb)(rados_completion_t c)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_wait_for_safe_and_cb)(rados_completion_t c)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_is_complete_and_cb)(rados_completion_t c)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_is_safe_and_cb)(rados_completion_t c)
{
...
extern "C" uint64_t LIBRADOS_C_API_DEFAULT_F(rados_aio_get_version)(rados_completion_t c)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_aio_release)(rados_completion_t c)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_read)(rados_ioctx_t io, const char* o, rados_completion_t completion,
                                                        char* buf, size_t len, uint64_t off)
{
    tracepoint(librados, rados_aio_read_enter, io, o, completion, len, off);
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
    object_t oid(o);
    int retval = ctx->aio_read(oid, (librados::AioCompletionImpl*)completion, buf, len, off, ctx->snap_seq);
...
#ifdef WITH_BLKIN
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_read_traced)(rados_ioctx_t io, const char* o,
                                                               rados_completion_t completion, char* buf, size_t len,
                                                               uint64_t off, struct blkin_trace_info* info)
{
    tracepoint(librados, rados_aio_read_enter, io, o, completion, len, off);
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
    object_t oid(o);
    int retval = ctx->aio_read(oid, (librados::AioCompletionImpl*)completion, buf, len, off, ctx->snap_seq, info);
    tracepoint(librados, rados_aio_read_exit, retval);
    return retval;
}
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_write)(rados_ioctx_t io, const char* o, rados_completion_t completion,
                                                         const char* buf, size_t len, uint64_t off)
{
    ...
    bufferlist bl;
    bl.append(buf, len);
    int retval = ctx->aio_write(oid, (librados::AioCompletionImpl*)completion, bl, len, off);
...
#ifdef WITH_BLKIN
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_write_traced)(rados_ioctx_t io, const char* o,
                                                                rados_completion_t completion, const char* buf,
                                                                size_t len, uint64_t off, struct blkin_trace_info* info)
{
    tracepoint(librados, rados_aio_write_enter, io, o, completion, buf, len, off);
    if (len > UINT_MAX / 2) return -E2BIG;
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
    ...
    bufferlist bl;
    bl.append(buf, len);
    int retval = ctx->aio_write(oid, (librados::AioCompletionImpl*)completion, bl, len, off, info);
    tracepoint(librados, rados_aio_write_exit, retval);
    return retval;
}
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_append)(rados_ioctx_t io, const char* o,
                                                          rados_completion_t completion, const char* buf, size_t len)
{
    ...
    bufferlist bl;
    bl.append(buf, len);
    int retval = ctx->aio_append(oid, (librados::AioCompletionImpl*)completion, bl, len);
    tracepoint(librados, rados_aio_append_exit, retval);
    return retval;
}
LIBRADOS_C_API_BASE_DEFAULT(rados_aio_append);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_write_full)(rados_ioctx_t io, const char* o,
                                                              rados_completion_t completion, const char* buf,
                                                              size_t len)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_writesame)(rados_ioctx_t io, const char* o,
                                                             rados_completion_t completion, const char* buf,
                                                             size_t data_len, size_t write_len, uint64_t off)
{
    tracepoint(librados, rados_aio_writesame_enter, io, o, completion, buf, data_len, write_len, off);
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
    object_t oid(o);
    bufferlist bl;
    bl.append(buf, data_len);
    int retval = ctx->aio_writesame(o, (librados::AioCompletionImpl*)completion, bl, write_len, off);
    tracepoint(librados, rados_aio_writesame_exit, retval);
    return retval;
}
LIBRADOS_C_API_BASE_DEFAULT(rados_aio_writesame);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_remove)(rados_ioctx_t io, const char* o,
                                                          rados_completion_t completion)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_flush_async)(rados_ioctx_t io, rados_completion_t completion)
{
...
struct AioGetxattrData
{
    AioGetxattrData(char* buf, rados_completion_t c, size_t l)
        : user_buf(buf)
        , len(l)
        , user_completion((librados::AioCompletionImpl*)c)
    {}
    bufferlist bl;
    char* user_buf;
    size_t len;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_getxattr)(rados_ioctx_t io, const char* o,
                                                            rados_completion_t completion, const char* name, char* buf,
                                                            size_t len)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_getxattrs)(rados_ioctx_t io, const char* oid,
                                                             rados_completion_t completion, rados_xattrs_iter_t* iter)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_setxattr)(rados_ioctx_t io, const char* o,
                                                            rados_completion_t completion, const char* name,
                                                            const char* buf, size_t len)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_rmxattr)(rados_ioctx_t io, const char* o,
                                                           rados_completion_t completion, const char* name)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_stat)(rados_ioctx_t io, const char* o, rados_completion_t completion,
                                                        uint64_t* psize, time_t* pmtime)
{
    tracepoint(librados, rados_aio_stat_enter, io, o, completion);
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
    object_t oid(o);
    int retval = ctx->aio_stat(oid, (librados::AioCompletionImpl*)completion, psize, pmtime);
    tracepoint(librados, rados_aio_stat_exit, retval);
    return retval;
}
LIBRADOS_C_API_BASE_DEFAULT(rados_aio_stat);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_stat2)(rados_ioctx_t io, const char* o, rados_completion_t completion,
                                                         uint64_t* psize, struct timespec* pmtime)
{
    tracepoint(librados, rados_aio_stat2_enter, io, o, completion);
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
    object_t oid(o);
    int retval = ctx->aio_stat2(oid, (librados::AioCompletionImpl*)completion, psize, pmtime);
    tracepoint(librados, rados_aio_stat2_exit, retval);
    return retval;
}
LIBRADOS_C_API_BASE_DEFAULT(rados_aio_stat2);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_cmpext)(rados_ioctx_t io, const char* o,
                                                          rados_completion_t completion, const char* cmp_buf,
                                                          size_t cmp_len, uint64_t off)
{
    tracepoint(librados, rados_aio_cmpext_enter, io, o, completion, cmp_buf, cmp_len, off);
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
    object_t oid(o);
    int retval = ctx->aio_cmpext(oid, (librados::AioCompletionImpl*)completion, cmp_buf, cmp_len, off);
    tracepoint(librados, rados_aio_cmpext_exit, retval);
    return retval;
}
LIBRADOS_C_API_BASE_DEFAULT(rados_aio_cmpext);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_cancel)(rados_ioctx_t io, rados_completion_t completion)
{
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_exec)(rados_ioctx_t io, const char* o, rados_completion_t completion,
                                                        const char* cls, const char* method, const char* inbuf,
                                                        size_t in_len, char* buf, size_t out_len)
{
    ...
    bufferlist inbl;
    inbl.append(inbuf, in_len);
    int retval = ctx->aio_exec(oid, (librados::AioCompletionImpl*)completion, cls, method, inbl, buf, out_len);
...
struct C_WatchCB : public librados::WatchCtx
{
    rados_watchcb_t wcb;
    void* arg;
    C_WatchCB(rados_watchcb_t _wcb, void* _arg)
        : wcb(_wcb)
        , arg(_arg)
    {}
    void notify(uint8_t opcode, uint64_t ver, bufferlist& bl) override { wcb(opcode, ver, arg); }
};

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_watch)(rados_ioctx_t io, const char* o, uint64_t ver, uint64_t* handle,
...
struct C_WatchCB2 : public librados::WatchCtx2
{
    ...
    void* arg;
    C_WatchCB2(rados_watchcb2_t _wcb, rados_watcherrcb_t _errcb, void* _arg)
        : wcb(_wcb)
        , errcb(_errcb)
        , arg(_arg)
    {}
    void handle_notify(uint64_t notify_id, uint64_t cookie, uint64_t notifier_gid, bufferlist& bl) override
    {
        wcb(arg, notify_id, cookie, notifier_gid, bl.c_str(), bl.length());
    }
    void handle_error(uint64_t cookie, int err) override
    {
        if (errcb) errcb(arg, cookie, err);
    }
};

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_watch3)(rados_ioctx_t io, const char* o, uint64_t* handle,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_watch2)(rados_ioctx_t io, const char* o, uint64_t* handle,
                                                      rados_watchcb2_t watchcb, rados_watcherrcb_t watcherrcb,
                                                      void* arg)
{
    return LIBRADOS_C_API_DEFAULT_F(rados_watch3)(io, o, handle, watchcb, watcherrcb, 0, arg);
}
LIBRADOS_C_API_BASE_DEFAULT(rados_watch2);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_watch2)(rados_ioctx_t io, const char* o,
                                                          ...
                                                          uint32_t timeout, void* arg)
{
    ...
    if (!completion || !watchcb || !o || !handle) {
        ...
        librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
        object_t oid(o);
        librados::AioCompletionImpl* c = reinterpret_cast<librados::AioCompletionImpl*>(completion);
        C_WatchCB2* wc = new C_WatchCB2(watchcb, watcherrcb, arg);
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_watch)(rados_ioctx_t io, const char* o, rados_completion_t completion,
                                                         uint64_t* handle, rados_watchcb2_t watchcb,
                                                         rados_watcherrcb_t watcherrcb, void* arg)
{
    return LIBRADOS_C_API_DEFAULT_F(rados_aio_watch2)(io, o, completion, handle, watchcb, watcherrcb, 0, arg);
}
LIBRADOS_C_API_BASE_DEFAULT(rados_aio_watch);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_unwatch)(rados_ioctx_t io, const char* o, uint64_t handle)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_unwatch2)(rados_ioctx_t io, uint64_t handle)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_unwatch)(rados_ioctx_t io, uint64_t handle,
                                                           rados_completion_t completion)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_watch_check)(rados_ioctx_t io, uint64_t handle)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_notify)(rados_ioctx_t io, const char* o, uint64_t ver, const char* buf,
                                                      int buf_len)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_notify2)(rados_ioctx_t io, const char* o, const char* buf, int buf_len,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_decode_notify_response)(char* reply_buffer, size_t reply_buffer_len,
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_free_notify_response)(struct notify_ack_t* acks, size_t nr_acks,
                                                                     struct notify_timeout_t* timeouts)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_notify)(rados_ioctx_t io, const char* o,
                                                          rados_completion_t completion, const char* buf, int buf_len,
                                                          uint64_t timeout_ms, char** reply_buffer,
                                                          size_t* reply_buffer_len)
{
    tracepoint(librados, rados_aio_notify_enter, io, o, completion, buf, buf_len, timeout_ms);
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
    object_t oid(o);
    bufferlist bl;
    if (buf) {
    ...
    librados::AioCompletionImpl* c = reinterpret_cast<librados::AioCompletionImpl*>(completion);
    int ret = ctx->aio_notify(oid, c, bl, timeout_ms, NULL, reply_buffer, reply_buffer_len);
    tracepoint(librados, rados_aio_notify_exit, ret);
    return ret;
}
LIBRADOS_C_API_BASE_DEFAULT(rados_aio_notify);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_notify_ack)(rados_ioctx_t io, const char* o, uint64_t notify_id,
                                                          uint64_t handle, const char* buf, int buf_len)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_watch_flush)(rados_t cluster, rados_completion_t completion)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_set_alloc_hint)(rados_ioctx_t io, const char* o,
                                                              ...
                                                              uint64_t expected_write_size)
{
    ...
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
    object_t oid(o);
    int retval = ctx->set_alloc_hint(oid, expected_object_size, expected_write_size, 0);
    tracepoint(librados, rados_set_alloc_hint_exit, retval);
    return retval;
}
LIBRADOS_C_API_BASE_DEFAULT(rados_set_alloc_hint);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_set_alloc_hint2)(rados_ioctx_t io, const char* o,
                                                               uint64_t expected_object_size,
                                                               uint64_t expected_write_size, uint32_t flags)
{
    ...
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
    object_t oid(o);
    int retval = ctx->set_alloc_hint(oid, expected_object_size, expected_write_size, flags);
    tracepoint(librados, rados_set_alloc_hint2_exit, retval);
    return retval;
}
LIBRADOS_C_API_BASE_DEFAULT(rados_set_alloc_hint2);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_lock_exclusive)(rados_ioctx_t io, const char* o, const char* name,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_lock_shared)(rados_ioctx_t io, const char* o, const char* name,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_unlock)(rados_ioctx_t io, const char* o, const char* name,
                                                      const char* cookie)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_unlock)(rados_ioctx_t io, const char* o, const char* name,
...
extern "C" ssize_t LIBRADOS_C_API_DEFAULT_F(rados_list_lockers)(rados_ioctx_t io, const char* o, const char* name,
                                                                ...
                                                                size_t* cookies_len, char* addrs, size_t* addrs_len)
{
    ...
    if (r < 0) {
        tracepoint(
            librados, rados_list_lockers_exit, r, *exclusive, "", *tag_len, *clients_len, *cookies_len, *addrs_len);
        return r;
    }
    ...
    *tag_len = tag_str.length() + 1;
    ...
    tracepoint(
        librados, rados_list_lockers_exit, retval, *exclusive, tag, *tag_len, *clients_len, *cookies_len, *addrs_len);
    return retval;
}
LIBRADOS_C_API_BASE_DEFAULT(rados_list_lockers);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_break_lock)(rados_ioctx_t io, const char* o, const char* name,
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_release_write_op)(rados_write_op_t write_op)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_set_flags)(rados_write_op_t write_op, int flags)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_assert_version)(rados_write_op_t write_op, uint64_t ver)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_assert_exists)(rados_write_op_t write_op)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_cmpext)(rados_write_op_t write_op, const char* cmp_buf,
                                                                size_t cmp_len, uint64_t off, int* prval)
{
    tracepoint(librados, rados_write_op_cmpext_enter, write_op, cmp_buf, cmp_len, off, prval);
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_cmpxattr)(rados_write_op_t write_op, const char* name,
                                                                  uint8_t comparison_operator, const char* value,
                                                                  size_t value_len)
{
    ...
    to_object_operation(write_op)->cmpxattr(name, comparison_operator, CEPH_OSD_CMPXATTR_MODE_STRING, bl);
    tracepoint(librados, rados_write_op_cmpxattr_exit);
}
LIBRADOS_C_API_BASE_DEFAULT(rados_write_op_cmpxattr);

static void rados_c_omap_cmp(ObjectOperation* op, const char* key, uint8_t comparison_operator, const char* val,
                             size_t key_len, size_t val_len, int* prval)
{
    bufferlist bl;
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_omap_cmp)(rados_write_op_t write_op, const char* key,
                                                                  uint8_t comparison_operator, const char* val,
                                                                  size_t val_len, int* prval)
{
    tracepoint(librados, rados_write_op_omap_cmp_enter, write_op, key, comparison_operator, val, val_len, prval);
    rados_c_omap_cmp(to_object_operation(write_op), key, comparison_operator, val, strlen(key), val_len, prval);
    tracepoint(librados, rados_write_op_omap_cmp_exit);
}
LIBRADOS_C_API_BASE_DEFAULT(rados_write_op_omap_cmp);

extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_omap_cmp2)(rados_write_op_t write_op, const char* key,
                                                                   uint8_t comparison_operator, const char* val,
                                                                   size_t key_len, size_t val_len, int* prval)
{
    tracepoint(librados, rados_write_op_omap_cmp_enter, write_op, key, comparison_operator, val, val_len, prval);
    rados_c_omap_cmp(to_object_operation(write_op), key, comparison_operator, val, key_len, val_len, prval);
    tracepoint(librados, rados_write_op_omap_cmp_exit);
}
LIBRADOS_C_API_BASE_DEFAULT(rados_write_op_omap_cmp2);

extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_setxattr)(rados_write_op_t write_op, const char* name,
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_rmxattr)(rados_write_op_t write_op, const char* name)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_create)(rados_write_op_t write_op, int exclusive,
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_write)(rados_write_op_t write_op, const char* buffer,
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_write_full)(rados_write_op_t write_op, const char* buffer,
                                                                    size_t len)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_writesame)(rados_write_op_t write_op, const char* buffer,
                                                                   size_t data_len, size_t write_len, uint64_t offset)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_append)(rados_write_op_t write_op, const char* buffer,
                                                                size_t len)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_remove)(rados_write_op_t write_op)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_truncate)(rados_write_op_t write_op, uint64_t offset)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_zero)(rados_write_op_t write_op, uint64_t offset, uint64_t len)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_exec)(rados_write_op_t write_op, const char* cls,
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_omap_set)(rados_write_op_t write_op, char const* const* keys,
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_omap_set2)(rados_write_op_t write_op, char const* const* keys,
                                                                   char const* const* vals, const size_t* key_lens,
                                                                   const size_t* val_lens, size_t num)
{
    tracepoint(librados, rados_write_op_omap_set_enter, write_op, num);
    std::map<std::string, bufferlist> entries;
    for (size_t i = 0; i < num; ++i) {
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_omap_rm_keys)(rados_write_op_t write_op,
                                                                      char const* const* keys, size_t keys_len)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_omap_rm_keys2)(rados_write_op_t write_op,
                                                                       char const* const* keys, const size_t* key_lens,
                                                                       size_t keys_len)
{
    tracepoint(librados, rados_write_op_omap_rm_keys_enter, write_op, keys_len);
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_omap_rm_range2)(rados_write_op_t write_op,
                                                                        const char* key_begin, size_t key_begin_len,
                                                                        const char* key_end, size_t key_end_len)
{
    tracepoint(librados, rados_write_op_omap_rm_range_enter, write_op, key_begin, key_end);
    to_object_operation(write_op)->omap_rm_range({key_begin, key_begin_len}, {key_end, key_end_len});
    tracepoint(librados, rados_write_op_omap_rm_range_exit);
}
LIBRADOS_C_API_BASE_DEFAULT(rados_write_op_omap_rm_range2);

extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_omap_clear)(rados_write_op_t write_op)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_set_alloc_hint)(rados_write_op_t write_op,
                                                                        uint64_t expected_object_size,
                                                                        uint64_t expected_write_size)
{
    tracepoint(librados, rados_write_op_set_alloc_hint_enter, write_op, expected_object_size, expected_write_size);
    to_object_operation(write_op)->set_alloc_hint(expected_object_size, expected_write_size, 0);
    tracepoint(librados, rados_write_op_set_alloc_hint_exit);
}
LIBRADOS_C_API_BASE_DEFAULT(rados_write_op_set_alloc_hint);

extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_write_op_set_alloc_hint2)(rados_write_op_t write_op,
                                                                         uint64_t expected_object_size,
                                                                         uint64_t expected_write_size, uint32_t flags)
{
    tracepoint(
        librados, rados_write_op_set_alloc_hint2_enter, write_op, expected_object_size, expected_write_size, flags);
    to_object_operation(write_op)->set_alloc_hint(expected_object_size, expected_write_size, flags);
    tracepoint(librados, rados_write_op_set_alloc_hint2_exit);
}
LIBRADOS_C_API_BASE_DEFAULT(rados_write_op_set_alloc_hint2);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_write_op_operate)(rados_write_op_t write_op, rados_ioctx_t io,
                                                                const char* oid, time_t* mtime, int flags)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_write_op_operate2)(rados_write_op_t write_op, rados_ioctx_t io,
                                                                 const char* oid, struct timespec* ts, int flags)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_write_op_operate)(rados_write_op_t write_op, rados_ioctx_t io,
                                                                    rados_completion_t completion, const char* oid,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_write_op_operate2)(rados_write_op_t write_op, rados_ioctx_t io,
                                                                     rados_completion_t completion, const char* oid,
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_release_read_op)(rados_read_op_t read_op)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_set_flags)(rados_read_op_t read_op, int flags)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_assert_version)(rados_read_op_t read_op, uint64_t ver)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_assert_exists)(rados_read_op_t read_op)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_cmpext)(rados_read_op_t read_op, const char* cmp_buf,
                                                               size_t cmp_len, uint64_t off, int* prval)
{
    tracepoint(librados, rados_read_op_cmpext_enter, read_op, cmp_buf, cmp_len, off, prval);
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_cmpxattr)(rados_read_op_t read_op, const char* name,
                                                                 uint8_t comparison_operator, const char* value,
                                                                 size_t value_len)
{
    ...
    bufferlist bl;
    bl.append(value, value_len);
    ((::ObjectOperation*)read_op)->cmpxattr(name, comparison_operator, CEPH_OSD_CMPXATTR_MODE_STRING, bl);
    tracepoint(librados, rados_read_op_cmpxattr_exit);
}
LIBRADOS_C_API_BASE_DEFAULT(rados_read_op_cmpxattr);

extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_omap_cmp)(rados_read_op_t read_op, const char* key,
                                                                 uint8_t comparison_operator, const char* val,
                                                                 size_t val_len, int* prval)
{
    tracepoint(librados, rados_read_op_omap_cmp_enter, read_op, key, comparison_operator, val, val_len, prval);
    rados_c_omap_cmp((::ObjectOperation*)read_op, key, comparison_operator, val, strlen(key), val_len, prval);
    tracepoint(librados, rados_read_op_omap_cmp_exit);
}
LIBRADOS_C_API_BASE_DEFAULT(rados_read_op_omap_cmp);

extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_omap_cmp2)(rados_read_op_t read_op, const char* key,
                                                                  uint8_t comparison_operator, const char* val,
                                                                  size_t key_len, size_t val_len, int* prval)
{
    tracepoint(librados, rados_read_op_omap_cmp_enter, read_op, key, comparison_operator, val, val_len, prval);
    rados_c_omap_cmp((::ObjectOperation*)read_op, key, comparison_operator, val, key_len, val_len, prval);
    tracepoint(librados, rados_read_op_omap_cmp_exit);
}
LIBRADOS_C_API_BASE_DEFAULT(rados_read_op_omap_cmp2);

extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_stat)(rados_read_op_t read_op, uint64_t* psize, time_t* pmtime,
                                                             int* prval)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_stat2)(rados_read_op_t read_op, uint64_t* psize,
                                                              struct timespec* pmtime, int* prval)
{
...
public:
    bufferlist out_bl;
    C_bl_to_buf(char* out_buf, size_t out_len, size_t* bytes_read, int* prval)
        : out_buf(out_buf)
        , out_len(out_len)
    ...
    void finish(int r) override
    {
        if (out_bl.length() > out_len) {
            if (prval) *prval = -ERANGE;
            if (bytes_read) *bytes_read = 0;
            return;
        }
        if (bytes_read) *bytes_read = out_bl.length();
        if (out_buf && !out_bl.is_provided_buffer(out_buf)) out_bl.begin().copy(out_bl.length(), out_buf);
    }
};

extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_read)(rados_read_op_t read_op, uint64_t offset, size_t len,
                                                             char* buf, size_t* bytes_read, int* prval)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_checksum)(rados_read_op_t read_op, rados_checksum_type_t type,
                                                                 const char* init_value, size_t init_value_len,
                                                                 uint64_t offset, size_t len, size_t chunk_size,
                                                                 char* pchecksum, size_t checksum_len, int* prval)
{
    tracepoint(
        librados, rados_read_op_checksum_enter, read_op, type, init_value, init_value_len, offset, len, chunk_size);
    bufferlist init_value_bl;
    init_value_bl.append(init_value, init_value_len);
...
public:
    bufferlist out_bl;
    C_out_buffer(char** out_buf, size_t* out_len)
        : out_buf(out_buf)
        , out_len(out_len)
    {}
    void finish(int r) override
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_exec)(rados_read_op_t read_op, const char* cls,
                                                             const char* method, const char* in_buf, size_t in_len,
                                                             char** out_buf, size_t* out_len, int* prval)
{
    ...
    ((::ObjectOperation*)read_op)->call(cls, method, inbl, &ctx->out_bl, ctx, prval);
    tracepoint(librados, rados_read_op_exec_exit);
}
LIBRADOS_C_API_BASE_DEFAULT(rados_read_op_exec);

extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_exec_user_buf)(rados_read_op_t read_op, const char* cls,
                                                                      const char* method, const char* in_buf,
                                                                      size_t in_len, char* out_buf, size_t out_len,
                                                                      size_t* used_len, int* prval)
{
    tracepoint(librados,
...
public:
    explicit C_OmapIter(RadosOmapIter* iter)
        : iter(iter)
    {}
    void finish(int r) override { iter->i = iter->values.begin(); }
};
...
public:
    explicit C_XattrsIter(librados::RadosXattrsIter* iter)
        : iter(iter)
    {}
    void finish(int r) override { iter->i = iter->attrset.begin(); }
};

extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_getxattrs)(rados_read_op_t read_op, rados_xattrs_iter_t* iter,
                                                                  int* prval)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_omap_get_vals)(rados_read_op_t read_op, const char* start_after,
                                                                      const char* filter_prefix, uint64_t max_return,
                                                                      rados_omap_iter_t* iter, int* prval)
{
    ...
    ((::ObjectOperation*)read_op)->omap_get_vals(start, filter, max_return, &omap_iter->values, nullptr, prval);
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_omap_get_vals2)(rados_read_op_t read_op, const char* start_after,
                                                                       const char* filter_prefix, uint64_t max_return,
                                                                       rados_omap_iter_t* iter, unsigned char* pmore,
                                                                       int* prval)
{
    tracepoint(librados, rados_read_op_omap_get_vals_enter, read_op, start_after, filter_prefix, max_return, prval);
    RadosOmapIter* omap_iter = new RadosOmapIter;
    const char* start = start_after ? start_after : "";
    const char* filter = filter_prefix ? filter_prefix : "";
    ((::ObjectOperation*)read_op)->omap_get_vals(start, filter, max_return, &omap_iter->values, (bool*)pmore, prval);
    ((::ObjectOperation*)read_op)->set_handler(new C_OmapIter(omap_iter));
    *iter = omap_iter;
    tracepoint(librados, rados_read_op_omap_get_vals_exit, *iter);
}
...
struct C_OmapKeysIter : public Context
{
    ...
    explicit C_OmapKeysIter(RadosOmapIter* iter)
        : iter(iter)
    {}
    void finish(int r) override
    {
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_omap_get_keys)(rados_read_op_t read_op, const char* start_after,
                                                                      uint64_t max_return, rados_omap_iter_t* iter,
                                                                      int* prval)
{
    ...
    ((::ObjectOperation*)read_op)
        ->omap_get_keys(start_after ? start_after : "", max_return, &ctx->keys, nullptr, prval);
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_omap_get_keys2)(rados_read_op_t read_op, const char* start_after,
                                                                       uint64_t max_return, rados_omap_iter_t* iter,
                                                                       unsigned char* pmore, int* prval)
{
    ...
    C_OmapKeysIter* ctx = new C_OmapKeysIter(omap_iter);
    ((::ObjectOperation*)read_op)
        ->omap_get_keys(start_after ? start_after : "", max_return, &ctx->keys, (bool*)pmore, prval);
    ((::ObjectOperation*)read_op)->set_handler(ctx);
    *iter = omap_iter;
    tracepoint(librados, rados_read_op_omap_get_keys_exit, *iter);
}
...
static void internal_rados_read_op_omap_get_vals_by_keys(rados_read_op_t read_op, set<string>& to_get,
                                                         rados_omap_iter_t* iter, int* prval)
{
    RadosOmapIter* omap_iter = new RadosOmapIter;
    ((::ObjectOperation*)read_op)->omap_get_vals_by_keys(to_get, &omap_iter->values, prval);
    ((::ObjectOperation*)read_op)->set_handler(new C_OmapIter(omap_iter));
    *iter = omap_iter;
}

extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_omap_get_vals_by_keys)(rados_read_op_t read_op,
                                                                              char const* const* keys, size_t keys_len,
                                                                              rados_omap_iter_t* iter, int* prval)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_read_op_omap_get_vals_by_keys2)(rados_read_op_t read_op,
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_omap_get_next2)(rados_omap_iter_t iter, char** key, char** val,
                                                              size_t* key_len, size_t* val_len)
{
    ...
    if (key) *key = (char*)it->i->first.c_str();
    if (val) *val = it->i->second.c_str();
    if (key_len) *key_len = it->i->first.length();
    if (val_len) *val_len = it->i->second.length();
    ++it->i;
    tracepoint(librados, rados_omap_get_next_exit, 0, key, val, val_len);
    return 0;
}
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_omap_get_next)(rados_omap_iter_t iter, char** key, char** val,
                                                             size_t* len)
{
...
extern "C" unsigned int LIBRADOS_C_API_DEFAULT_F(rados_omap_iter_size)(rados_omap_iter_t iter)
{
    RadosOmapIter* it = static_cast<RadosOmapIter*>(iter);
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_omap_get_end)(rados_omap_iter_t iter)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_read_op_operate)(rados_read_op_t read_op, rados_ioctx_t io,
                                                               const char* oid, int flags)
{
    tracepoint(librados, rados_read_op_operate_enter, read_op, io, oid, flags);
    object_t obj(oid);
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
    int retval = ctx->operate_read(obj, (::ObjectOperation*)read_op, NULL, translate_flags(flags));
    tracepoint(librados, rados_read_op_operate_exit, retval);
    return retval;
}
LIBRADOS_C_API_BASE_DEFAULT(rados_read_op_operate);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_aio_read_op_operate)(rados_read_op_t read_op, rados_ioctx_t io,
                                                                   rados_completion_t completion, const char* oid,
                                                                   int flags)
{
    ...
    librados::IoCtxImpl* ctx = (librados::IoCtxImpl*)io;
    librados::AioCompletionImpl* c = (librados::AioCompletionImpl*)completion;
    int retval = ctx->aio_operate_read(obj, (::ObjectOperation*)read_op, c, translate_flags(flags), NULL);
    tracepoint(librados, rados_aio_read_op_operate_exit, retval);
    return retval;
}
LIBRADOS_C_API_BASE_DEFAULT(rados_aio_read_op_operate);

extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_cache_pin)(rados_ioctx_t io, const char* o)
{
...
extern "C" int LIBRADOS_C_API_DEFAULT_F(rados_cache_unpin)(rados_ioctx_t io, const char* o)
{
...
extern "C" void LIBRADOS_C_API_DEFAULT_F(rados_object_list_slice)(rados_ioctx_t io,
                                                                  const rados_object_list_cursor start,
                                                                  const rados_object_list_cursor finish, const size_t n,
                                                                  const size_t m, rados_object_list_cursor* split_start,
                                                                  rados_object_list_cursor* split_finish)
{
    ...
    ctx->object_list_slice(*start_hobj, *finish_hobj, n, m, split_start_hobj, split_finish_hobj);
}
