...
FutureImpl::FutureImpl(uint64_t tag_tid, uint64_t entry_tid, uint64_t commit_tid)
    : m_tag_tid(tag_tid)
...
ceph::ref_t<FutureImpl> FutureImpl::prepare_flush(FlushHandlers* flush_handlers, ceph::mutex& lock)
{
