...
private:
    ...
    struct Listener : public JournalMetadataListener
    {
        ...
        void handle_update(JournalMetadata*) override { journal_recorder->handle_update(); }
    };
    ...
    struct ObjectHandler : public ObjectRecorder::Handler
    {
        ...
        void closed(ObjectRecorder* object_recorder) override { journal_recorder->handle_closed(object_recorder); }
        void overflow(ObjectRecorder* object_recorder) override { journal_recorder->handle_overflow(object_recorder); }
    };
    ...
    struct C_AdvanceObjectSet : public Context
    {
        ...
        C_AdvanceObjectSet(JournalRecorder* _journal_recorder)
            : journal_recorder(_journal_recorder)
        {}
        void finish(int r) override { journal_recorder->handle_advance_object_set(r); }
    };
    ...
    ceph::ref_t<ObjectRecorder> create_object_recorder(uint64_t object_number, ceph::mutex* lock);
