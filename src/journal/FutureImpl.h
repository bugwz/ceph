...
public:
    ...
    inline uint64_t get_tag_tid() const { return m_tag_tid; }
    inline uint64_t get_entry_tid() const { return m_entry_tid; }
    inline uint64_t get_commit_tid() const { return m_commit_tid; }
    ...
    inline void detach() { m_flush_handler.reset(); }
    inline FlushHandler::ref get_flush_handler() const { return m_flush_handler; }
...
private:
    ...
    struct C_ConsistentAck : public Context
    {
        ...
        C_ConsistentAck(ceph::ref_t<FutureImpl> _future)
