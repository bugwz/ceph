...
private:
    ...
    struct MetadataListener : public JournalMetadataListener
    {
        ...
        {}
        void handle_update(JournalMetadata*) override { journal_trimmer->handle_metadata_updated(); }
    };
    ...
    struct C_CommitPositionSafe : public Context
    {
        ...
        ~C_CommitPositionSafe() override { journal_trimmer->m_async_op_tracker.finish_op(); }
    ...
    CreateContext m_create_commit_position_safe_context = [this]() { return new C_CommitPositionSafe(this); };
