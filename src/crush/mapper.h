 ...
 */
extern int crush_do_rule(const struct crush_map* map, int ruleno, int x, int* result, int result_max,
...
static inline size_t crush_work_size(const struct crush_map* map, int result_max)
{
