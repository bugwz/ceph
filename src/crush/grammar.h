...
struct crush_grammar : public boost::spirit::grammar<crush_grammar>
{
    ...
    template<typename ScannerT> struct definition
    {
        ...
        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>, boost::spirit::parser_tag<_bucket_type> >
            bucket_type;

        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>, boost::spirit::parser_tag<_bucket_id> >
            bucket_id;
        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>, boost::spirit::parser_tag<_bucket_alg> >
            bucket_alg;
        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>, boost::spirit::parser_tag<_bucket_hash> >
            bucket_hash;
        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>, boost::spirit::parser_tag<_bucket_item> >
            bucket_item;
        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>, boost::spirit::parser_tag<_bucket> > bucket;

        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>, boost::spirit::parser_tag<_step_take> >
            step_take;
        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>,
                            boost::spirit::parser_tag<_step_set_choose_tries> >
            step_set_choose_tries;
        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>,
                            boost::spirit::parser_tag<_step_set_choose_local_tries> >
            step_set_choose_local_tries;
        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>,
                            boost::spirit::parser_tag<_step_set_choose_local_fallback_tries> >
            step_set_choose_local_fallback_tries;
        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>,
                            boost::spirit::parser_tag<_step_set_chooseleaf_tries> >
            step_set_chooseleaf_tries;
        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>,
                            boost::spirit::parser_tag<_step_set_chooseleaf_vary_r> >
            step_set_chooseleaf_vary_r;
        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>,
                            boost::spirit::parser_tag<_step_set_chooseleaf_stable> >
            step_set_chooseleaf_stable;
        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>, boost::spirit::parser_tag<_step_choose> >
            step_choose;
        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>, boost::spirit::parser_tag<_step_chooseleaf> >
            step_chooseleaf;
        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>, boost::spirit::parser_tag<_step_emit> >
            step_emit;
        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>, boost::spirit::parser_tag<_step> > step;
        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>, boost::spirit::parser_tag<_crushrule> >
            crushrule;
        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>, boost::spirit::parser_tag<_weight_set_weights> >
            weight_set_weights;
        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>, boost::spirit::parser_tag<_weight_set> >
            weight_set;
        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>, boost::spirit::parser_tag<_choose_arg_ids> >
            choose_arg_ids;
        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>, boost::spirit::parser_tag<_choose_arg> >
            choose_arg;
        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>, boost::spirit::parser_tag<_choose_args> >
            choose_args;
        ...
        definition(crush_grammar const& /*self*/)
        {
            ...
            step_choose = str_p("choose") >> (str_p("indep") | str_p("firstn")) >> integer >> str_p("type") >> name;
            step_chooseleaf =
                str_p("chooseleaf") >> (str_p("indep") | str_p("firstn")) >> integer >> str_p("type") >> name;
            step_emit = str_p("emit");
            step = str_p("step") >>
                   (step_take | step_set_choose_tries | step_set_choose_local_tries |
                    step_set_choose_local_fallback_tries | step_set_chooseleaf_tries | step_set_chooseleaf_vary_r |
                    step_set_chooseleaf_stable | step_choose | step_chooseleaf | step_emit);
            crushrule = str_p("rule") >> !name >> '{' >> (str_p("id") | str_p("ruleset")) >> posint >> str_p("type") >>
                        (str_p("replicated") | str_p("erasure")) >> !(str_p("min_size") >> posint) >>
                        !(str_p("max_size") >> posint) >> +step >> '}';

            weight_set_weights = str_p("[") >> *real_p >> str_p("]");
            weight_set = str_p("weight_set") >> str_p("[") >> *weight_set_weights >> str_p("]");
            choose_arg_ids = str_p("ids") >> str_p("[") >> *integer >> str_p("]");
            choose_arg = str_p("{") >> str_p("bucket_id") >> negint >> !weight_set >> !choose_arg_ids >> str_p("}");
        ...
        boost::spirit::rule<ScannerT, boost::spirit::parser_context<>, boost::spirit::parser_tag<_crushmap> > const&
        start() const
        {
            return crushmap;
        }
