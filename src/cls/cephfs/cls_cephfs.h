...
public:
    ...
    bool operator>(ObjCeiling const& rhs) const { return id > rhs.id; }
...
public:
    ...
    AccumulateArgs(uint64_t obj_index_, uint64_t obj_size_, time_t mtime_, const std::string& obj_xattr_name_,
                   const std::string& mtime_xattr_name_, const std::string& obj_size_xattr_name_)
