...
int ClsCephFSClient::accumulate_inode_metadata(librados::IoCtx& ctx, inodeno_t inode_no, const uint64_t obj_index,
                                               const uint64_t obj_size, const time_t mtime)
{
    AccumulateArgs args(obj_index, obj_size, mtime, XATTR_CEILING, XATTR_MAX_MTIME, XATTR_MAX_SIZE);
...
int ClsCephFSClient::delete_inode_accumulate_result(librados::IoCtx& ctx, const std::string& oid)
{
...
int ClsCephFSClient::fetch_inode_accumulate_result(librados::IoCtx& ctx, const std::string& oid,
                                                   inode_backtrace_t* backtrace, file_layout_t* layout,
...
void ClsCephFSClient::build_tag_filter(const std::string& scrub_tag, bufferlist* out_bl)
{
