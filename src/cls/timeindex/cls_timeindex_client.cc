...
void cls_timeindex_add_prepare_entry(cls_timeindex_entry& entry, const utime_t& key_timestamp,
                                     const std::string& key_ext, const librados::bufferlist& bl)
{
...
void cls_timeindex_add(librados::ObjectWriteOperation& op, const utime_t& key_timestamp, const std::string& key_ext,
...
int cls_timeindex_trim(librados::IoCtx& io_ctx, const std::string& oid, const utime_t& from_time,
                       const utime_t& to_time, const std::string& from_marker, const std::string& to_marker)
{
    bool done = false;
                        ...
                        std::string* out_marker, bool* truncated)
{
    ...
    op.exec("timeindex", "list", in, new TimeindexListCtx(&entries, out_marker, truncated));
}
