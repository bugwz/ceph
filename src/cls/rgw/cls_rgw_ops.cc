...
void cls_rgw_mp_upload_part_info_update_op::generate_test_instances(
...
void cls_rgw_set_bucket_resharding_op::generate_test_instances(list<cls_rgw_set_bucket_resharding_op*>& ls)
{
...
void cls_rgw_clear_bucket_resharding_op::generate_test_instances(list<cls_rgw_clear_bucket_resharding_op*>& ls)
{
...
void cls_rgw_guard_bucket_resharding_op::generate_test_instances(list<cls_rgw_guard_bucket_resharding_op*>& ls)
{
...
void cls_rgw_get_bucket_resharding_op::generate_test_instances(list<cls_rgw_get_bucket_resharding_op*>& ls)
{
