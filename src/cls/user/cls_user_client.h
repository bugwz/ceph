...
void cls_user_bucket_list(librados::ObjectReadOperation& op, const std::string& in_marker,
                          const std::string& end_marker, int max_entries, std::list<cls_user_bucket_entry>& entries,
                          std::string* out_marker, bool* truncated, int* pret);
