...
CLS_INIT(test_remote_reads)
{
    ...
    cls_register_cxx_method(h_class, "test_read", CLS_METHOD_RD, test_read, &h_test_read);

    cls_register_cxx_method(h_class, "test_gather", CLS_METHOD_RD | CLS_METHOD_WR, test_gather, &h_test_gather);
}
