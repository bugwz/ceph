...
{
public:
    ReplicatedBackend(pg_t pgid, pg_shard_t whoami, CollectionRef coll, crimson::osd::ShardServices& shard_services,
...
private:
    ...
    seastar::future<> request_committed(const osd_reqid_t& reqid, const eversion_t& at_version) final;
};
