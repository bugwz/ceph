...
template<OSDMapGateType OSDMapGateTypeV> class OSDMapGate
{
public:
...
private:
    ...
    using waiting_peering_t = std::map<epoch_t, OSDMapBlocker>;
...
public:
     ...
     */
    seastar::future<epoch_t> wait_for_map(typename OSDMapBlocker::BlockingEvent::TriggerI&& trigger, epoch_t epoch,
