...
public:
    ...
    seastar::future<core_id_t> maybe_create_pg(spg_t pgid, core_id_t core = NULL_CORE)
    {
        ...
        if (find_iter != pg_to_core.end()) {
            ...
            return container()
                .invoke_on(0,
                           [pgid, core](auto& primary_mapping) {
                               ...
                               return primary_mapping.container().invoke_on_others(
                                   [pgid = insert_iter->first, core = insert_iter->second](auto& other_mapping) {
    ...
    seastar::future<> remove_pg(spg_t pgid)
    {
        return container().invoke_on(0, [pgid](auto& primary_mapping) {
            ...
            return primary_mapping.container().invoke_on_others([pgid](auto& other_mapping) {
