...
public:
    ...
    spg_t get_pgid() const { return req->get_spg(); }
    ...
    std::tuple<StartEvent, ConnectionPipeline::AwaitActive::BlockingEvent, ConnectionPipeline::AwaitMap::BlockingEvent,
               ConnectionPipeline::GetPG::BlockingEvent, ClientRequest::PGPipeline::AwaitMap::BlockingEvent,
               PG_OSDMapGate::OSDMapBlocker::BlockingEvent, PGMap::PGCreationBlockingEvent,
