...
static DeltaRecorderURef create_replay_recorder(node_type_t node_type, field_type_t field_type)
{
...
NodeExtentRef SeastoreNodeExtent::mutate(context_t c, DeltaRecorderURef&& _recorder)
{
