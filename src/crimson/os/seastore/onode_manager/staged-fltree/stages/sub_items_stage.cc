...
#define IA_TEMPLATE(KT)                                                                             \
    template const laddr_packed_t* internal_sub_items_t::insert_at<KT>(NodeExtentMutable&,          \
...
node_offset_t internal_sub_items_t::trim_until(NodeExtentMutable&, internal_sub_items_t& items, index_t index)
{
    assert(index != 0);
...
template<KeyT KT>
void internal_sub_items_t::Appender<KT>::append(const full_key_t<KT>& key, const laddr_packed_t& value,
...
template<KeyT KT>
const onode_t* leaf_sub_items_t::insert_at(NodeExtentMutable& mut, const leaf_sub_items_t& sub_items,
                                           const full_key_t<KT>& key, const onode_t& value, index_t index,
...
template const onode_t* leaf_sub_items_t::insert_at<KeyT::HOBJ>(NodeExtentMutable&, const leaf_sub_items_t&,
                                                                const full_key_t<KeyT::HOBJ>&, const onode_t&, index_t,
