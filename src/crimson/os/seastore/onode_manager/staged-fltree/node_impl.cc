...
InternalNodeImpl::alloc_ertr::future<InternalNodeImpl::fresh_impl_t> InternalNodeImpl::allocate(context_t c,
                                                                                                field_type_t type,
                                                                                                bool is_level_tail,
                                                                                                level_t level)
{
...
LeafNodeImpl::alloc_ertr::future<LeafNodeImpl::fresh_impl_t> LeafNodeImpl::allocate(context_t c, field_type_t type,
                                                                                    bool is_level_tail)
{
    if (type == field_type_t::N0) {
...
InternalNodeImplURef InternalNodeImpl::load(NodeExtentRef extent, field_type_t type, bool expect_is_level_tail)
{
    if (type == field_type_t::N0) {
...
LeafNodeImplURef LeafNodeImpl::load(NodeExtentRef extent, field_type_t type, bool expect_is_level_tail)
{
    if (type == field_type_t::N0) {
