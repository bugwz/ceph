...
public:
    ...
    bool is_empty() const { return encoded.length() == 0; }

    ceph::bufferlist get_delta() { return std::move(encoded); }
    ...
    virtual void apply_delta(ceph::bufferlist::const_iterator&, NodeExtentMutable&, const NodeExtent&) = 0;
