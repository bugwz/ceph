...
class FlatCollectionManager : public CollectionManager
{
    ...
    coll_context_t get_coll_context(Transaction& t) { return coll_context_t{tm, t}; }
...
public:
    ...
    create_ret create(coll_root_t& coll_root, Transaction& t, coll_t cid, coll_info_t info) final;
