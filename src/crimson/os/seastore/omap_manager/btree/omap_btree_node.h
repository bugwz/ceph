...
struct OMapNode : LogicalCachedExtent
{
    ...
    struct mutation_result_t
    {
        ...
        mutation_result_t(mutation_status_t s, std::optional<std::tuple<OMapNodeRef, OMapNodeRef, std::string>> tuple,
    ...
    virtual insert_ret insert(omap_context_t oc, const std::string& key, const ceph::bufferlist& value) = 0;
    ...
    virtual list_ret list(omap_context_t oc, const std::optional<std::string>& first,
                          const std::optional<std::string>& last, omap_list_config_t config) = 0;
    ...
    using make_balanced_ret = make_balanced_iertr::future<std::tuple<OMapNodeRef, OMapNodeRef, std::string>>;
