...
private:
    ...
    friend void populate_log(ceph::os::Transaction&, pg_analogue_t&, unsigned, unsigned);

    friend void update_log(ceph::os::Transaction&, FSDriver::pg_analogue_t&, unsigned, unsigned);
};
