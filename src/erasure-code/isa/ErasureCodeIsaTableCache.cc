 ...
 * ISA-L allows to use custom matrices which might be added later as implementations deriving from the base class
 * ErasoreCodeIsa.
 */
...
unsigned char** ErasureCodeIsaTableCache::getEncodingTable(int matrix, int k, int m)
{
    std::lock_guard lock{codec_tables_guard};
...
unsigned char** ErasureCodeIsaTableCache::getEncodingTableNoLock(int matrix, int k, int m)
{
...
unsigned char** ErasureCodeIsaTableCache::getEncodingCoefficient(int matrix, int k, int m)
{
    std::lock_guard lock{codec_tables_guard};
...
unsigned char** ErasureCodeIsaTableCache::getEncodingCoefficientNoLock(int matrix, int k, int m)
{
...
unsigned char* ErasureCodeIsaTableCache::setEncodingTable(int matrix, int k, int m, unsigned char* ec_in_table)
{
    std::lock_guard lock{codec_tables_guard};
...
unsigned char* ErasureCodeIsaTableCache::setEncodingCoefficient(int matrix, int k, int m, unsigned char* ec_in_coeff)
{
    std::lock_guard lock{codec_tables_guard};
...
bool ErasureCodeIsaTableCache::getDecodingTableFromCache(std::string& signature, unsigned char*& table, int matrixtype,
                                                         int k, int m)
{
    // --------------------------------------------------------------------------
...
void ErasureCodeIsaTableCache::putDecodingTableToCache(std::string& signature, unsigned char*& table, int matrixtype,
                                                       int k, int m)
{
    // --------------------------------------------------------------------------
    // LRU decoding matrix cache
