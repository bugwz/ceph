 ...
 *                                                                                                                                                                                                            *
 * Author: Andreas-Joachim Peters <Andreas.Joachim.Peters@cern.ch> * This library is free software; you can redistribute
...
region_xor(unsigned char** src, unsigned char* parity, int src_size, unsigned size)
{
    ...
    if (src_aligned && is_aligned(parity, EC_ISA_VECTOR_OP_WORDSIZE)) {
        ...
        if (ceph_arch_intel_sse2) {
            ...
            // -----------------------------
            unsigned region_size = (size / EC_ISA_VECTOR_SSE2_WORDSIZE) * EC_ISA_VECTOR_SSE2_WORDSIZE;
