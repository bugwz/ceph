 ...
 */
void PerfCountersCollectionImpl::dump_formatted_generic(Formatter* f, bool schema, bool histograms, bool dump_labeled,
...
void PerfCounters::dump_formatted_generic(Formatter* f, bool schema, bool histograms, bool dump_labeled,
