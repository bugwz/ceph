...
public:
     ...
     */
    set_value_result_t set_value(std::string_view key, Option::value_t&& value, int level);
     ...
     *              highest-priority
     */
    std::pair<Option::value_t, bool> get_value(const std::string_view name, int level) const;
