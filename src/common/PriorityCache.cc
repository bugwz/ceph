...
int64_t get_chunk(uint64_t usage, uint64_t total_bytes)
{
    ...
    if (r > 0) val = val + chunk - r;
    return val;
}

Manager::Manager(CephContext* c, uint64_t min, uint64_t max, uint64_t target, bool reserve_extra,
    ...
    , name(name.empty() ? "prioritycache" : name)
{
    ...
    b.add_u64(MallocStats::M_TARGET_BYTES,
              "target_bytes",
    ...
    b.add_u64(MallocStats::M_MAPPED_BYTES,
              "mapped_bytes",
    ...
    b.add_u64(MallocStats::M_UNMAPPED_BYTES,
              "unmapped_bytes",
              "unmapped bytes that the kernel has yet to reclaimed",
              "u",
              PerfCountersBuilder::PRIO_INTERESTING,
              unit_t(UNIT_BYTES));

    b.add_u64(MallocStats::M_HEAP_BYTES,
              "heap_bytes",
    ...
    b.add_u64(MallocStats::M_CACHE_BYTES,
              "cache_bytes",
...
void Manager::tune_memory()
{
    ...
    ldout(cct, 5) << __func__ << " target: " << target_mem << " mapped: " << mapped << " unmapped: " << unmapped
                  << " heap: " << heap_size << " old mem: " << tuned_mem << " new mem: " << new_size << dendl;
...
void Manager::insert(const std::string& name, std::shared_ptr<PriCache> c, bool enable_perf_counters)
{
    ...
    b.add_u64(cur_index + Priority::PRI0,
              "pri0_bytes",
    ...
    b.add_u64(cur_index + Priority::PRI1,
              "pri1_bytes",
    ...
    b.add_u64(cur_index + Priority::PRI2,
              "pri2_bytes",
    ...
    b.add_u64(cur_index + Priority::PRI3,
              "pri3_bytes",
    ...
    b.add_u64(cur_index + Priority::PRI4,
              "pri4_bytes",
    ...
    b.add_u64(cur_index + Priority::PRI5,
              "pri5_bytes",
    ...
    b.add_u64(cur_index + Priority::PRI6,
              "pri6_bytes",
    ...
    b.add_u64(cur_index + Priority::PRI7,
              "pri7_bytes",
    ...
    b.add_u64(cur_index + Priority::PRI8,
              "pri8_bytes",
    ...
    b.add_u64(cur_index + Priority::PRI9,
              "pri9_bytes",
    ...
    b.add_u64(cur_index + Priority::PRI10,
              "pri10_bytes",
    ...
    b.add_u64(cur_index + Priority::PRI11,
              "pri11_bytes",
    ...
    b.add_u64(cur_index + Extra::E_RESERVED,
              "reserved_bytes",
    ...
    b.add_u64(cur_index + Extra::E_COMMITTED,
              "committed_bytes",
...
void Manager::balance_priority(int64_t* mem_avail, Priority pri)
{
    ...
    while (!tmp_caches.empty() && *mem_avail > static_cast<int64_t>(tmp_caches.size())) {
        ...
        for (auto it = tmp_caches.begin(); it != tmp_caches.end();) {
            ...
            ldout(cct, 10) << __func__ << " " << it->first << " pri: " << (int)pri << " round: " << round
                           << " wanted: " << cache_wants << " ratio: " << it->second->get_cache_ratio()
                           << " cur_ratios: " << cur_ratios << " fair_share: " << fair_share
                           << " mem_avail: " << *mem_avail << dendl;
