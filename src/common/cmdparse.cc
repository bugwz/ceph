...
bool validate_bool(const cmdmap_t& cmdmap, const arg_desc_t& desc, const std::string_view name,
...
bool validate_arg(const cmdmap_t& cmdmap, const arg_desc_t& desc, const std::string_view name,
                  const std::string_view type, std::ostream& os)
{
    Value v;
    try {
...
bool validate_cmd(const std::string& desc, const cmdmap_t& cmdmap, std::ostream& os)
{
...
bool cmd_getval(const cmdmap_t& cmdmap, std::string_view k, bool& val)
{
    /*
...
bool cmd_getval_compat_cephbool(const cmdmap_t& cmdmap, const std::string& k, bool& val)
{
    try {
