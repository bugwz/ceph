...
ssize_t safe_recv(int fd, void* buf, size_t count) WARN_UNUSED_RESULT;
ssize_t safe_send(int fd, const void* buf, size_t count) WARN_UNUSED_RESULT;
 ...
 */
ssize_t safe_splice(int fd_in, off_t* off_in, int fd_out, off_t* off_out, size_t len,
                    unsigned int flags) WARN_UNUSED_RESULT;
ssize_t safe_splice_exact(int fd_in, off_t* off_in, int fd_out, off_t* off_out, size_t len,
                          unsigned int flags) WARN_UNUSED_RESULT;
#endif
...
ssize_t safe_recv_exact(int fd, void* buf, size_t count) WARN_UNUSED_RESULT;
