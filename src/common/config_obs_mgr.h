...
template<class ConfigObs> class ObserverMgr : public ConfigTracker
{
...
public:
    ...
    void for_each_change(const std::set<std::string>& changes, ConfigProxyT& proxy, config_gather_cb callback,
                         std::ostream* oss);
...
template<class ConfigObs> void ObserverMgr<ConfigObs>::add_observer(ConfigObs* observer)
{
...
template<class ConfigObs> void ObserverMgr<ConfigObs>::remove_observer(ConfigObs* observer)
{
...
template<class ConfigObs> void ObserverMgr<ConfigObs>::for_each_observer(config_gather_cb callback)
{
...
template<class ConfigProxyT>
void ObserverMgr<ConfigObs>::for_each_change(const std::set<std::string>& changes, ConfigProxyT& proxy,
...
template<class ConfigObs> bool ObserverMgr<ConfigObs>::is_tracking(const std::string& name) const
{
