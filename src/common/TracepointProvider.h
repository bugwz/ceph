...
public:
    ...
    public:
        ...
        {}
        ~Singleton() { delete tracepoint_provider; }

        inline bool is_enabled() const { return tracepoint_provider->m_handle != nullptr; }
    ...
    TracepointProvider(CephContext* cct, const char* library, const char* config_key);
    ...
    {
#ifdef WITH_LTTNG
        cct->lookup_or_create_singleton_object<TypedSingleton<traits>>(traits.library, false, cct);
#endif
    }

protected:
    const char** get_tracked_conf_keys() const override { return m_config_keys; }
