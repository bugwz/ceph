...
ConfigValues::set_value_result_t ConfigValues::set_value(const std::string_view key, Option::value_t&& new_value,
                                                         int level)
{
...
std::pair<Option::value_t, bool> ConfigValues::get_value(const std::string_view name, int level) const
{
