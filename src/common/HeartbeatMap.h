...
public:
    ...
    void reset_timeout(heartbeat_handle_d* h, ceph::timespan grace, ceph::timespan suicide_grace);
...
private:
    using clock = ceph::coarse_mono_clock;
    CephContext* m_cct;
    ceph::shared_mutex m_rwlock = ceph::make_shared_mutex("HeartbeatMap::m_rwlock");
    ...
    bool _check(const heartbeat_handle_d* h, const char* who, ceph::coarse_mono_time now);
};
