...
public:
    template<typename BitVectorT, typename DataIteratorT, typename ReferenceT> class IteratorImpl
    {
    private:
        friend class BitVector;
    ...
    public:
        ...
        inline ReferenceT operator*() const { return ReferenceT(m_data_iterator, m_shift); }
    };

    typedef IteratorImpl<const BitVector, bufferlist::const_iterator, ConstReference> ConstIterator;
