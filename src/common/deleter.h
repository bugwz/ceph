...
/// \cond internal
template<typename Deleter> struct lambda_deleter_impl final : deleter::impl
{
    Deleter del;
...
template<typename Object> struct object_deleter_impl final : deleter::impl
{
    Object obj;
...
template<typename Object> inline object_deleter_impl<Object>* make_object_deleter_impl(deleter next, Object obj)
{
...
/// \related deleter
template<typename Object> deleter make_deleter(deleter next, Object o)
{
...
/// \related deleter
template<typename Object> deleter make_deleter(Object o)
{
...
/// \related deleter
template<typename T> inline deleter make_object_deleter(T&& obj)
{
...
/// \related deleter
template<typename T> inline deleter make_object_deleter(deleter d, T&& obj)
{
