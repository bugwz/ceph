...
template<> struct is_error_condition_enum<::ceph::errc>
{
    static const bool value = true;
};
template<> struct is_error_code_enum<::ceph::errc>
{
...
namespace boost::system {
template<> struct is_error_code_enum<::ceph::buffer::errc>
{
    static const bool value = true;
};

template<> struct is_error_condition_enum<::ceph::buffer::errc>
{
    static const bool value = false;
};
}   // namespace boost::system
...
{
    error_code(int r)
        : error(-r, boost::system::system_category())
    {}
