...
using yield_context = spawn::basic_yield_context<
    boost::asio::executor_binder<void (*)(), boost::asio::strand<boost::asio::io_context::executor_type>>>;
...
public:
    ...
    explicit optional_yield(boost::asio::io_context& c, yield_context& y) noexcept
        : c(&c)
        , y(&y)
    {}
