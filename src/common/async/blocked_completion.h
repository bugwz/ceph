...
class use_blocked_t
{
    use_blocked_t(bs::error_code* ec)
        : ec(ec)
    {}
...
public:
    ...
    use_blocked_t operator[](bs::error_code& _ec) const { return use_blocked_t(&_ec); }
...
template<typename... Ts> struct blocked_handler
{
    blocked_handler(use_blocked_t b) noexcept
        : ec(b.ec)
    {}
...
template<typename T> struct blocked_handler<T>
{
    blocked_handler(use_blocked_t b) noexcept
        : ec(b.ec)
    {}
...
template<> struct blocked_handler<void>
{
    blocked_handler(use_blocked_t b) noexcept
        : ec(b.ec)
    {}
...
template<typename... Ts> class blocked_result
{
public:
...
template<typename T> class blocked_result<T>
{
public:
...
template<> class blocked_result<void>
{
public:
...
class async_result<ceph::async::use_blocked_t, ReturnType()> : public ceph::async::detail::blocked_result<void>
{
public:
    explicit async_result(typename ceph::async::detail::blocked_result<void>::completion_handler_type& h)
...
template<typename ReturnType>
class async_result<ceph::async::use_blocked_t, ReturnType(boost::system::error_code)>
...
template<typename ReturnType, typename... Args>
class async_result<ceph::async::use_blocked_t, ReturnType(boost::system::error_code, Args...)>
    : public ceph::async::detail::blocked_result<std::decay_t<Args>...>
{
public:
    explicit async_result(
