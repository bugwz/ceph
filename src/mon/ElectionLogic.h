...
public:
    ...
    ElectionLogic(ElectionOwner* e, election_strategy es, ConnectionTracker* t, double ipm, CephContext* c)
        : elector(e)
        , peer_tracker(t)
        , cct(c)
     ...
     * Defaults to CLASSIC.
     */
    void set_election_strategy(election_strategy es) { strategy = es; }
    /**
