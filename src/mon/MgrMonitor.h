...
public:
    ...
    const std::map<std::string, Option>& get_mgr_module_options() { return mgr_module_options; }
    ...
    int load_metadata(const std::string& name, std::map<std::string, std::string>& m, std::ostream* err) const;
