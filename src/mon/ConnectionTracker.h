...
struct ConnectionReport
{
    ...
    {
        return o.rank == rank && o.current == current && o.history == history && o.epoch == epoch &&
...
public:
     ...
     */
    void set_half_life(double d) { half_life = d; }
    /**
     ...
     */
    void get_total_connection_score(int peer_rank, double* rating, int* live_count) const;
    /**
...
public:
    ConnectionTracker()
        ...
        , persist_interval(10)
    {}
    ConnectionTracker(RankProvider* o, int rank, double hl, int persist_i, CephContext* c)
        : epoch(0)
        , version(0)
        , half_life(hl)
        , owner(o)
