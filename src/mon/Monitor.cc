                              ...
                              std::ostream& out)
{
    ...
    if (command == "mon_status") {
        ...
        string validate;
        if ((!cmd_getval(cmdmap, "validate", validate)) || (validate != "--yes-i-really-mean-it")) {
...
void Monitor::update_log_clients()
{
    ...
    if (parse_log_client_options(g_ceph_context,
                                 log_to_monitors,
                                 log_to_syslog,
                                 log_channel,
                                 log_prio,
    ...
    audit_clog->update_config(log_to_monitors,
                              log_to_syslog,
                              log_channel,
                              log_prio,
                              log_to_graylog,
...
bool Monitor::session_stretch_allowed(MonSession* s, MonOpRequestRef& op)
{
    ...
    if (s->con->peer_is_osd()) {
        ...
        int barrier_id;
        int retval = osdmon()->osdmap.crush->get_validated_type_id(stretch_bucket_divider, &barrier_id);
