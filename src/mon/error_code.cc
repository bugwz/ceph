...
const char* mon_error_category::message(int ev, char* buf, std::size_t len) const noexcept
{
...
bs::error_condition mon_error_category::default_error_condition(int ev) const noexcept
{
