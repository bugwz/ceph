...
#undef dout_prefix
#define dout_prefix *_dout << "rbd::mirror::PoolMetaCache: " << this << " " << __func__ << ": "

namespace rbd {
namespace mirror {

int PoolMetaCache::get_local_pool_meta(int64_t pool_id, LocalPoolMeta* local_pool_meta) const
{
...
void PoolMetaCache::set_local_pool_meta(int64_t pool_id, const LocalPoolMeta& local_pool_meta)
{
...
int PoolMetaCache::get_remote_pool_meta(int64_t pool_id, RemotePoolMeta* remote_pool_meta) const
{
    dout(15) << "pool_id=" << pool_id << dendl;
...
void PoolMetaCache::set_remote_pool_meta(int64_t pool_id, const RemotePoolMeta& remote_pool_meta)
{
    dout(15) << "pool_id=" << pool_id << ", "
