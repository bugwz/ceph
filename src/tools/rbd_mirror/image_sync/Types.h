...
struct SyncPoint
{
    ...
    SyncPoint() {}
    SyncPoint(const cls::rbd::SnapshotNamespace& snap_namespace, const std::string& snap_name,
    ...
    cls::rbd::SnapshotNamespace snap_namespace = {cls::rbd::UserSnapshotNamespace{}};
    ...
    {
        return (snap_namespace == rhs.snap_namespace && snap_name == rhs.snap_name &&
                from_snap_name == rhs.from_snap_name && object_number == rhs.object_number);
    }
};
...
public:
    ...
    virtual void update_sync_points(const librbd::SnapSeqs& snap_seq, const SyncPoints& sync_points, bool sync_complete,
                                    Context* on_finish) = 0;
