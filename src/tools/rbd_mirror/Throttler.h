...
{
public:
    static Throttler* create(CephContext* cct, const std::string& config_key) { return new Throttler(cct, config_key); }
    ...
    void start_op(const std::string& ns, const std::string& id, Context* on_start);
