...
template<typename ImageCtxT = librbd::ImageCtx> class CreateImageRequest
{
public:
    static CreateImageRequest* create(Threads<ImageCtxT>* threads, librados::IoCtx& local_io_ctx,
                                      ...
                                      ImageCtxT* remote_image_ctx, PoolMetaCache* pool_meta_cache,
                                      cls::rbd::MirrorImageMode mirror_image_mode, Context* on_finish)
    {
        return new CreateImageRequest(threads,
                                      local_io_ctx,
                                      global_image_id,
                                      remote_mirror_uuid,
                                      local_image_name,
    ...
    CreateImageRequest(Threads<ImageCtxT>* threads, librados::IoCtx& local_io_ctx, const std::string& global_image_id,
                       const std::string& remote_mirror_uuid, const std::string& local_image_name,
                       const std::string& local_image_id, ImageCtxT* remote_image_ctx, PoolMetaCache* pool_meta_cache,
                       cls::rbd::MirrorImageMode mirror_image_mode, Context* on_finish);
