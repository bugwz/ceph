...
template<typename ImageCtxT> class SyncPointHandler : public image_sync::SyncPointHandler
{
public:
    ...
    void update_sync_points(const librbd::SnapSeqs& snap_seqs, const SyncPoints& sync_points, bool sync_complete,
