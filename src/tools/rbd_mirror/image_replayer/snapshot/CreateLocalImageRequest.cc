...
template<typename I> void CreateLocalImageRequest<I>::send()
{
    disable_mirror_image();
}

template<typename I> void CreateLocalImageRequest<I>::disable_mirror_image()
{
    ...
    cls::rbd::MirrorImage mirror_image{
        cls::rbd::MIRROR_IMAGE_MODE_SNAPSHOT, m_global_image_id, cls::rbd::MIRROR_IMAGE_STATE_DISABLING};
    librados::ObjectWriteOperation op;
    librbd::cls_client::mirror_image_set(&op, m_state_builder->local_image_id, mirror_image);

    auto aio_comp =
        create_rados_callback<CreateLocalImageRequest<I>, &CreateLocalImageRequest<I>::handle_disable_mirror_image>(
            this);
...
template<typename I> void CreateLocalImageRequest<I>::handle_disable_mirror_image(int r)
{
    dout(10) << "r=" << r << dendl;
...
template<typename I> void CreateLocalImageRequest<I>::remove_mirror_image()
{
    dout(10) << dendl;
    ...
    auto aio_comp =
        create_rados_callback<CreateLocalImageRequest<I>, &CreateLocalImageRequest<I>::handle_remove_mirror_image>(
            this);
    int r = m_local_io_ctx.aio_operate(RBD_MIRRORING, aio_comp, &op);
    ceph_assert(r == 0);
    aio_comp->release();
...
template<typename I> void CreateLocalImageRequest<I>::handle_remove_mirror_image(int r)
{
    dout(10) << "r=" << r << dendl;
...
template<typename I> void CreateLocalImageRequest<I>::add_mirror_image()
{
    ceph_assert(m_state_builder->local_image_id.empty());
    m_state_builder->local_image_id = librbd::util::generate_image_id<I>(m_local_io_ctx);
    ...
    cls::rbd::MirrorImage mirror_image{
        cls::rbd::MIRROR_IMAGE_MODE_SNAPSHOT, m_global_image_id, cls::rbd::MIRROR_IMAGE_STATE_CREATING};
    librados::ObjectWriteOperation op;
    librbd::cls_client::mirror_image_set(&op, m_state_builder->local_image_id, mirror_image);

    auto aio_comp =
        create_rados_callback<CreateLocalImageRequest<I>, &CreateLocalImageRequest<I>::handle_add_mirror_image>(this);
    int r = m_local_io_ctx.aio_operate(RBD_MIRRORING, aio_comp, &op);
    ceph_assert(r == 0);
    aio_comp->release();
}

template<typename I> void CreateLocalImageRequest<I>::handle_add_mirror_image(int r)
{
    dout(10) << "r=" << r << dendl;
...
template<typename I> void CreateLocalImageRequest<I>::create_local_image()
{
    ...
    auto ctx =
        create_context_callback<CreateLocalImageRequest<I>, &CreateLocalImageRequest<I>::handle_create_local_image>(
            this);
    auto request = CreateImageRequest<I>::create(m_threads,
                                                 m_local_io_ctx,
                                                 m_global_image_id,
...
template<typename I> void CreateLocalImageRequest<I>::handle_create_local_image(int r)
{
    dout(10) << "r=" << r << dendl;
...
template<typename I> void CreateLocalImageRequest<I>::update_progress(const std::string& description)
{
