...
template<typename ImageCtxT = librbd::ImageCtx> class SnapshotPurgeRequest
{
public:
    ...
    SnapshotPurgeRequest(librados::IoCtx& io_ctx, const std::string& image_id, Context* on_finish)
        : m_io_ctx(io_ctx)
        , m_image_id(image_id)
