...
struct PayloadBase
{
    ...
    PayloadBase(uint64_t request_id)
...
struct PeerImageRemovedPayload : public PayloadBase
{
    ...
    PeerImageRemovedPayload(uint64_t request_id, const std::string& global_image_id,
...
typedef boost::variant<ImageAcquirePayload, ImageReleasePayload, PeerImageRemovedPayload, SyncRequestPayload,
...
struct NotifyAckPayload
{
    ...
    NotifyAckPayload(const std::string& instance_id, uint64_t request_id, int ret_val)
