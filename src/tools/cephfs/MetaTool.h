...
private:
    ...
    public:
        ...
        string outfile() { return _out; }
        string infile() { return _in; }
...
public:
    ...
    int main(string& mode, string& rank_str, string& minfo, string& ino, string& out, string& in, bool confirm = false);
};
#endif   // METATOOL_H__
