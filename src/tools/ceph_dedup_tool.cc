...
void usage()
{
    cout << " usage: [--op <estimate|chunk-scrub|chunk-get-ref|chunk-put-ref|dump-chunk-refs>] [--pool <pool_name> ] "
         << std::endl;
...
int estimate_dedup_ratio(const std::map<std::string, std::string>& opts, std::vector<const char*>& nargs)
{
    Rados rados;
    IoCtx io_ctx;
...
int chunk_scrub_common(const std::map<std::string, std::string>& opts, std::vector<const char*>& nargs)
{
    Rados rados;
...
int main(int argc, const char** argv)
{
    ...
    else if (op_name == "chunk-get-ref" || op_name == "chunk-put-ref") {
        return chunk_scrub_common(opts, args);
    }
    else if (op_name == "dump-chunk-refs") {
        return chunk_scrub_common(opts, args);
