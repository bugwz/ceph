...
{}
ObjectCacheRegData::ObjectCacheRegData(uint16_t t, uint64_t s, const std::string& version)
    : ObjectCacheRequest(t, s)
    , version(version)
{}
...
void ObjectCacheRegData::decode_payload(bufferlist::const_iterator i, __u8 encode_version)
{
    if (i.end()) {
        return;
    }
...
void ObjectCacheRegReplyData::decode_payload(bufferlist::const_iterator bl, __u8 encode_version) {}

ObjectCacheReadData::ObjectCacheReadData(uint16_t t, uint64_t s, uint64_t read_offset, uint64_t read_len,
                                         uint64_t pool_id, uint64_t snap_id, uint64_t object_size, std::string oid,
...
void ObjectCacheReadData::decode_payload(bufferlist::const_iterator i, __u8 encode_version)
{
...
ObjectCacheReadReplyData::ObjectCacheReadReplyData(uint16_t t, uint64_t s, std::string cache_path)
    : ObjectCacheRequest(t, s)
...
void ObjectCacheReadReplyData::decode_payload(bufferlist::const_iterator i, __u8 encode_version)
{
...
void ObjectCacheReadRadosData::decode_payload(bufferlist::const_iterator i, __u8 encode_version) {}
