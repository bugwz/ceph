...
public:
    ...
    void lookup_object(std::string pool_nspace, uint64_t pool_id, uint64_t snap_id, uint64_t object_size,
...
private:
    ...
    void handle_reply_header(bufferptr bp_head, const boost::system::error_code& ec, size_t bytes_transferred);
    void read_reply_data(bufferptr&& bp_head, bufferptr&& bp_data, const uint64_t data_len);
    void handle_reply_data(bufferptr bp_head, bufferptr bp_data, const uint64_t data_len,
