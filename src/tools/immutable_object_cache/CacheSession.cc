...
#undef dout_prefix
#define dout_prefix *_dout << "ceph::cache::CacheSession: " << this << " " << __func__ << ": "


namespace ceph {
namespace immutable_obj_cache {

CacheSession::CacheSession(io_service& io_service, ProcessMsg processmsg, CephContext* cct)
...
void CacheSession::handle_request_header(const boost::system::error_code& err, size_t bytes_transferred)
{
    ldout(m_cct, 20) << dendl;
...
void CacheSession::handle_request_data(bufferptr bp, uint64_t data_len, const boost::system::error_code& err,
