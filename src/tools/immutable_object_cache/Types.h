...
public:
    ...
    virtual void decode_payload(bufferlist::const_iterator bl_it, __u8 encode_version) = 0;
...
public:
    ...
    void decode_payload(bufferlist::const_iterator bl, __u8 encode_version) override;
...
public:
    ...
    void encode_payload() override;
    void decode_payload(bufferlist::const_iterator iter, __u8 encode_version) override;
