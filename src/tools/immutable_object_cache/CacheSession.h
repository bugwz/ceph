...
{
public:
    CacheSession(io_service& io_service, ProcessMsg process_msg, CephContext* ctx);
    ~CacheSession();
    ...
    void handle_request_data(bufferptr bp, uint64_t data_len, const boost::system::error_code& err,
