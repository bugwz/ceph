...
RewatchRequest::RewatchRequest(librados::IoCtx& ioctx, const std::string& oid, ceph::shared_mutex& watch_lock,
...
void RewatchRequest::unwatch()
{
    ...
    librados::AioCompletion* aio_comp =
        librados::Rados::aio_create_completion(this, &rados_callback<RewatchRequest, &RewatchRequest::handle_unwatch>);
...
void RewatchRequest::rewatch()
{
    ...
    librados::AioCompletion* aio_comp =
        librados::Rados::aio_create_completion(this, &rados_callback<RewatchRequest, &RewatchRequest::handle_rewatch>);
