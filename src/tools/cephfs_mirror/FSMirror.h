...
private:
    ...
    struct SnapListener : public InstanceWatcher::Listener
    {
        ...
        void acquire_directory(string_view dir_path) override { fs_mirror->handle_acquire_directory(dir_path); }

        void release_directory(string_view dir_path) override { fs_mirror->handle_release_directory(dir_path); }
    };
