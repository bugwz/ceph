...
template<typename Clock> class time_point_wrapper
{
...
public:
    ...
    explicit time_point_wrapper(const time_point& t)
        : t(t)
    {}
...
public:
    ...
    explicit timespan_wrapper(const ceph::timespan& d)
        : d(d)
    {}
    ...
    void dump(Formatter* f) { f->dump_int("timespan", d.count()); }
