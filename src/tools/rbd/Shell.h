...
public:
    ...
    struct Action
    {
        ...
        typedef int (*Execute)(const boost::program_options::variables_map&, const std::vector<std::string>&);
        ...
        Action(const std::initializer_list<std::string>& command_spec,
               const std::initializer_list<std::string>& alias_command_spec, const std::string& description,
               const std::string& help, Args args, Execute execute, bool visible = true)
            : command_spec(command_spec)
            , alias_command_spec(alias_command_spec)
...
private:
    ...
    void get_command_spec(const std::vector<std::string>& arguments, std::vector<std::string>* command_spec);
    Action* find_action(const CommandSpec& command_spec, CommandSpec** matching_spec, bool* is_alias);
    ...
    void print_bash_completion_options(const boost::program_options::options_description& ops);
};
