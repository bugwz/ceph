...
int main(int argc, char** argv)
{
    ...
    desc.add_options()("help", "produce help message")(
        ...
        "get-osdmap, set-osdmap, get-inc-osdmap, set-inc-osdmap, mark-complete, reset-last-complete, "
        "apply-layout-settings, update-mon-db, dump-export, trim-pg-log, trim-pg-log-dups statfs]")(
        "epoch",
