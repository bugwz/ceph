    ...
    if (!ret) { /* File Exists */
        if (S_ISREG(stbuf.stx_mode)) {
            ...
            case OPEN_ALWAYS:
                ...
                if ((st = do_open_file(path, fdc->read_only ? O_RDONLY : O_RDWR, 0755, fdc))) return st;
            ...
            case CREATE_ALWAYS:
                ...
                if ((st = do_open_file(path, O_CREAT | O_TRUNC | O_RDWR, 0755, fdc))) return st;
                return STATUS_OBJECT_NAME_COLLISION;
            }
        }
            ...
            case OPEN_ALWAYS:
            case OPEN_EXISTING: return do_open_file(path, O_RDONLY, 0755, fdc);
        ...
        case CREATE_ALWAYS:
            // create & return 0
            return do_open_file(path, O_CREAT | O_TRUNC | O_RDWR, 0755, fdc);
        case OPEN_ALWAYS: return do_open_file(path, O_CREAT | O_RDWR, 0755, fdc);
        case OPEN_EXISTING:
        case TRUNCATE_EXISTING:
