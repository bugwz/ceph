...
TEST(IsValidUtf8, SimpleAscii)
{
    ...
    ASSERT_EQ(0,
              check_utf8_cstr("Badgers badgers badgers badgers "
                              "mushroom mushroom"));
...
TEST(IsValidUtf8, ControlChars)
{
    ...
    uint8_t control_chars[] = {0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d};
    ASSERT_EQ(0, check_utf8((char*)control_chars, sizeof(control_chars)));
}

TEST(IsValidUtf8, SimpleUtf8)
{
    uint8_t funkystr[] = {0x66, 0xd1, 0x86, 0xd1, 0x9d, 0xd2, 0xa0, 0xd3, 0xad, 0xd3, 0xae, 0x0a};
...
TEST(HasControlChars, HasControlChars1)
{
    ...
    uint8_t validutf[] = {0x66, 0xd1, 0x86, 0xd1, 0x9d, 0xd2, 0xa0, 0xd3, 0xad, 0xd3, 0xae, 0x0};
