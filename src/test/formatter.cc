...
TEST(XmlFormatter, NamespaceTest)
{
    ...
    fmt.output_header();
    fmt.open_array_section_in_ns("foo", "http://s3.amazonaws.com/doc/2006-03-01/");
    fmt.dump_stream("blah") << "hithere";
    fmt.dump_float("pi", 0.128);
    fmt.close_section();
    fmt.flush(oss);
...
TEST(XmlFormatter, DumpFormatNameSpaceTest)
{
    ...
    fmt.dump_format_ns("foo", "http://s3.amazonaws.com/doc/2006-03-01/", "%s", "bar");
    fmt.flush(oss1);
    ASSERT_EQ(oss1.str(), "<foo xmlns=\"http://s3.amazonaws.com/doc/2006-03-01/\">bar</foo>");
...
TEST(HtmlFormatter, DumpFormatNameSpaceTest)
{
    ...
    fmt.dump_format_ns("foo", "http://s3.amazonaws.com/doc/2006-03-01/", "%s", "bar");
    fmt.flush(oss1);
    ASSERT_EQ(oss1.str(), "<li xmlns=\"http://s3.amazonaws.com/doc/2006-03-01/\">foo: bar</li>");
