...
public:
    ...
    MOCK_METHOD6(lookup_object, void(std::string, uint64_t, uint64_t, uint64_t, std::string, CacheGenContextURef));
...
{
public:
    MockCacheServer(CephContext* cct, const std::string& file, ProcessMsg processmsg) {}
