...
public:
    ...
    struct File
    {
        ...
        bool exists;
        ceph::shared_mutex lock = ceph::make_shared_mutex("TestMemCluster::File::lock");
    };
    ...
    struct Pool : public RefCountedObject
    {
        ...
        ceph::shared_mutex file_lock = ceph::make_shared_mutex("TestMemCluster::Pool::file_lock");
        Files files;
    ...
    int register_object_handler(int64_t pool_id, const ObjectLocator& locator, ObjectHandler* object_handler) override;
