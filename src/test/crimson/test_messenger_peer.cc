...
public:
    ...
    static std::unique_ptr<FailoverTestPeer> create(CephContext* cct, entity_addr_t cmd_peer_addr, bool nonstop)
    {
...
int main(int argc, char** argv)
{
    ...
    desc.add_options()("help,h", "show help message")("addr",
                                                      po::value<std::string>()->default_value("v2:127.0.0.1:9013"),
