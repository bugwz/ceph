...
std::pair<key_view_t, void*> build_key_view(const ghobject_t& hobj)
{
    ...
    size_t key_size =
        sizeof(shard_pool_crush_t) + sizeof(snap_gen_t) + ns_oid_view_t::estimate_size<KeyT::HOBJ>(key_hobj);
...
struct b_dummy_tree_test_t : public seastar_test_suite_t
{
    ...
    {
        return tree.mkfs(t).handle_error(crimson::ct_error::all_same_way([] { ASSERT_FALSE("Unable to mkfs"); }));
    }
};
...
TEST_F(b_dummy_tree_test_t, 3_random_insert_leaf_node)
{
    run_async([this] {
        ...
        auto key_e = make_ghobj(std::numeric_limits<shard_t>::max(), 0, 0, "ns", "oid", 0, 0);
        ...
        std::vector<std::tuple<ghobject_t, const onode_t*, Btree::Cursor>> insert_history;
        auto f_validate_insert_new = [this, &insert_history](const ghobject_t& key, const onode_t& value) {
        ...
        // insert the same key1 with a different onode
        {
            ...
            auto [cursor1_dup, ret1_dup] = tree.insert(t, key1, onode1_dup).unsafe_get0();
        ...
        Onodes::validate_cursor(tree.lower_bound(t, key_s).unsafe_get0(), smallest_key, *smallest_value);
        Onodes::validate_cursor(tree.begin(t).unsafe_get0(), smallest_key, *smallest_value);
        Onodes::validate_cursor(tree.last(t).unsafe_get0(), largest_key, *largest_value);
...
public:
    ...
    seastar::future<> build_tree(std::pair<unsigned, unsigned> range_2, std::pair<unsigned, unsigned> range_1,
                                 std::pair<unsigned, unsigned> range_0, size_t onode_size)
    {
    ...
    seastar::future<> build_tree(const std::vector<ghobject_t>& keys, const std::vector<const onode_t*>& values)
    {
    ...
    seastar::future<> split(const ghobject_t& key, const onode_t& value, const split_expectation_t& expected)
    {
    ...
    const onode_t& create_onode(size_t size) { return onodes.create(size); }
    ...
    run_async([this] {
        {
            ...
            test.split(make_ghobj(1, 1, 1, "ns3", "oid3", 3, 3), onode, {2u, 2u, true, InsertType::BEGIN}).get0();
            test.split(make_ghobj(2, 2, 2, "ns1", "oid1", 3, 3), onode, {2u, 1u, true, InsertType::BEGIN}).get0();
            test.split(make_ghobj(2, 2, 2, "ns2", "oid2", 1, 1), onode, {2u, 0u, true, InsertType::BEGIN}).get0();

            logger().info("\n---------------------------------------------"
                          "\nsplit at stage 2; insert to left back at stage 0, 1, 2, 1, 0\n");
            test.split(make_ghobj(2, 2, 2, "ns4", "oid4", 5, 5), onode, {2u, 0u, true, InsertType::LAST}).get0();
            test.split(make_ghobj(2, 2, 2, "ns5", "oid5", 3, 3), onode, {2u, 1u, true, InsertType::LAST}).get0();
            test.split(make_ghobj(2, 3, 3, "ns3", "oid3", 3, 3), onode, {2u, 2u, true, InsertType::LAST}).get0();
            test.split(make_ghobj(3, 3, 3, "ns1", "oid1", 3, 3), onode, {2u, 1u, true, InsertType::LAST}).get0();
            test.split(make_ghobj(3, 3, 3, "ns2", "oid2", 1, 1), onode, {2u, 0u, true, InsertType::LAST}).get0();

            auto& onode0 = test.create_onode(1416);
            logger().info("\n---------------------------------------------"
                          "\nsplit at stage 2; insert to right front at stage 0, 1, 2, 1, 0\n");
            test.split(make_ghobj(3, 3, 3, "ns4", "oid4", 5, 5), onode0, {2u, 0u, false, InsertType::BEGIN}).get0();
            test.split(make_ghobj(3, 3, 3, "ns5", "oid5", 3, 3), onode0, {2u, 1u, false, InsertType::BEGIN}).get0();
            test.split(make_ghobj(3, 4, 4, "ns3", "oid3", 3, 3), onode0, {2u, 2u, false, InsertType::BEGIN}).get0();
            test.split(make_ghobj(4, 4, 4, "ns1", "oid1", 3, 3), onode0, {2u, 1u, false, InsertType::BEGIN}).get0();
            test.split(make_ghobj(4, 4, 4, "ns2", "oid2", 1, 1), onode0, {2u, 0u, false, InsertType::BEGIN}).get0();

            logger().info("\n---------------------------------------------"
                          "\nsplit at stage 2; insert to right back at stage 0, 1, 2\n");
            test.split(make_ghobj(4, 4, 4, "ns4", "oid4", 5, 5), onode0, {2u, 0u, false, InsertType::LAST}).get0();
            test.split(make_ghobj(4, 4, 4, "ns5", "oid5", 3, 3), onode0, {2u, 1u, false, InsertType::LAST}).get0();
            test.split(make_ghobj(5, 5, 5, "ns3", "oid3", 3, 3), onode0, {2u, 2u, false, InsertType::LAST}).get0();

            auto& onode1 = test.create_onode(316);
            logger().info("\n---------------------------------------------"
                          "\nsplit at stage 1; insert to left middle at stage 0, 1, 2, 1, 0\n");
            test.split(make_ghobj(2, 2, 2, "ns4", "oid4", 5, 5), onode1, {1u, 0u, true, InsertType::MID}).get0();
            test.split(make_ghobj(2, 2, 2, "ns5", "oid5", 3, 3), onode1, {1u, 1u, true, InsertType::MID}).get0();
            test.split(make_ghobj(2, 2, 3, "ns3", "oid3", 3, 3), onode1, {1u, 2u, true, InsertType::MID}).get0();
            test.split(make_ghobj(3, 3, 3, "ns1", "oid1", 3, 3), onode1, {1u, 1u, true, InsertType::MID}).get0();
            test.split(make_ghobj(3, 3, 3, "ns2", "oid2", 1, 1), onode1, {1u, 0u, true, InsertType::MID}).get0();

            logger().info("\n---------------------------------------------"
                          "\nsplit at stage 1; insert to left back at stage 0, 1, 0\n");
            test.split(make_ghobj(3, 3, 3, "ns2", "oid2", 5, 5), onode1, {1u, 0u, true, InsertType::LAST}).get0();
            test.split(make_ghobj(3, 3, 3, "ns2", "oid3", 3, 3), onode1, {1u, 1u, true, InsertType::LAST}).get0();
            test.split(make_ghobj(3, 3, 3, "ns3", "oid3", 1, 1), onode1, {1u, 0u, true, InsertType::LAST}).get0();

            auto& onode2 = test.create_onode(452);
            logger().info("\n---------------------------------------------"
                          "\nsplit at stage 1; insert to right front at stage 0, 1, 0\n");
            test.split(make_ghobj(3, 3, 3, "ns3", "oid3", 5, 5), onode2, {1u, 0u, false, InsertType::BEGIN}).get0();
            test.split(make_ghobj(3, 3, 3, "ns3", "oid4", 3, 3), onode2, {1u, 1u, false, InsertType::BEGIN}).get0();
            test.split(make_ghobj(3, 3, 3, "ns4", "oid4", 1, 1), onode2, {1u, 0u, false, InsertType::BEGIN}).get0();

            logger().info("\n---------------------------------------------"
                          "\nsplit at stage 1; insert to right middle at stage 0, 1, 2, 1, 0\n");
            test.split(make_ghobj(3, 3, 3, "ns4", "oid4", 5, 5), onode2, {1u, 0u, false, InsertType::MID}).get0();
            test.split(make_ghobj(3, 3, 3, "ns5", "oid5", 3, 3), onode2, {1u, 1u, false, InsertType::MID}).get0();
            test.split(make_ghobj(3, 3, 4, "ns3", "oid3", 3, 3), onode2, {1u, 2u, false, InsertType::MID}).get0();
            test.split(make_ghobj(4, 4, 4, "ns1", "oid1", 3, 3), onode2, {1u, 1u, false, InsertType::MID}).get0();
            test.split(make_ghobj(4, 4, 4, "ns2", "oid2", 1, 1), onode2, {1u, 0u, false, InsertType::MID}).get0();

            auto& onode3 = test.create_onode(834);
            logger().info("\n---------------------------------------------"
                          "\nsplit at stage 0; insert to right middle at stage 0, 1, 2, 1, 0\n");
            test.split(make_ghobj(3, 3, 3, "ns4", "oid4", 5, 5), onode3, {0u, 0u, false, InsertType::MID}).get0();
            test.split(make_ghobj(3, 3, 3, "ns5", "oid5", 3, 3), onode3, {0u, 1u, false, InsertType::MID}).get0();
            test.split(make_ghobj(3, 3, 4, "ns3", "oid3", 3, 3), onode3, {0u, 2u, false, InsertType::MID}).get0();
            test.split(make_ghobj(4, 4, 4, "ns1", "oid1", 3, 3), onode3, {0u, 1u, false, InsertType::MID}).get0();
            test.split(make_ghobj(4, 4, 4, "ns2", "oid2", 1, 1), onode3, {0u, 0u, false, InsertType::MID}).get0();

            logger().info("\n---------------------------------------------"
                          "\nsplit at stage 0; insert to right front at stage 0\n");
            test.split(make_ghobj(3, 3, 3, "ns4", "oid4", 2, 3), onode3, {0u, 0u, false, InsertType::BEGIN}).get0();

            auto& onode4 = test.create_onode(572);
            logger().info("\n---------------------------------------------"
                          "\nsplit at stage 0; insert to left back at stage 0\n");
            test.split(make_ghobj(3, 3, 3, "ns2", "oid2", 3, 4), onode4, {0u, 0u, true, InsertType::LAST}).get0();
        }
...

        {
            ...
            std::vector<const onode_t*> values = {&test.create_onode(1360), &test.create_onode(1632)};
            test.build_tree(keys, values).get0();
            auto& onode = test.create_onode(1640);
            logger().info("\n---------------------------------------------"
                          "\nsplit at [END, END, END]; insert to right at stage 0, 1, 2\n");
            test.split(make_ghobj(3, 3, 3, "ns3", "oid3", 4, 4), onode, {0u, 0u, false, InsertType::BEGIN}).get0();
            EXPECT_TRUE(last_split.match_split_pos({1, {0, {1}}}));
            test.split(make_ghobj(3, 3, 3, "ns4", "oid4", 3, 3), onode, {1u, 1u, false, InsertType::BEGIN}).get0();
            EXPECT_TRUE(last_split.match_split_pos({1, {1, {0}}}));
            test.split(make_ghobj(4, 4, 4, "ns3", "oid3", 3, 3), onode, {2u, 2u, false, InsertType::BEGIN}).get0();
...
class DummyChildPool
{
    ...
    protected:
        ...
        bool is_empty() const override { ceph_abort("impossible path"); }
        node_offset_t free_size() const override { ceph_abort("impossible path"); }
        key_view_t get_key_view(const search_position_t&) const override { ceph_abort("impossible path"); }
        void next_position(search_position_t&) const override { ceph_abort("impossible path"); }
    ...
    public:
        ...
        node_future<> populate_split(context_t c, std::set<Ref<DummyChild>>& splitable_nodes)
        {
        ...
        node_future<> insert_and_split(context_t c, const ghobject_t& insert_key,
        ...
        static node_future<Ref<DummyChild>> create_initial(context_t c, const std::set<ghobject_t>& keys,
                                                           DummyChildPool& pool, RootNodeTracker& root_tracker)
        {
            auto initial = create_new(keys, true, pool);
            return c.nm.get_super(c.t, root_tracker).safe_then([c, &pool, initial](auto super) {
                initial->make_root_new(c, std::move(super));
                return initial->upgrade_root(c).safe_then([initial] { return initial; });
            });
        }

    protected:
        node_future<> test_clone_non_root(context_t, Ref<InternalNode> new_parent) const override
        {
            ceph_assert(!is_root());
        ...
        node_future<Ref<tree_cursor_t>> lookup_smallest(context_t) override { ceph_abort("impossible path"); }
        node_future<Ref<tree_cursor_t>> lookup_largest(context_t) override { ceph_abort("impossible path"); }
        node_future<> test_clone_root(context_t, RootNodeTracker&) const override { ceph_abort("impossible path"); }
        node_future<search_result_t> lower_bound_tracked(context_t, const key_hobj_t&, MatchHistory&) override
        {
            ceph_abort("impossible path");
        }
        node_future<> do_get_tree_stats(context_t, tree_stats_t&) override { ceph_abort("impossible path"); }
...
public:
    ...
    template<class ValueT = void> using node_future = Node::node_future<ValueT>;
        ...
        return DummyChild::create_initial(get_context(), keys, *this, *p_btree->root_tracker)
            .safe_then([this](auto initial_child) {
                ...
                return crimson::do_until([this] {
                    ...
                    return child->populate_split(get_context(), splitable_nodes).safe_then([] {
            ...
            .safe_then([](auto height) { ceph_assert(height == 2); });
    }

    seastar::future<> test_split(ghobject_t key, search_position_t pos, const split_expectation_t& expected)
    {
        return seastar::async([this, key, pos, expected] {
            ...
            pool_clone.p_btree->test_clone_from(pool_clone.t(), t(), *p_btree).unsafe_get0();
            pool_clone_in_progress = nullptr;
            auto node_to_split = pool_clone.get_node_by_pos(pos);
            node_to_split->insert_and_split(pool_clone.get_context(), key, pool_clone.splitable_nodes).unsafe_get0();
            std::ostringstream oss;
...
TEST_F(c_dummy_test_t, 5_split_internal_node)
{
    run_async([this] {
        DummyChildPool pool;
        {
            ...
            logger().info("\n---------------------------------------------"
                          "\nsplit at stage 2; insert to right front at stage 0, 1, 2, 1, 0\n");
            pool.test_split(make_ghobj(3, 3, 3, "ns4", "oid4" + padding, 5, 5),
                            {2, {0, {0}}},
                            {2u, 0u, false, InsertType::BEGIN})
                .get();
            pool.test_split(make_ghobj(3, 3, 3, "ns5", "oid5", 3, 3), {2, {0, {0}}}, {2u, 1u, false, InsertType::BEGIN})
                .get();
            pool.test_split(make_ghobj(3, 4, 4, "ns3", "oid3", 3, 3), {2, {0, {0}}}, {2u, 2u, false, InsertType::BEGIN})
                .get();
            pool.test_split(make_ghobj(4, 4, 4, "ns1", "oid1", 3, 3), {2, {0, {0}}}, {2u, 1u, false, InsertType::BEGIN})
                .get();
            pool.test_split(make_ghobj(4, 4, 4, "ns2", "oid2" + padding, 1, 1),
                            {2, {0, {0}}},
                            {2u, 0u, false, InsertType::BEGIN})
                .get();
            ...
            pool.test_split(
                ...
                .get();
            pool.test_split(make_ghobj(4, 4, 4, "ns5", "oid5", 3, 3), {3, {0, {0}}}, {2u, 1u, false, InsertType::MID})
                .get();
            pool.test_split(make_ghobj(4, 4, 5, "ns3", "oid3", 3, 3), {3, {0, {0}}}, {2u, 2u, false, InsertType::MID})
                .get();
            pool.test_split(make_ghobj(5, 5, 5, "ns1", "oid1", 3, 3), {3, {0, {0}}}, {2u, 1u, false, InsertType::MID})
                .get();
            pool.test_split(
            ...
            logger().info("\n---------------------------------------------"
                          "\nsplit at stage 2; insert to right back at stage 0, 1, 2\n");
            pool.test_split(make_ghobj(5, 5, 5, "ns4", "oid4" + padding_e, 5, 5),
                            search_position_t::end(),
                            {2u, 0u, false, InsertType::LAST})
                .get();
            pool.test_split(make_ghobj(5, 5, 5, "ns5", "oid5", 3, 3),
                            search_position_t::end(),
                            {2u, 1u, false, InsertType::LAST})
                .get();
            pool.test_split(make_ghobj(6, 6, 6, "ns3", "oid3", 3, 3),
                            search_position_t::end(),
            ...
            pool.test_split(make_ghobj(1, 1, 1, "ns3", "oid3", 3, 3), {0, {0, {0}}}, {0u, 2u, true, InsertType::BEGIN})
                .get();
            pool.test_split(make_ghobj(2, 2, 2, "ns1", "oid1", 3, 3), {0, {0, {0}}}, {0u, 1u, true, InsertType::BEGIN})
                .get();
            pool.test_split(make_ghobj(2, 2, 2, "ns2", "oid2" + padding_s, 1, 1),
                            {0, {0, {0}}},
            ...
            pool.test_split(
                ...
                .get();
            pool.test_split(make_ghobj(2, 2, 2, "ns5", "oid5", 3, 3), {1, {0, {0}}}, {0u, 1u, true, InsertType::MID})
                .get();
            pool.test_split(make_ghobj(2, 2, 3, "ns3", "oid3" + std::string(80, '_'), 3, 3),
                            {1, {0, {0}}},
                            {0u, 2u, true, InsertType::MID})
                .get();
            pool.test_split(make_ghobj(3, 3, 3, "ns1", "oid1", 3, 3), {1, {0, {0}}}, {0u, 1u, true, InsertType::MID})
                .get();
            pool.test_split(
...

        {
            ...
            pool.test_split(
                ...
                .get();
            pool.test_split(make_ghobj(3, 3, 3, "ns5", "oid5", 3, 3), {2, {0, {0}}}, {2u, 1u, true, InsertType::LAST})
                .get();
            pool.test_split(make_ghobj(3, 4, 4, "n", "o", 3, 3), {2, {0, {0}}}, {2u, 2u, true, InsertType::LAST}).get();
            pool.test_split(make_ghobj(4, 4, 4, "n", "o", 3, 3), {2, {0, {0}}}, {2u, 1u, true, InsertType::LAST}).get();

            logger().info("\n---------------------------------------------"
                          "\nsplit at stage 2; insert to left middle at stage 2\n");
            pool.test_split(make_ghobj(2, 3, 3, "n", "o", 3, 3), {1, {0, {0}}}, {2u, 2u, true, InsertType::MID}).get();
        }

        {
            ...
            logger().info("\n---------------------------------------------"
                          "\nsplit at stage 2; insert to left back at stage (0, 1, 2, 1,) 0\n");
            pool.test_split(make_ghobj(4, 4, 4, "n", "o", 2, 2), {2, {0, {0}}}, {2u, 0u, true, InsertType::LAST}).get();
        }

        {
            ...
            logger().info("\n---------------------------------------------"
                          "\nsplit at stage 1; insert to right front at stage 0, 1, 0\n");
            pool.test_split(make_ghobj(3, 3, 3, "ns2", "oid2" + padding, 5, 5),
                            {1, {1, {0}}},
                            {1u, 0u, false, InsertType::BEGIN})
                .get();
            pool.test_split(make_ghobj(3, 3, 3, "ns2", "oid3", 3, 3), {1, {1, {0}}}, {1u, 1u, false, InsertType::BEGIN})
                .get();
            pool.test_split(make_ghobj(3, 3, 3, "ns3", "oid3" + padding, 1, 1),
                            {1, {1, {0}}},
                            {1u, 0u, false, InsertType::BEGIN})
                .get();
        }

        {
            ...
            pool.test_split(
                ...
                .get();
            pool.test_split(make_ghobj(3, 3, 3, "ns2", "oid3", 3, 3), {1, {1, {0}}}, {1u, 1u, true, InsertType::LAST})
                .get();
        }

        {
            ...
            logger().info("\n---------------------------------------------"
                          "\nsplit at stage 1; insert to left back at stage (0, 1,) 0\n");
            pool.test_split(make_ghobj(3, 3, 3, "ns2", "oid3", 2, 2), {1, {1, {0}}}, {1u, 0u, true, InsertType::LAST})
                .get();
        }

        {
            ...
            logger().info("\n---------------------------------------------"
                          "\nsplit at stage 0; insert to right front at stage 0\n");
            pool.test_split(make_ghobj(3, 3, 3, "ns3", "oid3" + padding, 2, 3),
                            {1, {1, {1}}},
...
TEST_F(d_seastore_tm_test_t, 6_random_insert_leaf_node)
{
    run_async([this] {
        ...
        KVPool kvs{{8, 11, 64, 256, 301, 320}, {8, 16, 128, 512, 576, 640}, {0, 32}, {0, 10}, {0, 4}};
        auto tree = std::make_unique<TreeBuilder<TRACK_CURSORS>>(
            kvs,
