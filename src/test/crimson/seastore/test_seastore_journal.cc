...
struct journal_test_t : seastar_test_suite_t, JournalSegmentProvider
{
    ...
    seastar::future<> set_up_fut() final
    {
        ...
        return segment_manager->init()
            ...
            .safe_then([](auto) {}, crimson::ct_error::all_same_way([] { ASSERT_FALSE("Unable to mount"); }));
    }
    ...
    auto replay_and_check()
    {
        ...
        advance();
        replay([&advance, &delta_checker](auto seq, auto base, const auto& di) mutable {
            if (!delta_checker) {
    ...
    seastar::future<> tear_down_fut() final { return seastar::now(); }
    ...
    delta_info_t generate_delta(size_t bytes)
    {
        ...
        return delta_info_t{extent_types_t::TEST_BLOCK, paddr_t{}, L_ADDR_NULL, 0, 0, block_size, 1, bl};
    }
};
