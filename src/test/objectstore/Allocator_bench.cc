...
public:
    ...
    void init_alloc(int64_t size, uint64_t min_alloc_size)
    {
        ...
        alloc.reset(Allocator::create(g_ceph_context, GetParam(), size, min_alloc_size));
    }
...
TEST_P(AllocTest, mempoolAccounting)
{
    ...
    Allocator* alloc = Allocator::create(g_ceph_context, GetParam(), capacity, alloc_size);
...
INSTANTIATE_TEST_SUITE_P(Allocator, AllocTest, ::testing::Values("stupid", "bitmap", "avl", "btree", "hybrid"));
