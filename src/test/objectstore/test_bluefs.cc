...
TEST(BlueFS, test_shared_alloc)
{
    ...
    shared_alloc.set(
        Allocator::create(
            g_ceph_context, g_ceph_context->_conf->bluefs_allocator, size, shared_alloc_unit, "test shared allocator"),
        shared_alloc_unit);
...
TEST(BlueFS, test_shared_alloc_sparse)
{
    ...
    shared_alloc.set(
        Allocator::create(
            g_ceph_context, g_ceph_context->_conf->bluefs_allocator, size, main_unit, "test shared allocator"),
        main_unit);
