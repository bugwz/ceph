...
CorruptFuncList crpt_funcs_set1 = {{0, &corrupt_object_size}, {1, &corrupt_nothing}};
...
ScrubGenerator::RealObjsConf minimal_snaps_configuration{/* RealObjsConf::objs */ {

    /* Clone 30  */ {ghobject_t{hobj_ms1_snp30, 0, shard_id_t{0}},
                     RealData{333,
                              0x17,
                              17,
                              21,
