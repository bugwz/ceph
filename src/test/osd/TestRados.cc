        ...
        if (m_op <= m_objects) {
          ...
          oid << " " << string(300, 'o');
            ...
            if (m_set_redirect) {
                ...
                cout << m_op << ": "
                     << "set_chunk oid " << oid.str() << " offset: " << rand_offset << " length: " << rand_length
                     << " target oid " << oid2.str() << " tgt_offset: " << rand_tgt_offset << std::endl;
                op = new SetChunkOp(m_op,
                                    &context,
                                    oid.str(),
                                    rand_offset,
                                    rand_length,
                                    oid2.str(),
                                    context.low_tier_pool_name,
                                    rand_tgt_offset,
                                    m_stats);
                return true;
            }
