...
TEST(AES, Encrypt)
{
    ...
    unsigned char want_cipher[] = {
        0xb3, 0x8f, 0x5b, 0xc9, 0x35, 0x4c, 0xf8, 0xc6, 0x13, 0x15, 0x66, 0x6f, 0x37, 0xd7, 0x79, 0x3a,
        0x11, 0x90, 0x7b, 0xe9, 0xd8, 0x3c, 0x35, 0x70, 0x58, 0x7b, 0x97, 0x9b, 0x03, 0xd2, 0xa5, 0x01,
    };
...
TEST(AES, DecryptNoBl)
{
    ...
    constexpr static std::size_t plain_buf_size = CryptoKey::get_max_outbuf_size(sizeof(want_plaintext));
...
template<std::size_t TextSizeV> static void aes_loop_cephx()
{
    CryptoHandler* h = g_ceph_context->get_crypto_handler(CEPH_CRYPTO_AES);
