...
{
public:
    StRadosOpenPool(int argc, const char** argv, CrossProcessSem* pool_setup_sem, CrossProcessSem* open_pool_sem,
    ...
    int run() override
    {
        ...
        if (m_pool_setup_sem) m_pool_setup_sem->wait();
        ...
        if (m_open_pool_sem) m_open_pool_sem->post();
...
int main(int argc, const char** argv)
{
    ...
    StRadosCreatePool r3(argc, argv, NULL, pool_setup_sem2, open_pool_sem2, pool, 50, ".obj");
