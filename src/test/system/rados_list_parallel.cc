...
{
public:
    RadosDeleteObjectsR(int argc, const char** argv, const std::string& pool_name)
    ...
    int run(void) override
    {
        ...
        if (!log_name.empty()) rados_conf_set(cl, "log_file", log_name.c_str());
...
{
public:
    RadosAddObjectsR(int argc, const char** argv, const std::string& pool_name, const std::string& suffix)
        : SysTestRunnable(argc, argv)
        , m_pool_name(pool_name)
        , m_suffix(suffix)
    {}
...
int main(int argc, const char** argv)
{
    ...
    // Test 1... list objects
    {
        StRadosCreatePool r1(argc, argv, NULL, pool_setup_sem, NULL, pool, g_num_objects, ".obj");
        StRadosListObjects r2(argc, argv, pool, false, g_num_objects, pool_setup_sem, modify_sem, NULL);
    ...
    {
        StRadosCreatePool r1(argc, argv, NULL, pool_setup_sem, NULL, pool, g_num_objects, ".obj");
        StRadosListObjects r2(argc, argv, pool, false, g_num_objects / 2, pool_setup_sem, modify_sem, NULL);
