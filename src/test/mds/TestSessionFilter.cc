...
TEST(MDSSessionFilter, ParseGood)
{
    args_eg_set examples = {
        ...
        {},
        {"id=123"},
        {"id=34", "client_metadata.root=/foo/bar", "auth_name=foxtrot", "state=reconnecting", "reconnecting=true"}};
...
{
    args_eg_set examples = {
        {"rhubarb"}, {"id="}, {"id=custard"}, {"=custard"}, {"reconnecting=MAYBE"}, {"reconnecting=2"}};
