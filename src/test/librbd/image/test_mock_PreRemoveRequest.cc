...
template<> class SnapshotRemoveRequest<MockTestImageCtx>
{
public:
    static SnapshotRemoveRequest* s_instance;
    static SnapshotRemoveRequest* create(MockTestImageCtx& image_ctx, cls::rbd::SnapshotNamespace sn, std::string name,
    ...
    SnapshotRemoveRequest() { s_instance = this; }
...
template<> class ListWatchersRequest<MockTestImageCtx>
{
public:
...
public:
    ...
    {
        EXPECT_CALL(mock_image_ctx, test_features(_)).WillRepeatedly(TestFeatures(&mock_image_ctx));
    }
    ...
    void expect_set_journal_policy(MockTestImageCtx& mock_image_ctx)
    {
        if (m_test_imctx->test_features(RBD_FEATURE_JOURNALING)) {
            EXPECT_CALL(mock_image_ctx, set_journal_policy(_)).WillOnce(Invoke([](journal::Policy* policy) {
    ...
    void expect_acquire_exclusive_lock(MockTestImageCtx& mock_image_ctx, MockExclusiveLock& mock_exclusive_lock, int r)
    {
        if (m_mock_imctx->exclusive_lock != nullptr) {
    ...
    void expect_remove_snap(MockTestImageCtx& mock_image_ctx, MockSnapshotRemoveRequest& mock_snap_remove_request,
                            int r)
    {
...
{
    m_mock_imctx->snap_info = {{123, {"snap1", {cls::rbd::UserSnapshotNamespace{}}, {}, {}, {}, {}, {}}}};
...
TEST_F(TestMockImagePreRemoveRequest, Watchers)
{
    ...
    MockListWatchersRequest mock_list_watchers_request;
    expect_list_image_watchers(*m_mock_imctx, mock_list_watchers_request, -EINVAL);
...
TEST_F(TestMockImagePreRemoveRequest, AutoDeleteSnapshots)
{
    ...
    m_mock_imctx->snap_info = {{123, {"snap1", {cls::rbd::TrashSnapshotNamespace{}}, {}, {}, {}, {}, {}}}};
