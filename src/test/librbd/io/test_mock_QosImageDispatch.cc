...
TEST_F(TestMockIoImageRequestWQ, QosNoLimit)
{
    ...
    mock_image_request_wq.apply_qos_limit(IMAGE_DISPATCH_FLAG_QOS_BPS_THROTTLE, 0, 0, 1);
...
TEST_F(TestMockIoImageRequestWQ, BPSQosNoBurst)
{
    ...
    mock_image_request_wq.apply_qos_limit(IMAGE_DISPATCH_FLAG_QOS_BPS_THROTTLE, 1, 0, 1);
...
TEST_F(TestMockIoImageRequestWQ, BPSQosWithBurst)
{
    ...
    mock_image_request_wq.apply_qos_limit(IMAGE_DISPATCH_FLAG_QOS_BPS_THROTTLE, 1, 1, 1);
