...
template<> struct FlushTracker<MockTestImageCtx>
{
...
struct TestMockIoSimpleSchedulerObjectDispatch : public TestMockFixture
{
    ...
    ceph::mutex m_mock_timer_lock = ceph::make_mutex("TestMockIoSimpleSchedulerObjectDispatch::Mutex");
    ...
    void expect_get_object_name(MockTestImageCtx& mock_image_ctx, uint64_t object_no)
    {
        EXPECT_CALL(mock_image_ctx, get_object_name(object_no))
            .WillRepeatedly(Return(mock_image_ctx.image_ctx->get_object_name(object_no)));
    }

    void expect_dispatch_delayed_requests(MockTestImageCtx& mock_image_ctx, int r)
    {
    ...
    {
        EXPECT_CALL(m_mock_timer, cancel_event(timer_task)).WillOnce(Invoke([](Context* timer_task) {
            delete timer_task;
            return true;
        }));
    }
    ...
    void expect_schedule_dispatch_delayed_requests(Context* current_task, Context** new_task)
    {
...
TEST_F(TestMockIoSimpleSchedulerObjectDispatch, Read)
{
    ...
    MockSimpleSchedulerObjectDispatch mock_simple_scheduler_object_dispatch(&mock_image_ctx);
...
TEST_F(TestMockIoSimpleSchedulerObjectDispatch, Discard)
{
    ...
    ASSERT_FALSE(mock_simple_scheduler_object_dispatch.discard(
        0, 0, 4096, mock_image_ctx.get_data_io_context(), 0, {}, nullptr, nullptr, nullptr, &on_finish, nullptr));
...
TEST_F(TestMockIoSimpleSchedulerObjectDispatch, Write)
{
    ...
    C_SaferCond cond;
    Context* on_finish = &cond;
    ASSERT_FALSE(mock_simple_scheduler_object_dispatch.write(0,
                                                             0,
                                                             std::move(data),
...
TEST_F(TestMockIoSimpleSchedulerObjectDispatch, WriteSame)
{
    ...
    C_SaferCond cond;
    Context* on_finish = &cond;
    ASSERT_FALSE(mock_simple_scheduler_object_dispatch.write_same(0,
                                                                  0,
                                                                  4096,
...
TEST_F(TestMockIoSimpleSchedulerObjectDispatch, CompareAndWrite)
{
    ...
    C_SaferCond cond;
    Context* on_finish = &cond;
    ASSERT_FALSE(mock_simple_scheduler_object_dispatch.compare_and_write(0,
                                                                         0,
                                                                         std::move(cmp_data),
                                                                         std::move(write_data),
                                                                         mock_image_ctx.get_data_io_context(),
...
TEST_F(TestMockIoSimpleSchedulerObjectDispatch, WriteDelayed)
{
    ...
    ASSERT_TRUE(mock_simple_scheduler_object_dispatch.write(0,
                                                            0,
                                                            std::move(data),
                                                            mock_image_ctx.get_data_io_context(),
                                                            0,
...
TEST_F(TestMockIoSimpleSchedulerObjectDispatch, Mixed)
{
    ...
    Context* on_finish4 = &cond4;
    ASSERT_FALSE(mock_simple_scheduler_object_dispatch.discard(
        0, 4096, 4096, mock_image_ctx.get_data_io_context(), 0, {}, nullptr, nullptr, nullptr, &on_finish4, nullptr));
    ASSERT_NE(on_finish4, &cond4);
    ASSERT_EQ(0, on_dispatched2.wait());
    ASSERT_EQ(0, on_dispatched3.wait());
    ...
    Context* on_finish6 = &cond6;
    ASSERT_FALSE(mock_simple_scheduler_object_dispatch.discard(
        0, 4096, 4096, mock_image_ctx.get_data_io_context(), 0, {}, nullptr, nullptr, nullptr, &on_finish6, nullptr));
    ASSERT_NE(on_finish6, &cond6);
    ASSERT_EQ(0, on_dispatched5.wait());
...
TEST_F(TestMockIoSimpleSchedulerObjectDispatch, DispatchQueue)
{
    ...
    C_SaferCond cond1;
    Context* on_finish1 = &cond1;
    ASSERT_FALSE(mock_simple_scheduler_object_dispatch.write(object_no,
                                                             0,
                                                             std::move(data),
                                                             mock_image_ctx.get_data_io_context(),
                                                             0,
    ...
    Context* on_finish2 = &cond2;
    C_SaferCond on_dispatched2;
    ASSERT_TRUE(mock_simple_scheduler_object_dispatch.write(object_no,
                                                            0,
                                                            std::move(data),
                                                            mock_image_ctx.get_data_io_context(),
                                                            0,
