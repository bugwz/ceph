...
TEST_F(TestMirroring, SnapshotUnlinkPeer)
{
    ...
    C_SaferCond cond1;
    auto req = librbd::mirror::snapshot::UnlinkPeerRequest<>::create(ictx, snap_id, peer1_uuid, &cond1);
    req->send();
    ...
    C_SaferCond cond2;
    req = librbd::mirror::snapshot::UnlinkPeerRequest<>::create(ictx, snap_id, peer2_uuid, &cond2);
    req->send();
