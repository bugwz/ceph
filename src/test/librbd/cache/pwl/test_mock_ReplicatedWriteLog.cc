...
struct TestMockCacheReplicatedWriteLog : public TestMockFixture
{
    ...
    MockImageCacheStateRWL* get_cache_state(MockImageCtx& mock_image_ctx, MockApi& mock_api)
    {
        MockImageCacheStateRWL* rwl_state = new MockImageCacheStateRWL(&mock_image_ctx, mock_api);
        return rwl_state;
    }

    void validate_cache_state(librbd::ImageCtx* image_ctx, MockImageCacheStateRWL& state, bool present, bool empty,
...
TEST_F(TestMockCacheReplicatedWriteLog, init_shutdown)
{
    ...
    MockReplicatedWriteLog rwl(
        mock_image_ctx, get_cache_state(mock_image_ctx, mock_api), mock_image_writeback, mock_api);
