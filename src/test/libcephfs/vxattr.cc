...
TEST(LibCephFS, LayoutSetBadJSON)
{
...

    {
        ...
        ASSERT_EQ(-CEPHFS_EINVAL,
                  ceph_setxattr(
                      cmount, "test/d0", "ceph.dir.layout.json", (void*)new_layout, strlen(new_layout), XATTR_CREATE));
    }
...
TEST(LibCephFS, LayoutSetBadPoolName)
{
...

    {
        ...
        ASSERT_EQ(
            -CEPHFS_EINVAL,
            ceph_setxattr(cmount, "test/d0", "ceph.dir.layout.pool_name", (void*)"UglyPoolName", 12, XATTR_CREATE));
    }
...
TEST(LibCephFS, LayoutSetBadPoolId)
{
...

    {
        ...
        ASSERT_EQ(-CEPHFS_EINVAL,
                  ceph_setxattr(cmount, "test/d0", "ceph.dir.layout.pool_id", (void*)"300", 3, XATTR_CREATE));
    }
...
TEST(LibCephFS, LayoutSetInvalidFieldName)
{
...

    {
        ...
        ASSERT_EQ(-CEPHFS_ENODATA,
                  ceph_setxattr(cmount, "test/d0", "ceph.dir.layout.bad_field", (void*)"300", 3, XATTR_CREATE));
    }
