...
using test_functions = std::vector<std::pair<std::string, bool (*)(std::string&)>>;
...
public:
    ...
    void add_test(const std::string& target, const std::string& command, bool (*test)(std::string&));
