...
void RadosTestFixture::SetUpTestCase()
{
    ...
    _thread_pool = new ThreadPool(cct, "RadosTestFixture::_thread_pool", "tp_test", 1);
    _thread_pool->start();
}
...
void RadosTestFixture::SetUp()
{
    ...
    m_work_queue = new ContextWQ("RadosTestFixture::m_work_queue", ceph::make_timespan(60), _thread_pool);
...
int RadosTestFixture::create(const std::string& oid, uint8_t order, uint8_t splay_width)
{
...
int RadosTestFixture::client_register(const std::string& oid, const std::string& id, const std::string& description)
{
    bufferlist data;
...
int RadosTestFixture::client_commit(const std::string& oid, const std::string& id,
