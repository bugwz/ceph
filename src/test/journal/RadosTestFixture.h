...
public:
    ...
    int create(const std::string& oid, uint8_t order = 14, uint8_t splay_width = 2);
    ...
    int client_register(const std::string& oid, const std::string& id = "client", const std::string& description = "");
