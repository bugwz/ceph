...
template<typename A> static void test_empty()
{
    A a;
...
struct not_noexcept
{
    ...
    not_noexcept& operator=(const not_noexcept&) noexcept(false) { return *this; }

    not_noexcept(not_noexcept&&) noexcept(false) {}
    not_noexcept& operator=(not_noexcept&&) noexcept(false) { return *this; }

    template<typename... Args> explicit not_noexcept(Args&&...) noexcept(false) {}

    template<typename U, typename... Args> not_noexcept(std::initializer_list<U>, Args&&...) noexcept(false) {}
};

template<typename A> static void test_value_CMD()
{
    {
        cmd_tattler::reset();
        cmd_tattler c;
...
{
    static_assert(std::is_nothrow_constructible_v<immobile_any<1024>, const cmd_tattler&>);
    static_assert(std::is_nothrow_assignable_v<immobile_any<1024>, const cmd_tattler&>);
    static_assert(std::is_nothrow_constructible_v<immobile_any<1024>, cmd_tattler&&>);
    static_assert(std::is_nothrow_assignable_v<immobile_any<1024>, cmd_tattler&&>);

    static_assert(!std::is_nothrow_constructible_v<immobile_any<1024>, const not_noexcept&>);
    static_assert(!std::is_nothrow_assignable_v<immobile_any<1024>, const not_noexcept&>);
    static_assert(!std::is_nothrow_constructible_v<immobile_any<1024>, not_noexcept&&>);
    static_assert(!std::is_nothrow_assignable_v<immobile_any<1024>, not_noexcept&&>);
...
{
    static_assert(!std::is_nothrow_constructible_v<unique_any, const cmd_tattler&>);
    static_assert(!std::is_nothrow_assignable_v<unique_any, const cmd_tattler&>);
    static_assert(!std::is_nothrow_constructible_v<unique_any, cmd_tattler&&>);
    static_assert(!std::is_nothrow_assignable_v<unique_any, cmd_tattler&&>);

    static_assert(!std::is_nothrow_constructible_v<unique_any, const not_noexcept&>);
    static_assert(!std::is_nothrow_assignable_v<unique_any, const not_noexcept&>);
    static_assert(!std::is_nothrow_constructible_v<unique_any, not_noexcept&&>);
    static_assert(!std::is_nothrow_assignable_v<unique_any, not_noexcept&&>);
...
{
    static_assert(!std::is_nothrow_constructible_v<shared_any, const cmd_tattler&>);
    static_assert(!std::is_nothrow_assignable_v<shared_any, const cmd_tattler&>);
    static_assert(!std::is_nothrow_constructible_v<shared_any, cmd_tattler&&>);
    static_assert(!std::is_nothrow_assignable_v<shared_any, cmd_tattler&&>);

    static_assert(!std::is_nothrow_constructible_v<shared_any, const not_noexcept&>);
    static_assert(!std::is_nothrow_assignable_v<shared_any, const not_noexcept&>);
    static_assert(!std::is_nothrow_constructible_v<shared_any, not_noexcept&&>);
    static_assert(!std::is_nothrow_assignable_v<shared_any, not_noexcept&&>);

    test_value_CMD<shared_any>();
}

template<typename A> static void test_move()
{
    {
        A a(5);
        EXPECT_TRUE(a.has_value());
...
template<typename A> static void test_copy()
{
    {
        const A a(5);
        EXPECT_TRUE(a.has_value());
...
template<typename A> static void test_unmoving_pack_il()
{
    ...
    // List + pack!!
    {
        const A a(std::in_place_type<unmoving>, {true, true, true, true}, nullptr, 5, 3.1);
        EXPECT_TRUE(a.has_value());
        EXPECT_EQ(typeid(unmoving), a.type());
        EXPECT_TRUE(any_cast<const unmoving&>(a).a);
...
{
    static_assert(std::is_nothrow_constructible_v<immobile_any<1024>, std::in_place_type_t<unmoving>>);
    ...
    static_assert(std::is_nothrow_constructible_v<immobile_any<1024>,
                                                  ...
                                                  int,
                                                  double>);
    static_assert(noexcept(immobile_any<1024>{}.emplace<unmoving>(nullptr, 5, 3.1)));

    static_assert(std::is_nothrow_constructible_v<immobile_any<1024>,
                                                  std::in_place_type_t<unmoving>,
                                                  std::initializer_list<int>>);
    static_assert(noexcept(immobile_any<1024>{}.emplace<unmoving>({true, true, true, true})));
    ...
    static_assert(std::is_nothrow_constructible_v<immobile_any<1024>,
                                                  ...
                                                  int,
                                                  double>);
    static_assert(noexcept(immobile_any<1024>{}.emplace<unmoving>({true, true, true, true}, nullptr, 5, 3.1)));
...
{
    static_assert(!std::is_nothrow_constructible_v<unique_any, std::in_place_type_t<unmoving>>);
    static_assert(!noexcept(unique_any{}.emplace<unmoving>()));

    static_assert(
        !std::is_nothrow_constructible_v<unique_any, std::in_place_type_t<unmoving>, std::nullptr_t, int, double>);
    static_assert(!noexcept(unique_any{}.emplace<unmoving>(nullptr, 5, 3.1)));

    static_assert(
        !std::is_nothrow_constructible_v<unique_any, std::in_place_type_t<unmoving>, std::initializer_list<int>>);
    static_assert(!noexcept(unique_any{}.emplace<unmoving>({true, true, true, true})));
    ...
    static_assert(!std::is_nothrow_constructible_v<unique_any,
                                                   ...
                                                   int,
                                                   double>);
    static_assert(!noexcept(unique_any{}.emplace<unmoving>({true, true, true, true}, nullptr, 5, 3.1)));
...
{
    static_assert(!std::is_nothrow_constructible_v<shared_any, std::in_place_type_t<unmoving>>);
    static_assert(!noexcept(shared_any{}.emplace<unmoving>()));

    static_assert(
        !std::is_nothrow_constructible_v<shared_any, std::in_place_type_t<unmoving>, std::nullptr_t, int, double>);
    static_assert(!noexcept(shared_any{}.emplace<unmoving>(nullptr, 5, 3.1)));

    static_assert(
        !std::is_nothrow_constructible_v<shared_any, std::in_place_type_t<unmoving>, std::initializer_list<int>>);
    static_assert(!noexcept(shared_any{}.emplace<unmoving>({true, true, true, true})));
    ...
    static_assert(!std::is_nothrow_constructible_v<shared_any,
                                                   ...
                                                   int,
                                                   double>);
    static_assert(!noexcept(shared_any{}.emplace<unmoving>({true, true, true, true}, nullptr, 5, 3.1)));

    test_unmoving_pack_il<shared_any>();
}

template<typename A> static void test_swap()
{
    A a(true);
...
template<typename A> static void test_cast()
{
    // Empty
    {
        A a;
...
TEST(Make, Immobile)
{
    ...
    // List + pack!!
    {
        auto a{make_immobile_any<unmoving, 1024>({true, true, true, true}, nullptr, 5, 3.1)};
        EXPECT_TRUE(a.has_value());
        EXPECT_EQ(typeid(unmoving), a.type());
        EXPECT_TRUE(any_cast<const unmoving&>(a).a);
        EXPECT_EQ(-12, *any_cast<const unmoving&>(a).a);
...
TEST(Make, Unique)
{
    ...
    // List + pack!!
    {
        auto a{make_unique_any<unmoving>({true, true, true, true}, nullptr, 5, 3.1)};
        EXPECT_TRUE(a.has_value());
        EXPECT_EQ(typeid(unmoving), a.type());
        EXPECT_TRUE(any_cast<const unmoving&>(a).a);
        EXPECT_EQ(-12, *any_cast<const unmoving&>(a).a);
...
TEST(Make, Shared)
{
    ...
    // List + pack!!
    {
        auto a{make_shared_any<unmoving>({true, true, true, true}, nullptr, 5, 3.1)};
        EXPECT_TRUE(a.has_value());
        EXPECT_EQ(typeid(unmoving), a.type());
        EXPECT_TRUE(any_cast<const unmoving&>(a).a);
        EXPECT_EQ(-12, *any_cast<const unmoving&>(a).a);
