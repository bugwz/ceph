...
{
public:
    void SetUp() override { ceph::crypto::init(); }
};
...
TEST(Digest, SHA1)
{
    auto digest = [](const bufferlist& bl) { return ceph::crypto::digest<ceph::crypto::SHA1>(bl); };
    {
        bufferlist bl;
...
TEST(Digest, SHA256)
{
    auto digest = [](const bufferlist& bl) { return ceph::crypto::digest<ceph::crypto::SHA256>(bl); };
    {
        bufferlist bl;
...
TEST(Digest, SHA512)
{
    auto digest = [](const bufferlist& bl) { return ceph::crypto::digest<ceph::crypto::SHA512>(bl); };
    {
        bufferlist bl;
        sha512_digest_t sha512 = digest(bl);
        EXPECT_EQ("cf83e1357eefb8bdf1542850d66d8007d620e4050b5715dc83f4a921d36ce9ce47d0d13c5d85f2b0ff8318d2877eec2f63b9"
    ...
    }
    {
        ...
        bl.append("Hello");
        sha512_digest_t sha512 = digest(bl);
        EXPECT_EQ("3615f80c9d293ed7402687f94b22d58e529b8cc7916f8fac7fddf7fbd5af4cf777d3d795a7a00a16bf7e7f3fb9561ee9baae"
                  "480da9fe7a18769e71886b03f315",
                  sha512.to_str());
    }
    {
        bufferlist bl, bl2;
        ...
        bl.claim_append(bl2);
        sha512_digest_t sha512 = digest(bl);
        EXPECT_EQ("c1527cd893c124773d811911970c8fe6e857d6df5dc9226bd8a160614c0cd963a4ddea2b94bb7d36021ef9d865d5cea294a8"
                  "2dd49a0bb269f51f6e7a57f79421",
                  sha512.to_str());
        bl2.append("  How are you today?");
        bl.claim_append(bl2);
        sha512 = digest(bl);
        EXPECT_EQ("7d50e299496754f9a0d158e018d4b733f2ef51c487b43b50719ffdabe3c3da5a347029741056887b4ffa2ddd0aa9e0dd358b"
                  "8ed9da9a4f3455f44896fc8e5395",
                  sha512.to_str());
    }
    {
        bufferptr p(65536);
        ...
        bl.append(p);
        sha512_digest_t sha512 = digest(bl);
        EXPECT_EQ("73e4153936dab198397b74ee9efc26093dda721eaab2f8d92786891153b45b04265a161b169c988edb0db2c53124607b6eaa"
                  "a816559c5ce54f3dbc9fa6a7a4b2",
                  sha512.to_str());
    }
}
