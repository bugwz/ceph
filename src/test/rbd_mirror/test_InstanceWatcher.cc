...
{
    InstanceWatcher<> instance_watcher(m_local_io_ctx, *m_threads->asio_engine, nullptr, nullptr, m_instance_id);
...
TEST_F(TestInstanceWatcher, Remove)
{
    ...
    InstanceWatcher<> instance_watcher(m_local_io_ctx, *m_threads->asio_engine, nullptr, nullptr, "instance_id");
    // Init
    ASSERT_EQ(0, instance_watcher.init());
    ...
    InstanceWatcher<>::remove_instance(m_local_io_ctx, *m_threads->asio_engine, "instance_id", &on_remove);
    ...
    InstanceWatcher<>::remove_instance(m_local_io_ctx, *m_threads->asio_engine, instance_id, &on_remove_noent);
