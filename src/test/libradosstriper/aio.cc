...
TEST_F(StriperTest, SimpleWrite)
{
    ...
    ASSERT_EQ(0, rados_aio_create_completion2(&test_data, set_completion_complete, &my_completion));
    char buf[128];
...
{
    AioTestData test_data;
    AioCompletion* my_completion = librados::Rados::aio_create_completion((void*)&test_data, set_completion_complete);
    char buf[128];
    memset(buf, 0xcc, sizeof(buf));
    bufferlist bl1;
...
{
    AioTestData test_data;
    AioCompletion* my_completion = librados::Rados::aio_create_completion(&test_data, set_completion_complete);
    char buf[128];
    memset(buf, 0xcc, sizeof(buf));
    bufferlist bl1;
    bl1.append(buf, sizeof(buf));
...
TEST_F(StriperTest, RoundTrip)
{
    ...
    ASSERT_EQ(0, rados_aio_create_completion2(&test_data, set_completion_complete, &my_completion2));
...
TEST_F(StriperTestPP, RoundTripPP)
{
    ...
    bufferlist bl2;
    AioCompletion* my_completion2 = librados::Rados::aio_create_completion(&test_data, set_completion_complete);
...
TEST_F(StriperTest, RoundTripAppend)
{
    ...
    ASSERT_EQ(0, rados_aio_create_completion2(&test_data, set_completion_complete, &my_completion3));
...
TEST_F(StriperTestPP, RoundTripAppendPP)
{
    ...
    bufferlist bl3;
    AioCompletion* my_completion3 = librados::Rados::aio_create_completion(&test_data, set_completion_complete);
