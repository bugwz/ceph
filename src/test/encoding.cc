...
{
    switch (which) {
    case 0: throw buffer::malformed_input(DECODE_ERR_OLDVERSION(__PRETTY_FUNCTION__, 100, 200));
    case 1: throw buffer::malformed_input(DECODE_ERR_PAST(__PRETTY_FUNCTION__));
    }
}
