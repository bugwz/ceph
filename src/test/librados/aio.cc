...
TEST(LibRadosAio, TooBig)
{
    ...
    ASSERT_EQ(-E2BIG, rados_aio_write(test_data.m_ioctx, "foo", my_completion, buf, UINT_MAX, 0));
    ASSERT_EQ(-E2BIG, rados_aio_write_full(test_data.m_ioctx, "foo", my_completion, buf, UINT_MAX));
    ASSERT_EQ(-E2BIG, rados_aio_append(test_data.m_ioctx, "foo", my_completion, buf, UINT_MAX));
...
TEST(LibRadosAio, SimpleWrite)
{
    ...
    char buf[128];
    memset(buf, 0xcc, sizeof(buf));
    ASSERT_EQ(0, rados_aio_write(test_data.m_ioctx, "foo", my_completion, buf, sizeof(buf), 0));
    {
        TestAlarm alarm;
    ...
    ASSERT_EQ(0, rados_aio_write(test_data.m_ioctx, "foo", my_completion2, buf, sizeof(buf), 0));
    {
        TestAlarm alarm;
...
TEST(LibRadosAio, RoundTrip)
{
    ...
    rados_completion_t my_completion2;
    ASSERT_EQ(0, rados_aio_create_completion2(nullptr, nullptr, &my_completion2));
    ASSERT_EQ(0, rados_aio_read(test_data.m_ioctx, "foo", my_completion2, buf2, sizeof(buf2), 0));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, rados_aio_wait_for_complete(my_completion2));
    }
...
TEST(LibRadosAio, RoundTrip3)
{
    ...
    ASSERT_EQ(0, rados_aio_write_op_operate(op1, test_data.m_ioctx, my_completion, "foo", NULL, 0));
    ...
    rados_read_op_set_flags(op2, LIBRADOS_OP_FLAG_FADVISE_NOCACHE | LIBRADOS_OP_FLAG_FADVISE_RANDOM);
    ceph_le32 init_value(-1);
    ceph_le32 checksum[2];
    rados_read_op_checksum(op2,
                           ...
                           sizeof(checksum),
                           NULL);
    ASSERT_EQ(0, rados_aio_read_op_operate(op2, test_data.m_ioctx, my_completion2, "foo", 0));
...
TEST(LibRadosAio, RoundTripAppend)
{
    ...
    char buf[128];
    memset(buf, 0xcc, sizeof(buf));
    ASSERT_EQ(0, rados_aio_append(test_data.m_ioctx, "foo", my_completion, buf, sizeof(buf)));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, rados_aio_wait_for_complete(my_completion));
    }
    ...
    ASSERT_EQ(0, rados_aio_create_completion2(nullptr, nullptr, &my_completion2));
    ASSERT_EQ(0, rados_aio_append(test_data.m_ioctx, "foo", my_completion2, buf2, sizeof(buf2)));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, rados_aio_wait_for_complete(my_completion2));
    }
    ...
    ASSERT_EQ(0, rados_aio_read(test_data.m_ioctx, "foo", my_completion3, buf3, sizeof(buf3), 0));
    {
        TestAlarm alarm;
...
TEST(LibRadosAio, RmXattr)
{
    ...
    ASSERT_EQ(
        0, rados_aio_setxattr(test_data.m_ioctx, "foo_rmxattr", my_completion4, attr2, attr2_buf, sizeof(attr2_buf)));
    {
        TestAlarm alarm;
...
TEST(LibRadosAio, XattrIter)
{
    ...
    rados_completion_t my_completion;
    ASSERT_EQ(0, rados_aio_create_completion2((void*)&test_data, nullptr, &my_completion));
...
TEST(LibRadosAio, ReturnValue)
{
    ...
    ASSERT_EQ(0, rados_aio_read(test_data.m_ioctx, "nonexistent", my_completion, buf, sizeof(buf), 0));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, rados_aio_wait_for_complete(my_completion));
    }
...
TEST(LibRadosAio, RoundTripWriteFull)
{
    ...
    memset(buf2, 0xdd, sizeof(buf2));
    ASSERT_EQ(0, rados_aio_create_completion2(nullptr, nullptr, &my_completion2));
    ASSERT_EQ(0, rados_aio_write_full(test_data.m_ioctx, "foo", my_completion2, buf2, sizeof(buf2)));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, rados_aio_wait_for_complete(my_completion2));
    }
...
TEST(LibRadosAio, RoundTripWriteSame)
{
    ...
    ASSERT_EQ(0, rados_aio_write(test_data.m_ioctx, "foo", my_completion, full, sizeof(full), 0));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, rados_aio_wait_for_complete(my_completion));
    }
    ...
    ASSERT_EQ(0, rados_aio_create_completion2(nullptr, nullptr, &my_completion2));
    ASSERT_EQ(0, rados_aio_writesame(test_data.m_ioctx, "foo", my_completion2, buf, sizeof(buf), ws_write_len, 0));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, rados_aio_wait_for_complete(my_completion2));
    }
    ASSERT_EQ(0, rados_aio_get_return_value(my_completion2));
    ASSERT_EQ(0, rados_aio_create_completion2(nullptr, nullptr, &my_completion3));
    ASSERT_EQ(0, rados_aio_read(test_data.m_ioctx, "foo", my_completion3, full, sizeof(full), 0));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, rados_aio_wait_for_complete(my_completion3));
    }
...
TEST(LibRadosAio, SimpleStat)
{
    ...
    rados_completion_t my_completion2;
    ASSERT_EQ(0, rados_aio_create_completion2(nullptr, nullptr, &my_completion2));
    ASSERT_EQ(0, rados_aio_stat(test_data.m_ioctx, "foo", my_completion2, &psize, &pmtime));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, rados_aio_wait_for_complete(my_completion2));
    }
...
TEST(LibRadosAio, OperateMtime)
{
    ...
    time_t set_mtime = 1457129052;
    {
        ...
        ASSERT_EQ(0, rados_aio_write_op_operate(op, test_data.m_ioctx, completion, "foo", &set_mtime, 0));
        {
            TestAlarm alarm;
...
TEST(LibRadosAio, Operate2Mtime)
{
    ...
    timespec set_mtime{1457129052, 123456789};
    {
        ...
        rados_completion_t completion;
        ASSERT_EQ(0, rados_aio_create_completion2(nullptr, nullptr, &completion));
        ASSERT_EQ(0, rados_aio_write_op_operate2(op, test_data.m_ioctx, completion, "foo", &set_mtime, 0));
        {
            TestAlarm alarm;
            ASSERT_EQ(0, rados_aio_wait_for_complete(completion));
        }
...
TEST(LibRadosAio, SimpleStatNS)
{
    ...
    memset(buf2, 0xbb, sizeof(buf2));
    ASSERT_EQ(0, rados_aio_create_completion2(nullptr, nullptr, &my_completion));
    ASSERT_EQ(0, rados_aio_write(test_data.m_ioctx, "foo", my_completion, buf2, sizeof(buf2), 0));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, rados_aio_wait_for_complete(my_completion));
    }
    ...
    rados_completion_t my_completion3;
    ASSERT_EQ(0, rados_aio_create_completion2(nullptr, nullptr, &my_completion3));
    ASSERT_EQ(0, rados_aio_stat(test_data.m_ioctx, "foo", my_completion3, &psize, &pmtime));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, rados_aio_wait_for_complete(my_completion3));
    }
...
TEST(LibRadosAio, StatRemove)
{
    ...
    rados_completion_t my_completion4;
    ASSERT_EQ(0, rados_aio_create_completion2(nullptr, nullptr, &my_completion4));
    ASSERT_EQ(0, rados_aio_stat(test_data.m_ioctx, "foo", my_completion4, &psize2, &pmtime2));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, rados_aio_wait_for_complete(my_completion4));
    }
...
TEST(LibRadosAio, ExecuteClass)
{
    ...
    char out[128];
    ASSERT_EQ(
        0, rados_aio_exec(test_data.m_ioctx, "foo", my_completion2, "hello", "say_hello", NULL, 0, out, sizeof(out)));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, rados_aio_wait_for_complete(my_completion2));
    }
...
TEST(LibRadosAio, MultiWrite)
{
    ...
    memset(buf2, 0xdd, sizeof(buf2));
    ASSERT_EQ(0, rados_aio_create_completion2(nullptr, nullptr, &my_completion2));
    ASSERT_EQ(0, rados_aio_write(test_data.m_ioctx, "foo", my_completion2, buf2, sizeof(buf2), sizeof(buf)));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, rados_aio_wait_for_complete(my_completion2));
    }
...
TEST(LibRadosAioEC, RoundTripAppend)
{
    ...
    ASSERT_EQ(0, rados_aio_append(test_data.m_ioctx, "foo", my_completion, buf, bsize));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, rados_aio_wait_for_complete(my_completion));
    }
    ...
    ASSERT_EQ(0, rados_aio_create_completion2(nullptr, nullptr, &my_completion2));
    ASSERT_EQ(0, rados_aio_append(test_data.m_ioctx, "foo", my_completion2, buf2, hbsize));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, rados_aio_wait_for_complete(my_completion2));
    }
    ...
    ASSERT_EQ(0, rados_aio_create_completion2(nullptr, nullptr, &my_completion3));
    ASSERT_EQ(0, rados_aio_append(test_data.m_ioctx, "foo", my_completion3, buf2, hbsize));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, rados_aio_wait_for_complete(my_completion3));
    }
    ...
    ASSERT_EQ(0, rados_aio_create_completion2(nullptr, nullptr, &my_completion4));
    ASSERT_EQ(0, rados_aio_read(test_data.m_ioctx, "foo", my_completion4, buf3, bsize * 3, 0));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, rados_aio_wait_for_complete(my_completion4));
    }
