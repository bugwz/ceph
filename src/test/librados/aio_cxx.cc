...
TEST(LibRadosAio, PoolQuotaPP)
{
    ...
    for (n = 0; n < 1024; ++n) {
        ...
        ASSERT_EQ(0, ioctx.aio_operate("foo" + stringify(n), completion.get(), &op, librados::OPERATION_FULL_TRY));
...
TEST(LibRadosAio, RoundTripPP)
{
    ...
    ASSERT_EQ(0, test_data.m_ioctx.aio_read("foo", my_completion2.get(), &bl2, sizeof(buf), 0));
    {
        TestAlarm alarm;
...
TEST(LibRadosAio, RoundTripSparseReadPP)
{
    ...
    auto my_completion2 = std::unique_ptr<AioCompletion>{Rados::aio_create_completion()};
    ASSERT_TRUE(my_completion2);
    ASSERT_EQ(0, test_data.m_ioctx.aio_sparse_read("foo", my_completion2.get(), &extents, &bl2, sizeof(buf), 0));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, my_completion2->wait_for_complete());
    }
...
TEST(LibRadosAio, RoundTripWriteFullPP)
{
    ...
    ASSERT_EQ(0, test_data.m_ioctx.aio_read("foo", my_completion3.get(), &bl3, sizeof(buf), 0));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, my_completion3->wait_for_complete());
    }
...
TEST(LibRadosAio, RoundTripWriteSamePP)
{
    ...
    ASSERT_EQ(0, test_data.m_ioctx.aio_write("foo", my_completion.get(), bl1, sizeof(full), 0));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, my_completion->wait_for_complete());
    }
    ...
    auto my_completion2 = std::unique_ptr<AioCompletion>{Rados::aio_create_completion()};
    ASSERT_TRUE(my_completion2);
    ASSERT_EQ(0, test_data.m_ioctx.aio_writesame("foo", my_completion2.get(), bl2, ws_write_len, 0));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, my_completion2->wait_for_complete());
    }
    ...
    auto my_completion3 = std::unique_ptr<AioCompletion>{Rados::aio_create_completion()};
    ASSERT_TRUE(my_completion3);
    ASSERT_EQ(0, test_data.m_ioctx.aio_read("foo", my_completion3.get(), &bl3, sizeof(full), 0));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, my_completion3->wait_for_complete());
    }
...
TEST(LibRadosAio, SimpleStatPPNS)
{
    ...
    auto my_completion2 = std::unique_ptr<AioCompletion>{Rados::aio_create_completion()};
    ASSERT_TRUE(my_completion2);
    ASSERT_EQ(0, test_data.m_ioctx.aio_stat("foo", my_completion2.get(), &psize, &pmtime));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, my_completion2->wait_for_complete());
    }
...
TEST(LibRadosAio, StatRemovePP)
{
    ...
    ASSERT_EQ(0, test_data.m_ioctx.aio_stat("foo", my_completion4.get(), &psize2, &pmtime2));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, my_completion4->wait_for_complete());
    }
...
TEST(LibRadosAio, ExecuteClassPP)
{
    ...
    ASSERT_TRUE(my_completion2);
    bufferlist in, out;
    ASSERT_EQ(0, test_data.m_ioctx.aio_exec("foo", my_completion2.get(), "hello", "say_hello", in, &out));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, my_completion2->wait_for_complete());
    }
...
TEST(LibRadosAio, MultiWritePP)
{
    ...
    auto my_completion2 = std::unique_ptr<AioCompletion>{Rados::aio_create_completion()};
    ASSERT_TRUE(my_completion2);
    ASSERT_EQ(0, test_data.m_ioctx.aio_write("foo", my_completion2.get(), bl2, sizeof(buf2), sizeof(buf)));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, my_completion2->wait_for_complete());
    }
    ...
    auto my_completion3 = std::unique_ptr<AioCompletion>{Rados::aio_create_completion()};
    ASSERT_TRUE(my_completion3);
    ASSERT_EQ(0, test_data.m_ioctx.aio_read("foo", my_completion3.get(), &bl3, (sizeof(buf) + sizeof(buf2) * 3), 0));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, my_completion3->wait_for_complete());
    }
...
TEST(LibRadosAio, RoundTripAppendPP)
{
    ...
    bufferlist bl1;
    bl1.append(buf, sizeof(buf));
    ASSERT_EQ(0, test_data.m_ioctx.aio_append("foo", my_completion.get(), bl1, sizeof(buf)));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, my_completion->wait_for_complete());
    }
    ...
    auto my_completion2 = std::unique_ptr<AioCompletion>{Rados::aio_create_completion()};
    ASSERT_TRUE(my_completion2);
    ASSERT_EQ(0, test_data.m_ioctx.aio_append("foo", my_completion2.get(), bl2, sizeof(buf2)));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, my_completion2->wait_for_complete());
    }
    ...
    auto my_completion3 = std::unique_ptr<AioCompletion>{Rados::aio_create_completion()};
    ASSERT_TRUE(my_completion3);
    ASSERT_EQ(0, test_data.m_ioctx.aio_read("foo", my_completion3.get(), &bl3, 2 * sizeof(buf), 0));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, my_completion3->wait_for_complete());
    }
...
TEST(LibRadosAioEC, RoundTripAppendPP)
{
    ...
    ASSERT_EQ(0, test_data.m_ioctx.aio_append("foo", my_completion.get(), bl1, bsize));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, my_completion->wait_for_complete());
    }
    ...
    auto my_completion2 = std::unique_ptr<AioCompletion>{Rados::aio_create_completion()};
    ASSERT_TRUE(my_completion2);
    ASSERT_EQ(0, test_data.m_ioctx.aio_append("foo", my_completion2.get(), bl2, hbsize));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, my_completion2->wait_for_complete());
    }
    ...
    auto my_completion3 = std::unique_ptr<AioCompletion>{Rados::aio_create_completion()};
    ASSERT_TRUE(my_completion3);
    ASSERT_EQ(0, test_data.m_ioctx.aio_append("foo", my_completion3.get(), bl2, hbsize));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, my_completion3->wait_for_complete());
    }
    ...
    auto my_completion4 = std::unique_ptr<AioCompletion>{Rados::aio_create_completion()};
    ASSERT_TRUE(my_completion4);
    ASSERT_EQ(0, test_data.m_ioctx.aio_read("foo", my_completion4.get(), &bl3, bsize * 3, 0));
    {
        TestAlarm alarm;
        ASSERT_EQ(0, my_completion4->wait_for_complete());
    }
...
TEST(LibRadosAio, RacingRemovePP)
{
    ...
    ASSERT_EQ(0, test_data.m_ioctx.aio_write("foo", my_completion.get(), bl, sizeof(buf), 0));
    {
        TestAlarm alarm;
