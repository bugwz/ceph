...
{
public:
    RadosTestParamPPNS(bool c = false)
        : cluster(s_cluster)
        , cleanup(c)
    {}
...
{
    RadosTestECPPNSCleanup()
        : RadosTestECPPNS(true)
    {}
};
