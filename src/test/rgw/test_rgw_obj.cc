...
template<class T> void dump(JSONFormatter& f, const string& name, const T& entity)
{
...
static void test_obj_to_raw(test_rgw_env& env, const rgw_bucket& b, const string& name, const string& instance,
