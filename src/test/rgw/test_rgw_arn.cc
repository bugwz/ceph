...
const std::string expected_basic_qualifier[BASIC_ENTRIES] = {"", "", "qualifier", "qualifier", "", "qualifier"};
...
const std::string wildcard_str[WILDCARD_ENTRIES] = {
    "arn:aws:s3:*:*:resource", "arn:aws:s3:*:12345:resource", "arn:aws:s3:us-east-1:*:resource"};
