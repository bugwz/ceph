...
TEST_F(PolicyTest, Parse1)
{
    ...
    ASSERT_NO_THROW(p = Policy(cct.get(), arbitrary_tenant, bufferlist::static_from_string(example1)));
    ASSERT_TRUE(p);
...
{
    auto p = Policy(cct.get(), arbitrary_tenant, bufferlist::static_from_string(example1));
    Environment e;
...
TEST_F(PolicyTest, Parse2)
{
    ...
    ASSERT_NO_THROW(p = Policy(cct.get(), arbitrary_tenant, bufferlist::static_from_string(example2)));
    ASSERT_TRUE(p);
...
{
    auto p = Policy(cct.get(), arbitrary_tenant, bufferlist::static_from_string(example2));
    Environment e;
...
TEST_F(PolicyTest, Parse3)
{
    ...
    ASSERT_NO_THROW(p = Policy(cct.get(), arbitrary_tenant, bufferlist::static_from_string(example3)));
    ASSERT_TRUE(p);
...
{
    auto p = Policy(cct.get(), arbitrary_tenant, bufferlist::static_from_string(example3));
    Environment em;
...
TEST_F(PolicyTest, Parse4)
{
    ...
    ASSERT_NO_THROW(p = Policy(cct.get(), arbitrary_tenant, bufferlist::static_from_string(example4)));
    ASSERT_TRUE(p);
...
{
    auto p = Policy(cct.get(), arbitrary_tenant, bufferlist::static_from_string(example4));
    Environment e;
...
TEST_F(PolicyTest, Parse5)
{
    ...
    ASSERT_NO_THROW(p = Policy(cct.get(), arbitrary_tenant, bufferlist::static_from_string(example5)));
    ASSERT_TRUE(p);
...
{
    auto p = Policy(cct.get(), arbitrary_tenant, bufferlist::static_from_string(example5));
    Environment e;
...
TEST_F(PolicyTest, Parse6)
{
    ...
    ASSERT_NO_THROW(p = Policy(cct.get(), arbitrary_tenant, bufferlist::static_from_string(example6)));
    ASSERT_TRUE(p);
...
{
    auto p = Policy(cct.get(), arbitrary_tenant, bufferlist::static_from_string(example6));
    Environment e;
...
TEST_F(PolicyTest, Parse7)
{
    ...
    ASSERT_NO_THROW(p = Policy(cct.get(), arbitrary_tenant, bufferlist::static_from_string(example7)));
    ASSERT_TRUE(p);
...
{
    auto p = Policy(cct.get(), arbitrary_tenant, bufferlist::static_from_string(example7));
    Environment e;
...
TEST_F(IPPolicyTest, ParseIPAddress)
{
    ...
    ASSERT_NO_THROW(p = Policy(cct.get(), arbitrary_tenant, bufferlist::static_from_string(ip_address_full_example)));
    ASSERT_TRUE(p);
...
{
    auto allowp = Policy(cct.get(), arbitrary_tenant, bufferlist::static_from_string(ip_address_allow_example));
    auto denyp = Policy(cct.get(), arbitrary_tenant, bufferlist::static_from_string(ip_address_deny_example));
    auto fullp = Policy(cct.get(), arbitrary_tenant, bufferlist::static_from_string(ip_address_full_example));
    Environment e;
