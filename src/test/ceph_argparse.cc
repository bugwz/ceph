...
public:
    ...
    ~VectorContainer()
    {
        for (std::vector<const char*>::iterator i = orig.begin(); i != orig.end(); ++i) {
            free((void*)*i);
        }
    }
    void refresh() { arr.assign(orig.begin(), orig.end()); }
...
TEST(CephArgParse, SimpleArgParse)
{
    ...
    for (std::vector<const char*>::iterator i = bar5.arr.begin(); i != bar5.arr.end();) {
    ...
    ostringstream err;
    for (std::vector<const char*>::iterator i = foo.arr.begin(); i != foo.arr.end();) {
    ...
    for (std::vector<const char*>::iterator i = none.arr.begin(); i != none.arr.end();) {
...
TEST(CephArgParse, DoubleDash)
{
    ...
    for (std::vector<const char*>::iterator i = args.arr.begin(); i != args.arr.end();) {
        std::string myarg;
...
TEST(CephArgParse, WithDashesAndUnderscores)
{
    ...
    for (std::vector<const char*>::iterator i = bazstuff1.arr.begin(); i != bazstuff1.arr.end();) {
    ...
    for (std::vector<const char*>::iterator i = bazstuff2.arr.begin(); i != bazstuff2.arr.end();) {
    ...
    for (std::vector<const char*>::iterator i = bazstuff3.arr.begin(); i != bazstuff3.arr.end();) {
    ...
    for (std::vector<const char*>::iterator i = bazstuff4.arr.begin(); i != bazstuff4.arr.end();) {
    ...
    for (std::vector<const char*>::iterator i = none1.arr.begin(); i != none1.arr.end();) {
    ...
    for (std::vector<const char*>::iterator i = none2.arr.begin(); i != none2.arr.end();) {
    ...
    for (std::vector<const char*>::iterator i = none3.arr.begin(); i != none3.arr.end();) {
