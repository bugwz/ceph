...
protected:
    ...
    void SetUp() override
    {
        ...
        ss_oid << test_info->test_case_name() << "_" << test_info->name() << "_" << getpid();
     ...
     */
    int __clslua_exec(const string& oid, const string& script, librados::bufferlist* input = NULL,
                      const string& funcname = "")
    {
        ...
        return cls_lua_client::exec(ioctx, oid, script, funcname, inbl, reply_output);
    }

    int clslua_exec(const string& script, librados::bufferlist* input = NULL, const string& funcname = "")
    {
