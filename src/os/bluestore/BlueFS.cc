        ...
        if (admin_socket) {
            ...
            if (r != 0) {
                ...
                r = admin_socket->register_command(
                    "bluefs debug_inject_read_zeros", hook, "Injects 8K zeros into next BlueFS read. Debug only.");
                ceph_assert(r == 0);
            }
        }
        return hook;
...
void BlueFS::_init_logger()
{
    ...
    b.add_u64(l_bluefs_db_total_bytes,
              "db_total_bytes",
              "Total bytes (main db device)",
              "b",
              PerfCountersBuilder::PRIO_USEFUL,
              unit_t(UNIT_BYTES));
    b.add_u64(l_bluefs_db_used_bytes,
              "db_used_bytes",
              "Used bytes (main db device)",
              "u",
              PerfCountersBuilder::PRIO_USEFUL,
              unit_t(UNIT_BYTES));
    b.add_u64(l_bluefs_wal_total_bytes,
              "wal_total_bytes",
              "Total bytes (wal device)",
              "walb",
              PerfCountersBuilder::PRIO_USEFUL,
              unit_t(UNIT_BYTES));
    b.add_u64(l_bluefs_wal_used_bytes,
              "wal_used_bytes",
              "Used bytes (wal device)",
              "walu",
              PerfCountersBuilder::PRIO_USEFUL,
              unit_t(UNIT_BYTES));
    b.add_u64(l_bluefs_slow_total_bytes,
              "slow_total_bytes",
              "Total bytes (slow device)",
              "slob",
              PerfCountersBuilder::PRIO_USEFUL,
              unit_t(UNIT_BYTES));
    b.add_u64(l_bluefs_slow_used_bytes,
              "slow_used_bytes",
    ...
    b.add_u64_counter(l_bluefs_log_write_count, "log_write_count", "Write op count to the metadata log");
    b.add_u64_counter(l_bluefs_logged_bytes,
                      "logged_bytes",
    ...
    b.add_u64_counter(l_bluefs_write_count_wal, "write_count_wal", "Write op count to WAL");
    b.add_u64_counter(l_bluefs_write_count_sst, "write_count_sst", "Write op count to SSTs");
    b.add_u64_counter(l_bluefs_bytes_written_wal,
                      "bytes_written_wal",
                      "Bytes written to WAL",
                      "walb",
                      PerfCountersBuilder::PRIO_CRITICAL);
    b.add_u64_counter(l_bluefs_bytes_written_sst,
                      "bytes_written_sst",
                      "Bytes written to SSTs",
                      "sstb",
                      PerfCountersBuilder::PRIO_CRITICAL,
                      unit_t(UNIT_BYTES));
    b.add_u64_counter(l_bluefs_bytes_written_slow,
                      "bytes_written_slow",
                      "Bytes written to WAL/SSTs at slow device",
                      "slwb",
                      PerfCountersBuilder::PRIO_CRITICAL,
                      unit_t(UNIT_BYTES));
    b.add_u64_counter(l_bluefs_max_bytes_wal,
                      "max_bytes_wal",
                      "Maximum bytes allocated from WAL",
                      "mxwb",
                      PerfCountersBuilder::PRIO_INTERESTING,
                      unit_t(UNIT_BYTES));
    b.add_u64_counter(l_bluefs_max_bytes_db,
                      "max_bytes_db",
                      "Maximum bytes allocated from DB",
                      "mxdb",
                      PerfCountersBuilder::PRIO_INTERESTING,
                      unit_t(UNIT_BYTES));
    b.add_u64_counter(l_bluefs_max_bytes_slow,
                      "max_bytes_slow",
                      "Maximum bytes allocated from SLOW",
                      "mxwb",
                      PerfCountersBuilder::PRIO_INTERESTING,
                      unit_t(UNIT_BYTES));
    b.add_u64_counter(l_bluefs_main_alloc_unit,
                      "alloc_unit_main",
                      "Allocation unit size (in bytes) for primary/shared device",
                      "aumb",
                      PerfCountersBuilder::PRIO_CRITICAL,
                      unit_t(UNIT_BYTES));
    b.add_u64_counter(l_bluefs_db_alloc_unit,
                      "alloc_unit_db",
                      "Allocation unit size (in bytes) for standalone DB device",
                      "audb",
                      PerfCountersBuilder::PRIO_CRITICAL,
                      unit_t(UNIT_BYTES));
    b.add_u64_counter(l_bluefs_wal_alloc_unit,
                      "alloc_unit_wal",
                      "Allocation unit size (in bytes) for standalone WAL device",
                      "auwb",
                      PerfCountersBuilder::PRIO_CRITICAL,
                      unit_t(UNIT_BYTES));
    b.add_u64_counter(l_bluefs_read_random_count,
                      "read_random_count",
                      "random read requests processed",
                      NULL,
                      PerfCountersBuilder::PRIO_USEFUL);
    b.add_u64_counter(l_bluefs_read_random_bytes,
                      "read_random_bytes",
                      "Bytes requested in random read mode",
                      NULL,
                      PerfCountersBuilder::PRIO_USEFUL,
                      unit_t(UNIT_BYTES));
    b.add_u64_counter(l_bluefs_read_random_disk_count,
                      "read_random_disk_count",
                      "random reads requests going to disk",
                      NULL,
                      PerfCountersBuilder::PRIO_USEFUL);
    b.add_u64_counter(l_bluefs_read_random_disk_bytes,
                      "read_random_disk_bytes",
                      "Bytes read from disk in random read mode",
                      "rrb",
                      PerfCountersBuilder::PRIO_INTERESTING,
                      unit_t(UNIT_BYTES));
    b.add_u64_counter(l_bluefs_read_random_disk_bytes_wal,
                      "read_random_disk_bytes_wal",
                      "random reads requests going to WAL disk",
                      NULL,
                      PerfCountersBuilder::PRIO_USEFUL,
                      unit_t(UNIT_BYTES));
    b.add_u64_counter(l_bluefs_read_random_disk_bytes_db,
                      "read_random_disk_bytes_db",
                      "random reads requests going to DB disk",
                      NULL,
                      PerfCountersBuilder::PRIO_USEFUL,
                      unit_t(UNIT_BYTES));
    b.add_u64_counter(l_bluefs_read_random_disk_bytes_slow,
    ...
    b.add_u64_counter(l_bluefs_read_random_buffer_bytes,
                      ...
                      unit_t(UNIT_BYTES));
    b.add_u64_counter(
        l_bluefs_read_count, "read_count", "buffered read requests processed", NULL, PerfCountersBuilder::PRIO_USEFUL);
    b.add_u64_counter(l_bluefs_read_bytes,
                      ...
                      PerfCountersBuilder::PRIO_USEFUL,
                      unit_t(UNIT_BYTES));
    b.add_u64_counter(l_bluefs_read_disk_count,
                      "read_disk_count",
                      "buffered reads requests going to disk",
                      NULL,
                      PerfCountersBuilder::PRIO_USEFUL);
    b.add_u64_counter(l_bluefs_read_disk_bytes,
                      "read_disk_bytes",
                      "Bytes read in buffered mode from disk",
                      "rb",
                      PerfCountersBuilder::PRIO_INTERESTING,
                      unit_t(UNIT_BYTES));
    b.add_u64_counter(l_bluefs_read_disk_bytes_wal,
                      "read_disk_bytes_wal",
                      "reads requests going to WAL disk",
                      NULL,
                      PerfCountersBuilder::PRIO_USEFUL,
                      unit_t(UNIT_BYTES));
    b.add_u64_counter(l_bluefs_read_disk_bytes_db,
                      "read_disk_bytes_db",
                      "reads requests going to DB disk",
                      NULL,
                      PerfCountersBuilder::PRIO_USEFUL,
                      unit_t(UNIT_BYTES));
    b.add_u64_counter(l_bluefs_read_disk_bytes_slow,
                      "read_disk_bytes_slow",
                      "reads requests going to main disk",
                      "rsb",
                      PerfCountersBuilder::PRIO_INTERESTING,
                      unit_t(UNIT_BYTES));
    b.add_u64_counter(l_bluefs_read_prefetch_count,
                      "read_prefetch_count",
                      "prefetch read requests processed",
                      NULL,
                      PerfCountersBuilder::PRIO_USEFUL);
    b.add_u64_counter(l_bluefs_read_prefetch_bytes,
                      "read_prefetch_bytes",
                      "Bytes requested in prefetch read mode",
                      NULL,
                      PerfCountersBuilder::PRIO_USEFUL,
                      unit_t(UNIT_BYTES));
    b.add_u64_counter(l_bluefs_write_count, "write_count", "Write requests processed");
    b.add_u64_counter(l_bluefs_write_disk_count, "write_disk_count", "Write requests sent to disk");
    b.add_u64_counter(l_bluefs_write_bytes,
                      "write_bytes",
                      "Bytes written",
                      NULL,
                      PerfCountersBuilder::PRIO_USEFUL,
                      unit_t(UNIT_BYTES));
    b.add_time_avg(l_bluefs_compaction_lat,
                   "compact_lat",
                   "Average bluefs log compaction latency",
                   "c__t",
                   PerfCountersBuilder::PRIO_INTERESTING);
    b.add_time_avg(l_bluefs_compaction_lock_lat,
                   "compact_lock_lat",
                   "Average lock duration while compacting bluefs log",
                   "c_lt",
                   PerfCountersBuilder::PRIO_INTERESTING);
    b.add_u64_counter(l_bluefs_alloc_shared_dev_fallbacks,
                      "alloc_slow_fallback",
                      "Amount of allocations that required fallback to "
                      " slow/shared device",
                      "asdf",
                      PerfCountersBuilder::PRIO_USEFUL);
    b.add_u64_counter(l_bluefs_alloc_shared_size_fallbacks,
                      ...
                      PerfCountersBuilder::PRIO_USEFUL);
    b.add_u64(
        l_bluefs_read_zeros_candidate, "read_zeros_candidate", "How many times bluefs read found page with all 0s");
    b.add_u64(
        l_bluefs_read_zeros_errors, "read_zeros_errors", "How many times bluefs read found transient page with all 0s");
...
int BlueFS::add_block_device(unsigned id, const string& path, bool trim, uint64_t reserved,
...
void BlueFS::dump_block_extents(ostream& out)
{
    for (unsigned i = 0; i < MAX_BDEV; ++i) {
        ...
        out << i << " : device size 0x" << std::hex << total << " : using 0x" << total - free << std::dec << "("
            << byte_u_t(total - free) << ")";
        out << "\n";
    }
}

void BlueFS::foreach_block_extents(unsigned id, std::function<void(uint64_t, uint32_t)> fn)
{
...
int BlueFS::mkfs(uuid_d osd_uuid, const bluefs_layout_t& layout)
{
    ...
    if (vselector == nullptr) {
        vselector.reset(new OriginalVolumeSelector(get_block_device_size(BlueFS::BDEV_WAL) * 95 / 100,
...
void BlueFS::_init_alloc()
{
    ...
    if (shared_alloc && shared_alloc->a) {
        ...
        shared_alloc_size = std::max(unit, shared_alloc_size);
    ...
    for (unsigned id = 0; id < bdev.size(); ++id) {
        ...
        if (is_shared_alloc(id)) {
            dout(1) << __func__ << " shared, id " << id << std::hex << ", capacity 0x" << bdev[id]->get_size()
            ...
            dout(1) << __func__ << " new, id " << id << std::hex << ", allocator name " << name << ", allocator type "
                    << cct->_conf->bluefs_allocator << ", capacity 0x" << bdev[id]->get_size() << ", block size 0x"
                    << alloc_size[id] << std::dec << dendl;
            alloc[id] =
                Allocator::create(cct, cct->_conf->bluefs_allocator, bdev[id]->get_size(), alloc_size[id], 0, 0, name);
...
int BlueFS::_read_and_check(uint8_t ndev, uint64_t off, uint64_t len, ceph::buffer::list* pbl, IOContext* ioc,
                            bool buffered)
{
    dout(10) << __func__ << " dev " << int(ndev) << ": 0x" << std::hex << off << "~" << len << std::dec
    ...
    if (inject_read_zeros) {
        if (len >= block_size * 2) {
            derr << __func__ << " injecting error, zeros at " << int(ndev) << ": 0x" << std::hex << (off + len / 2)
    ...
    if (all_zeros) {
        ...
        if (!bl.contents_equal(bl_reread)) {
            ...
            derr << __func__ << " initial read of " << int(ndev) << ": 0x" << std::hex << off << "~" << len << std::dec
...
int BlueFS::_read_random_and_check(uint8_t ndev, uint64_t off, uint64_t len, char* buf, bool buffered)
{
    dout(10) << __func__ << " dev " << int(ndev) << ": 0x" << std::hex << off << "~" << len << std::dec
             << (buffered ? " buffered" : "") << dendl;
    int r;
...
int BlueFS::_bdev_read(uint8_t ndev, uint64_t off, uint64_t len, ceph::buffer::list* pbl, IOContext* ioc, bool buffered)
{
    int cnt = 0;
    switch (ndev) {
...
int BlueFS::_bdev_read_random(uint8_t ndev, uint64_t off, uint64_t len, char* buf, bool buffered)
{
    int cnt = 0;
    switch (ndev) {
...
int BlueFS::mount()
{
    ...
    dout(10) << __func__ << " log write pos set to 0x" << std::hex << log.writer->pos << std::dec << dendl;
    // update log size
...
int BlueFS::prepare_new_device(int id, const bluefs_layout_t& layout)
{
    ...
    if (id == BDEV_NEWDB) {
        ...
        _rewrite_log_and_layout_sync_LNF_LD(
            false, BDEV_NEWDB, new_log_dev_cur, new_log_dev_next, RENAME_DB2SLOW, layout);
    }
    else if (id == BDEV_NEWWAL) {
        _rewrite_log_and_layout_sync_LNF_LD(false, BDEV_DB, BDEV_NEWWAL, BDEV_WAL, REMOVE_WAL, layout);
    }
    else {
        assert(false);
    }
...
int BlueFS::_write_super(int dev)
{
    ...
    dout(20) << __func__ << " v " << super.version << " crc 0x" << std::hex << crc << " offset 0x" << get_super_offset()
             << std::dec << dendl;
    return 0;
}
...
int BlueFS::_open_super()
{
    ...
    r = _bdev_read(BDEV_DB, get_super_offset(), get_super_length(), &bl, ioc[BDEV_DB], false);
    if (r < 0) return r;
    ...
    if (crc != expected_crc) {
        derr << __func__ << " bad crc on superblock, expected 0x" << std::hex << expected_crc << " != actual 0x" << crc
             << std::dec << dendl;
        return -EIO;
    }
    dout(10) << __func__ << " superblock " << super.version << dendl;
                               ...
                               const char* op_name)
{
    ...
    for (auto e : fnode_extents) {
        ...
        if (int r = _verify_alloc_granularity(id, e.offset, e.length, alloc_unit, op_name); r < 0) {
            return r;
        }

        apply_for_bitset_range(
            e.offset, e.length, alloc_unit, used_blocks[id], [&](uint64_t pos, boost::dynamic_bitset<uint64_t>& bs) {
        ...
        if (fail) {
            derr << __func__ << " " << op_name << " invalid extent " << int(e.bdev) << ": 0x" << std::hex << e.offset
                 << "~" << e.length << std::dec
...
int BlueFS::_verify_alloc_granularity(__u8 id, uint64_t offset, uint64_t length, uint64_t alloc_unit, const char* op)
{
    if ((offset & (alloc_unit - 1)) || (length & (alloc_unit - 1))) {
        derr << __func__ << " " << op << " of " << (int)id << ":0x" << std::hex << offset << "~" << length << std::dec
             << " does not align to alloc_size 0x" << std::hex << alloc_unit << std::dec << dendl;
        return -EFAULT;
    }
    return 0;
}
...
int BlueFS::_replay(bool noop, bool to_stdout)
{
    ...
    FileReader* log_reader = new FileReader(log_file,
    ...
    while (true) {
        ...
        if (uuid != super.uuid) {
            if (seen_recs) {
                dout(10) << __func__ << " 0x" << std::hex << pos << std::dec << ": stop: uuid " << uuid
                         << " != super.uuid " << super.uuid << dendl;
            }
            else {
                derr << __func__ << " 0x" << std::hex << pos << std::dec << ": stop: uuid " << uuid << " != super.uuid "
                     << super.uuid << ", block dump: \n";
                bufferlist t;
        ...
        if (seq != log_seq + 1) {
            if (seen_recs) {
                dout(10) << __func__ << " 0x" << std::hex << pos << std::dec << ": stop: seq " << seq << " != expected "
                         << log_seq + 1 << dendl;
                ;
            }
            else {
                derr << __func__ << " 0x" << std::hex << pos << std::dec << ": stop: seq " << seq << " != expected "
                     << log_seq + 1 << dendl;
                ;
            }
            break;
        ...
        if (more) {
            ...
            if (r < (int)more) {
                dout(10) << __func__ << " 0x" << std::hex << pos << ": stop: len is 0x" << bl.length() + more
                         << std::dec << ", which is past eof" << dendl;
        ...
        try {
            ...
            if (seen_recs && more) {
                dout(10) << __func__ << " 0x" << std::hex << pos << std::dec << ": stop: failed to decode: " << e.what()
                         << dendl;
            }
            else {
                derr << __func__ << " 0x" << std::hex << pos << std::dec << ": stop: failed to decode: " << e.what()
                     << dendl;
                delete log_reader;
                return -EIO;
            }
        ...
        while (!p.end()) {
            ...
            case bluefs_transaction_t::OP_JUMP:
            {
                ...
                decode(next_seq, p);
                decode(offset, p);
                dout(20) << __func__ << " 0x" << std::hex << pos << std::dec << ":  op_jump seq " << next_seq
                         << " offset 0x" << std::hex << offset << std::dec << dendl;
                if (unlikely(to_stdout)) {
                    std::cout << " 0x" << std::hex << pos << std::dec << ":  op_jump seq " << next_seq << " offset 0x"
                ...
                if (skip) {
                    ...
                    if (r != (int)skip) {
                        dout(10) << __func__ << " 0x" << std::hex << read_pos << ": stop: failed to skip to " << offset
                                 << std::dec << dendl;
            ...
            case bluefs_transaction_t::OP_DIR_LINK:
            {
                ...
                decode(filename, p);
                decode(ino, p);
                dout(20) << __func__ << " 0x" << std::hex << pos << std::dec << ":  op_dir_link "
                         << " " << dirname << "/" << filename << " to " << ino << dendl;
                if (unlikely(to_stdout)) {
                    std::cout << " 0x" << std::hex << pos << std::dec << ":  op_dir_link "
                              << " " << dirname << "/" << filename << " to " << ino << std::endl;
                }
            ...
            case bluefs_transaction_t::OP_DIR_UNLINK:
            {
                ...
                decode(dirname, p);
                decode(filename, p);
                dout(20) << __func__ << " 0x" << std::hex << pos << std::dec << ":  op_dir_unlink "
                         << " " << dirname << "/" << filename << dendl;
                if (unlikely(to_stdout)) {
                    std::cout << " 0x" << std::hex << pos << std::dec << ":  op_dir_unlink "
            ...
            case bluefs_transaction_t::OP_FILE_UPDATE:
            {
                ...
                decode(fnode, p);
                dout(20) << __func__ << " 0x" << std::hex << pos << std::dec << ":  op_file_update "
                         << " " << fnode << " " << dendl;
                if (unlikely(to_stdout)) {
                    std::cout << " 0x" << std::hex << pos << std::dec << ":  op_file_update "
                              << " " << fnode << std::endl;
                }
                if (!noop) {
            ...
            case bluefs_transaction_t::OP_FILE_UPDATE_INC:
            {
                ...
                decode(delta, p);
                dout(20) << __func__ << " 0x" << std::hex << pos << std::dec << ":  op_file_update_inc "
                         << " " << delta << " " << dendl;
                if (unlikely(to_stdout)) {
                    std::cout << " 0x" << std::hex << pos << std::dec << ":  op_file_update_inc "
                              << " " << delta << std::endl;
                }
                if (!noop) {
                    ...
                    dout(20) << __func__ << " 0x" << std::hex << pos << std::dec << ":  op_file_update_inc produced "
                             << " " << fnode << " " << dendl;
            ...
            default:
                derr << __func__ << " 0x" << std::hex << pos << std::dec << ": stop: unrecognized op " << (int)op
                     << dendl;
                delete log_reader;
                return -EIO;
            }
...
int BlueFS::device_migrate_to_existing(CephContext* cct, const set<int>& devs_source, int dev_target,
                                       const bluefs_layout_t& layout)
{
    ...
    for (auto& [ino, file_ref] : nodes.file_map) {
        ...
        bool rewrite = std::any_of(file_ref->fnode.extents.begin(), file_ref->fnode.extents.end(), [=](auto& ext) {
        ...
        if (rewrite) {
            ...
            for (const auto& old_ext : old_fnode_extents) {
                ...
                int r = _bdev_read_random(old_ext.bdev, old_ext.offset, old_ext.length, (char*)&buf.at(0), buffered);
                if (r != 0) {
                    derr << __func__ << " failed to read 0x" << std::hex << old_ext.offset << "~" << old_ext.length
                         << std::dec << " from " << (int)dev_target << dendl;
                    return -EIO;
                }
            ...
            // write entire file
            auto l = _allocate(dev_target, bl.length(), 0, &file_ref->fnode, 0, false);
            if (l < 0) {
                derr << __func__ << " unable to allocate len 0x" << std::hex << bl.length() << std::dec << " from "
                     << (int)dev_target << ": " << cpp_strerror(l) << dendl;
                return -ENOSPC;
            }
            ...
            for (auto& ext : file_ref->fnode.extents) {
                if (dev_target != dev_target_new && ext.bdev == dev_target) {
                    dout(20) << __func__ << "  "
                             << " ... adjusting extent 0x" << std::hex << ext.offset << std::dec << " bdev "
    ...
    _rewrite_log_and_layout_sync_LNF_LD(
        false, (flags & REMOVE_DB) ? BDEV_SLOW : BDEV_DB, new_log_dev_cur, new_log_dev_next, flags, layout);
    return 0;
}

int BlueFS::device_migrate_to_new(CephContext* cct, const set<int>& devs_source, int dev_target,
                                  const bluefs_layout_t& layout)
{
    vector<byte> buf;
    bool buffered = cct->_conf->bluefs_buffered_io;
    ...
    _rewrite_log_and_layout_sync_LNF_LD(false, super_dev, new_log_dev_cur, new_log_dev_next, flags, layout);
    return 0;
}
...
{
    BlueFS::FileRef file;
    lock_fnode_print(BlueFS::FileRef file)
        : file(file){};
};
...
{
    dout(20) << __func__ << " had refs " << file->refs << " on " << lock_fnode_print(file) << dendl;
                             ...
                             char* out)       ///< [out] copy it here
{
    ...
    int64_t ret = 0;
    dout(10) << __func__ << " h " << h << " 0x" << std::hex << off << "~" << len << std::dec << " from "
             << lock_fnode_print(h->file) << dendl;
    ...
    while (len > 0) {
        if (off < buf->bl_off || off >= buf->get_buf_end()) {
            ...
            dout(20) << __func__ << " read random 0x" << std::hex << x_off << "~" << l << std::dec << " of " << *p
                     << dendl;
            int r;
            if (!cct->_conf->bluefs_check_for_zeros) {
                r = _bdev_read_random(p->bdev, p->offset + x_off, l, out, cct->_conf->bluefs_buffered_io);
            }
            else {
                r = _read_random_and_check(p->bdev, p->offset + x_off, l, out, cct->_conf->bluefs_buffered_io);
            }
            ceph_assert(r == 0);
            off += l;
            len -= l;
    ...
    dout(20) << __func__ << std::hex << " got 0x" << ret << std::dec << dendl;
    --h->file->num_reading;
    return ret;
}
                      ...
                      char* out)           ///< [out] optional: or copy it here
{
    ...
    dout(10) << __func__ << " h " << h << " 0x" << std::hex << off << "~" << len << std::dec << " from "
             << lock_fnode_print(h->file) << (prefetch ? " prefetch" : "") << dendl;
    ...
    while (len > 0) {
        ...
        if (off < buf->bl_off || off >= buf->get_buf_end()) {
            ...
            if (off < buf->bl_off || off >= buf->get_buf_end()) {
                ...
                dout(20) << __func__ << " fetching 0x" << std::hex << x_off << "~" << l << std::dec << " of " << *p
                         << dendl;
                int r;
                ...
                if (!cct->_conf->bluefs_check_for_zeros) {
                    r = _bdev_read(p->bdev, p->offset + x_off, l, &buf->bl, ioc[p->bdev], use_buffered_io);
                }
                else {
                    r = _read_and_check(p->bdev, p->offset + x_off, l, &buf->bl, ioc[p->bdev], use_buffered_io);
                }
...
uint64_t BlueFS::_make_initial_transaction(uint64_t start_seq, bluefs_fnode_t& fnode, uint64_t expected_final_size,
                                           bufferlist* out)
{
...
bool BlueFS::_should_start_compact_log_L_N()
{
    ...
    dout(10) << __func__ << " current 0x" << std::hex << current << " expected " << expected << std::dec << " ratio "
             << ratio << dendl;
    if (current < cct->_conf->bluefs_log_compact_min_size || ratio < cct->_conf->bluefs_log_compact_min_ratio) {
        return false;
    }
    return true;
}

void BlueFS::_compact_log_dump_metadata_NF(uint64_t start_seq, bluefs_transaction_t* t, int bdev_update_flags,
                                           uint64_t capture_before_seq)
{
    ...
    for (auto& [ino, file_ref] : nodes.file_map) {
        ...
        if (capture_before_seq == 0 || file_ref->dirty_seq < capture_before_seq) {
            ...
            dout(20) << __func__ << " op_file_update just modified, dirty_seq=" << file_ref->dirty_seq << " "
                     << file_ref->fnode << dendl;
        }
...
void BlueFS::_compact_log_sync_LNF_LD()
{
    ...
    {
        std::lock_guard ll(log.lock);
        prefer_bdev = vselector->select_prefer_bdev(log.writer->file->vselector_hint);
    }
    _rewrite_log_and_layout_sync_LNF_LD(true, BDEV_DB, prefer_bdev, prefer_bdev, 0, super.memorized_layout);
...
void BlueFS::_rewrite_log_and_layout_sync_LNF_LD(bool permit_dev_fallback, int super_dev, int log_dev, int log_dev_new,
                                                 int flags, std::optional<bluefs_layout_t> layout)
{
    ...
    ceph_assert((permit_dev_fallback && log_dev == log_dev_new) || !permit_dev_fallback);

    dout(10) << __func__ << " super_dev:" << super_dev << " log_dev:" << log_dev << " log_dev_new:" << log_dev_new
             << " flags:" << flags << " seq:" << log.seq_live << dendl;
    ...
    uint64_t compacted_meta_need = _estimate_transaction_size(&compacted_meta_t) + cct->_conf->bluefs_max_log_runway;

    dout(20) << __func__ << " compacted_meta_need " << compacted_meta_need << dendl;

    int r = _allocate(log_dev, compacted_meta_need, 0, &fnode_tail, 0, permit_dev_fallback);
    ceph_assert(r == 0);
    ...
    r = _allocate(log_dev, starter_need, 0, &fnode_starter, 0, permit_dev_fallback);
    ceph_assert(r == 0);
    ...
    //
    {
        dout(10) << __func__ << " release old log extents " << old_log_fnode.extents << dendl;
        std::lock_guard dl(dirty.lock);
...
void BlueFS::_compact_log_async_LD_LNF_D()   // also locks FW for new_writer
{
    ...
    dout(10) << __func__ << " old_log_jump_to 0x" << std::hex << old_log_jump_to << " need 0x"
             << cct->_conf->bluefs_max_log_runway << std::dec << dendl;
    int r = _allocate(
        vselector->select_prefer_bdev(log_file->vselector_hint), cct->_conf->bluefs_max_log_runway, 0, &fnode_tail);
    ceph_assert(r == 0);
    ...
    dout(20) << __func__ << " compacted_meta_need " << compacted_meta_need << dendl;
    {
        ...
        // do allocate
        r = _allocate(vselector->select_prefer_bdev(log_file->vselector_hint), compacted_meta_need, 0, &fnode_pre_tail);
        ceph_assert(r == 0);
    ...
    r = _allocate(vselector->select_prefer_bdev(log_file->vselector_hint), starter_need, 0, &new_log->fnode);
    ceph_assert(r == 0);
    ...
    bufferlist starter_bl;
    _make_initial_transaction(starter_seq, new_log->fnode, starter_need, &starter_bl);

    // 2.7 Encode compacted meta transaction,
    dout(20) << __func__ << " new_log jump seq " << seq_now << std::hex << " offset 0x"
             << starter_need + compacted_meta_need << std::dec << dendl;
    ...
    log_file->fnode.size = log.writer->pos - old_log_jump_to + starter_need + compacted_meta_need;
...
void BlueFS::_pad_bl(bufferlist& bl, uint64_t pad_size)
{
    ...
    if (partial) {
        dout(10) << __func__ << " padding with 0x" << std::hex << pad_size - partial << " zeros" << std::dec << dendl;
...
int64_t BlueFS::_maybe_extend_log()
{
    ...
    int64_t runway = log.writer->file->fnode.get_allocated() - log.writer->get_effective_write_pos();
    if (runway < (int64_t)cct->_conf->bluefs_min_log_runway) {
        dout(10) << __func__ << " allocating more log runway (0x" << std::hex << runway << std::dec << " remaining)"
                 << dendl;
        /*
        ...
        int r = _allocate(vselector->select_prefer_bdev(log.writer->file->vselector_hint),
                          cct->_conf->bluefs_max_log_runway,
                          0,
...
void BlueFS::_clear_dirty_set_stable_D(uint64_t seq)
{
    ...
    if (seq > dirty.seq_stable) {
        ...
        dout(20) << __func__ << " seq_stable " << dirty.seq_stable << " already >= out seq " << seq
...
int BlueFS::_flush_and_sync_log_LD(uint64_t want_seq)
{
    ...
    do {
        ...
        if (want_seq && want_seq <= dirty.seq_stable) {
            dout(10) << __func__ << " want_seq " << want_seq << " <= seq_stable " << dirty.seq_stable << ", done"
                     << dendl;
            dirty.lock.unlock();
            log.lock.unlock();
            return 0;
...
int BlueFS::_flush_and_sync_log_jump_D(uint64_t jump_to, int64_t available_runway)
{
    ceph_assert(ceph_mutex_is_locked(log.lock));
    ...
    dout(10) << __func__ << " jumping log offset from 0x" << std::hex << log.writer->pos << " -> 0x" << jump_to
             << std::dec << dendl;
...
ceph::bufferlist BlueFS::FileWriter::flush_buffer(CephContext* const cct, const bool partial, const unsigned length,
                                                  const bluefs_super_t& super)
{
    ...
    if (const unsigned tail = bl.length() & ~super.block_mask(); tail) {
        ...
        dout(20) << __func__ << " caching tail of 0x" << std::hex << tail << " and padding block with 0x" << padding_len
...
int BlueFS::_signal_dirty_to_log_D(FileWriter* h)
{
    ...
    if (h->file->dirty_seq <= dirty.seq_stable) {
        ...
        dout(20) << __func__ << " dirty_seq = " << dirty.seq_live << " (was clean)" << dendl;
    }
    else {
        if (h->file->dirty_seq != dirty.seq_live) {
            ...
            h->file->dirty_seq = dirty.seq_live;
            dirty.files[h->file->dirty_seq].push_back(*h->file);
            dout(20) << __func__ << " dirty_seq = " << dirty.seq_live << " (was " << h->file->dirty_seq << ")" << dendl;
        }
        else {
            dout(20) << __func__ << " dirty_seq = " << dirty.seq_live << " (unchanged, do nothing) " << dendl;
        }
    }
    return 0;
}
...
int BlueFS::_flush_range_F(FileWriter* h, uint64_t offset, uint64_t length)
{
    ...
    dout(10) << __func__ << " " << h << " pos 0x" << std::hex << h->pos << " 0x" << offset << "~" << length << std::dec
    ...
    if (allocated < offset + length) {
        ...
        int r = _allocate(
            vselector->select_prefer_bdev(h->file->vselector_hint), offset + length - allocated, 0, &h->file->fnode);
        if (r < 0) {
            derr << __func__ << " allocated: 0x" << std::hex << allocated << " offset: 0x" << offset << " length: 0x"
...
int BlueFS::_flush_F(FileWriter* h, bool force, bool* flushed)
{
    ...
    dout(10) << __func__ << " " << h << " 0x" << std::hex << offset << "~" << length << std::dec << " to "
             << h->file->fnode << dendl;
...
int BlueFS::fsync(FileWriter* h) /*_WF_WD_WLD_WLNF_WNF*/
{
    ...
    {
        dout(10) << __func__ << " " << h << " " << h->file->fnode << " dirty " << h->file->is_dirty << dendl;
        int r = _flush_F(h, true);
        if (r < 0) return r;
        _flush_bdev(h);
        if (h->file->is_dirty) {
        ...
        }
        {
            ...
            if (dirty.seq_stable < h->file->dirty_seq) {
                ...
                dout(20) << __func__ << " file metadata was dirty (" << old_dirty_seq << ") on " << h->file->fnode
                         << ", flushing log" << dendl;
            }
        }
    }
...
int BlueFS::_allocate(uint8_t id, uint64_t len, uint64_t alloc_unit, bluefs_fnode_t* node, size_t alloc_attempts,
                      bool permit_dev_fallback)
{
    dout(10) << __func__ << " len 0x" << std::hex << len << " au 0x" << alloc_unit << std::dec << " from " << (int)id
             << " cooldown " << cooldown_deadline << dendl;
    ceph_assert(id < alloc.size());
    int64_t alloc_len = 0;
    ...
    if (alloc[id]) {
        ...
        if (shared && alloc_unit != shared_unit) {
            if (duration_cast<seconds>(real_clock::now().time_since_epoch()).count() < cooldown_deadline) {
                ...
                dout(1) << __func__ << " shared allocation cooldown period elapsed" << dendl;
            }
        }
    ...
    if (alloc_len < 0 || alloc_len < need) {
        if (alloc[id]) {
            ...
            if (!was_cooldown && shared) {
                ...
                cooldown_deadline = delay_s + duration_cast<seconds>(real_clock::now().time_since_epoch()).count();
                dout(1) << __func__ << " shared allocation cooldown set for " << delay_s << "s" << dendl;
            }
            dout(1) << __func__ << " unable to allocate 0x" << std::hex << need << " on bdev " << (int)id
                    << ", allocator name " << alloc[id]->get_name() << ", allocator type " << alloc[id]->get_type()
                    << ", capacity 0x" << alloc[id]->get_capacity() << ", block size 0x" << alloc[id]->get_block_size()
                    << ", alloc unit 0x" << alloc_unit << ", free 0x" << alloc[id]->get_free() << ", fragmentation "
                    << alloc[id]->get_fragmentation() << ", allocated 0x" << (alloc_len > 0 ? alloc_len : 0) << std::dec
                    << dendl;
        }
        else {
            dout(20) << __func__ << " alloc-id not set on index=" << (int)id << " unable to allocate 0x" << std::hex
                     << need << " on bdev " << (int)id << std::dec << dendl;
        }
        if (alloc[id] && shared && alloc_unit != shared_unit) {
            alloc_unit = shared_unit;
            dout(20) << __func__ << " fallback to bdev " << (int)id << " with alloc unit 0x" << std::hex << alloc_unit
                     << std::dec << dendl;
            logger->inc(l_bluefs_alloc_shared_size_fallbacks);
            return _allocate(id, len, alloc_unit, node, alloc_attempts, permit_dev_fallback);
        }
...
int BlueFS::preallocate(FileRef f, uint64_t off, uint64_t len) /*_LF*/
{
    ...
    if (off + len > allocated) {
        ...
        vselector->sub_usage(f->vselector_hint, f->fnode);
        int r = _allocate(vselector->select_prefer_bdev(f->vselector_hint), want, 0, &f->fnode);
        vselector->add_usage(f->vselector_hint, f->fnode);
        if (r < 0) return r;
...
{
    if (!cct->_conf->bluefs_replay_recovery_disable_compact && _should_start_compact_log_L_N()) {
        auto t0 = mono_clock::now();
        if (cct->_conf->bluefs_compact_log_sync) {
            _compact_log_sync_LNF_LD();
        }
...
int BlueFS::open_for_write(std::string_view dirname, std::string_view filename, FileWriter** h, bool overwrite) /*_LND*/
{
    _maybe_check_vselector_LNF();
    FileRef file;
    bool create = false;
    ...
    mempool::bluefs::vector<bluefs_extent_t> pending_release_extents;
    {
        ...
        if (q == dir->file_map.end()) {
            if (overwrite) {
                dout(20) << __func__ << " dir " << dirname << " (" << dir << ") file " << filename << " does not exist"
                         << dendl;
                return -ENOENT;
            }
        ...
        dout(20) << __func__ << " mapping " << dirname << "/" << filename << " vsel_hint " << file->vselector_hint
                 << dendl;

        log.t.op_file_update(file->fnode);
        if (create) log.t.op_dir_link(dirname, filename, file->fnode.ino);
...
int BlueFS::open_for_read(std::string_view dirname, std::string_view filename, FileReader** h, bool random) /*_N*/
{
    _maybe_check_vselector_LNF();
    std::lock_guard nl(nodes.lock);
...
int BlueFS::rename(std::string_view old_dirname, std::string_view old_filename, std::string_view new_dirname,
                   std::string_view new_filename) /*_LND*/
{
    std::lock_guard ll(log.lock);
    std::lock_guard nl(nodes.lock);
    dout(10) << __func__ << " " << old_dirname << "/" << old_filename << " -> " << new_dirname << "/" << new_filename
             << dendl;
    ...
    if (q == old_dir->file_map.end()) {
        dout(20) << __func__ << " dir " << old_dirname << " (" << old_dir << ") file " << old_filename << " not found"
                 << dendl;
        return -ENOENT;
    }
    ...
    if (q != new_dir->file_map.end()) {
        dout(20) << __func__ << " dir " << new_dirname << " (" << old_dir << ") file " << new_filename
...
int BlueFS::stat(std::string_view dirname, std::string_view filename, uint64_t* size, utime_t* mtime) /*_N*/
{
    std::lock_guard nl(nodes.lock);
    dout(10) << __func__ << " " << dirname << "/" << filename << dendl;
    map<string, DirRef>::iterator p = nodes.dir_map.find(dirname);
...
int BlueFS::lock_file(std::string_view dirname, std::string_view filename, FileLock** plock) /*_LN*/
{
    std::lock_guard ll(log.lock);
    std::lock_guard nl(nodes.lock);
    dout(10) << __func__ << " " << dirname << "/" << filename << dendl;
    ...
    FileRef file;
    if (q == dir->file_map.end()) {
        dout(20) << __func__ << " dir " << dirname << " (" << dir << ") file " << filename << " not found, creating"
                 << dendl;
        file = ceph::make_ref<File>();
        file->fnode.ino = ++ino_last;
        file->fnode.mtime = ceph_clock_now();
 ...
 */
int BlueFS::_do_replay_recovery_read(FileReader* log_reader, size_t replay_pos, size_t read_offset, size_t read_len,
                                     bufferlist* bl)
{
    dout(1) << __func__ << " replay_pos=0x" << std::hex << replay_pos << " needs 0x" << read_offset << "~" << read_len
            << std::dec << dendl;
    ...
    int r =
        _bdev_read(e->bdev, e->offset + e_off, e->length - e_off, &fixed, ioc[e->bdev], cct->_conf->bluefs_buffered_io);
    ceph_assert(r == 0);
    ...
    while (e != log_fnode.extents.end()) {
        r = _bdev_read(e->bdev, e->offset, e->length, &fixed, ioc[e->bdev], cct->_conf->bluefs_buffered_io);
        ceph_assert(r == 0);
        last_e_dev = e->bdev;
        ++e;
    }
    ...
    for (int dcnt = 0; dcnt < 3; dcnt++) {
        ...
        for (size_t i = 0; i < disk_regions_count; reg++, i++) {
            ...
            while (len > last_32.length()) {
                ...
                dout(5) << __func__ << " read " << get_device_name(dev) << ":0x" << std::hex << pos << "+" << chunk_len
                        << std::dec << dendl;
                r = _bdev_read_random(dev, pos, chunk_len, raw_data + page_size, cct->_conf->bluefs_buffered_io);
                ceph_assert(r == 0);
                ...
                for (char* sp = search_b;; sp += last_32.length()) {
                    ...
                    dout(5) << __func__ << " checking location 0x" << std::hex << pos + (n - chunk_b) << std::dec
                            << dendl;
                    bufferlist test;
                    ...
                    if (ne.bdev >= MAX_BDEV || bdev[ne.bdev] == nullptr || ne.length > 16 * 1024 * 1024 ||
                        (ne.length & 4095) != 0 || ne.offset + ne.length > bdev[ne.bdev]->get_size() ||
                        (ne.offset & 4095) != 0) {
                    ...
                    r = _bdev_read(
                        ne.bdev, ne.offset, ne.length, &candidate, ioc[ne.bdev], cct->_conf->bluefs_buffered_io);
                    ceph_assert(r == 0);
...
{
    sout << "wal_total:" << wal_total << ", db_total:" << db_total << ", slow_total:" << slow_total << std::endl;
}
