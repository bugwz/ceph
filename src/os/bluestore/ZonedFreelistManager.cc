...
void ZonedFreelistManager::write_zone_state_to_db(uint64_t zone_num, const zone_state_t& zone_state,
...
int ZonedFreelistManager::create(uint64_t new_size, uint64_t granularity, KeyValueDB::Transaction txn)
{
