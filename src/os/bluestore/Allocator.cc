...
public:
    explicit SocketHook(Allocator* alloc, const std::string& _name)
        : alloc(alloc)
        , name(_name)
    {
...
Allocator::Allocator(const std::string& name, int64_t _capacity, int64_t _block_size)
...
Allocator* Allocator::create(CephContext* cct, string type, int64_t size, int64_t block_size, const std::string& name)
{
