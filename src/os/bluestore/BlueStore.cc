...
MEMPOOL_DEFINE_OBJECT_FACTORY(BlueStore::Buffer, bluestore_buffer, bluestore_Buffer);
...
MEMPOOL_DEFINE_OBJECT_FACTORY(BlueStore::SharedBlob, bluestore_shared_blob, bluestore_SharedBlob);
...
void BlueStore::Blob::decode(Collection* coll, bufferptr::const_iterator& p, uint64_t struct_v, uint64_t* sbid,
...
BlueStore::ExtentMap::ExtentMap(Onode* o)
    : onode(o)
    , inline_bl(o->c->store->cct->_conf->bluestore_extent_map_inline_shard_prealloc_size)
{}
...
void BlueStore::_init_logger()
{
    ...
    b.add_time_avg(l_bluestore_kv_commit_lat, "kv_commit_lat", "Average kv_thread commit latency");
    ...
    b.add_time_avg(
        l_bluestore_state_deferred_queued_lat, "state_deferred_queued_lat", "Average deferred_queued state latency");
    b.add_time_avg(
        l_bluestore_state_deferred_aio_wait_lat, "state_deferred_aio_wait_lat", "Average aio_wait state latency");
    b.add_time_avg(
        l_bluestore_state_deferred_cleanup_lat, "state_deferred_cleanup_lat", "Average cleanup state latency");
    ...
    b.add_time_avg(
        l_bluestore_submit_lat, "submit_lat", "Average submit latency", "s_l", PerfCountersBuilder::PRIO_CRITICAL);
    b.add_time_avg(
        l_bluestore_commit_lat, "commit_lat", "Average commit latency", "c_l", PerfCountersBuilder::PRIO_CRITICAL);
    b.add_time_avg(l_bluestore_read_lat, "read_lat", "Average read latency", "r_l", PerfCountersBuilder::PRIO_CRITICAL);
    b.add_time_avg(l_bluestore_read_onode_meta_lat, "read_onode_meta_lat", "Average read onode metadata latency");
    b.add_time_avg(l_bluestore_read_wait_aio_lat, "read_wait_aio_lat", "Average read latency");
    ...
    b.add_u64_counter(
        l_bluestore_write_pad_bytes, "write_pad_bytes", "Sum for write-op padded bytes", NULL, 0, unit_t(UNIT_BYTES));
    b.add_u64_counter(l_bluestore_deferred_write_ops, "deferred_write_ops", "Sum for deferred write op");
    b.add_u64_counter(l_bluestore_deferred_write_bytes,
    ...
    b.add_u64(l_bluestore_compressed_original,
              ...
              PerfCountersBuilder::PRIO_USEFUL,
              unit_t(UNIT_BYTES));
    b.add_u64(l_bluestore_onodes, "bluestore_onodes", "Number of onodes in cache");
    b.add_u64(l_bluestore_pinned_onodes, "bluestore_pinned_onodes", "Number of pinned onodes in cache");
    ...
    b.add_u64_counter(l_bluestore_onode_misses,
                      ...
                      "o_ms",
                      PerfCountersBuilder::PRIO_USEFUL);
    b.add_u64_counter(l_bluestore_onode_shard_hits, "onode_shard_hits", "Sum for onode-shard lookups hit in the cache");
    ...
    b.add_u64(l_bluestore_extents, "bluestore_extents", "Number of extents in cache");
    b.add_u64(l_bluestore_blobs, "bluestore_blobs", "Number of blobs in cache");
    b.add_u64(l_bluestore_buffers, "bluestore_buffers", "Number of buffers in cache");
    ...
    b.add_u64_counter(l_bluestore_write_big, "bluestore_write_big", "Large aligned writes into fresh blobs");
    b.add_u64_counter(l_bluestore_write_big_bytes,
                      ...
                      unit_t(UNIT_BYTES));
    b.add_u64_counter(
        l_bluestore_write_big_blobs, "bluestore_write_big_blobs", "Large aligned writes into fresh blobs (blobs)");
    b.add_u64_counter(l_bluestore_write_big_deferred, "bluestore_write_big_deferred", "Big overwrites using deferred");
    b.add_u64_counter(
        l_bluestore_write_small, "bluestore_write_small", "Small writes into existing or sparse small blobs");
    ...
    b.add_u64_counter(l_bluestore_write_deferred, "bluestore_write_deferred", "Total deferred writes submitted");
    b.add_u64_counter(
        l_bluestore_write_deferred_bytes, "bluestore_write_deferred_bytes", "Total bytes submitted as deferred writes");
    ...
    b.add_u64_counter(l_bluestore_write_new, "bluestore_write_new", "Write into new blob");

    b.add_u64_counter(l_bluestore_txc, "bluestore_txc", "Transactions committed");
    b.add_u64_counter(l_bluestore_onode_reshard, "bluestore_onode_reshard", "Onode extent map reshard events");
    b.add_u64_counter(l_bluestore_blob_split, "bluestore_blob_split", "Sum for blob splitting due to resharding");
    b.add_u64_counter(l_bluestore_extent_compress,
    ...
    b.add_u64_counter(l_bluestore_gc_merged,
                      ...
                      "collection");
    b.add_u64_counter(l_bluestore_read_eio, "bluestore_read_eio", "Read EIO errors propagated to high level callers");
    ...
    b.add_time_avg(
        l_bluestore_omap_upper_bound_lat, "omap_upper_bound_lat", "Average omap iterator upper_bound call latency");
    b.add_time_avg(
        l_bluestore_omap_lower_bound_lat, "omap_lower_bound_lat", "Average omap iterator lower_bound call latency");
    b.add_time_avg(l_bluestore_omap_next_lat, "omap_next_lat", "Average omap iterator next call latency");
    b.add_time_avg(l_bluestore_omap_get_keys_lat, "omap_get_keys_lat", "Average omap get_keys call latency");
    b.add_time_avg(l_bluestore_omap_get_values_lat, "omap_get_values_lat", "Average omap get_values call latency");
    b.add_time_avg(l_bluestore_clist_lat, "clist_lat", "Average collection listing latency");
    b.add_time_avg(l_bluestore_remove_lat, "remove_lat", "Average removal latency");
...
int BlueStore::_write_bdev_label(CephContext* cct, string path, bluestore_bdev_label_t label)
{
...
int BlueStore::_read_bdev_label(CephContext* cct, string path, bluestore_bdev_label_t* label)
{
    dout(10) << __func__ << dendl;
...
int BlueStore::_create_alloc()
{
    ...
    shared_alloc.set(Allocator::create(cct, cct->_conf->bluestore_allocator, bdev->get_size(), alloc_size, "block"),
                     alloc_size);

    if (!shared_alloc.a) {
        lderr(cct) << __func__ << "Failed to create allocator:: " << cct->_conf->bluestore_allocator << dendl;
        return -EINVAL;
    }
...
int BlueStore::_init_alloc()
{
    ...
    dout(1) << __func__ << " loaded " << byte_u_t(bytes) << " in " << num << " extents" << std::hex
            << ", allocator type " << shared_alloc.a->get_type() << ", capacity 0x" << shared_alloc.a->get_capacity()
            << ", block size 0x" << shared_alloc.a->get_block_size() << ", free 0x" << shared_alloc.a->get_free()
            << ", fragmentation " << shared_alloc.a->get_fragmentation() << std::dec << dendl;
...
int BlueStore::_open_bluefs(bool create, bool read_only)
{
    ...
    if (bluefs_layout.shared_bdev == BlueFS::BDEV_SLOW ||
        ...
        if (cct->_conf->bluestore_volume_selection_policy == "fit_to_fast") {
            ...
            vselector =
                new RocksDBBlueFSVolumeSelector(bluefs->get_block_device_size(BlueFS::BDEV_WAL) * 95 / 100,
                                                bluefs->get_block_device_size(BlueFS::BDEV_DB) * 95 / 100,
                                                bluefs->get_block_device_size(BlueFS::BDEV_SLOW) * 95 / 100,
...
void BlueStore::_fsck_check_pool_statfs(BlueStore::per_pool_statfs& expected_pool_statfs, int64_t& errors,
    ...
    if (it) {
        for (it->lower_bound(string()); it->valid(); it->next()) {
            ...
            try {
                ...
                if (repairer) {
                    dout(20) << __func__ << " undecodable Pool StatFS record, key:'" << pretty_binary_string(key)
                             << "', removing" << dendl;
                    repairer->remove_key(db, PREFIX_STAT, key);
                }
                ++errors;
            ...
            if (stat_it == expected_pool_statfs.end()) {
                if (vstatfs.is_empty()) {
                    ...
                    dout(20) << "fsck inf: found empty stray Pool StatFS record for pool id 0x" << std::hex << pool_id
                             << std::dec << dendl;
                    if (repairer) {
                    ...
                    derr << "fsck error: found stray Pool StatFS record for pool id 0x" << std::hex << pool_id
                         << std::dec << dendl;
                    ++errors;
                }
                if (repairer) {
            ...
            if (!(stat_it->second == statfs)) {
                derr << "fsck error: actual " << statfs << " != expected " << stat_it->second << " for pool "
...
int BlueStore::_fsck_on_open(BlueStore::FSCKDepth depth, bool repair)
{
    ...
    if (sb_ref_mismatches != 0) {
        derr << "fsck error: shared blob references aren't matching, at least " << sb_ref_mismatches << " found"
             << dendl;
            ...
            for (it->lower_bound(string()); it->valid() && !bypass_rest; it->next()) {
                ...
                for (auto b : blobs) {
                    ...
                    for (auto e = pextents.begin(); e != pextents.end(); e++) {
                        ...
                        PExtentVector exts;
                        int64_t alloc_len = shared_alloc.a->allocate(e->length, min_alloc_size, 0, 0, &exts);
                        if (alloc_len < 0 || alloc_len < (int64_t)e->length) {
                            derr << __func__ << " failed to allocate 0x" << std::hex << e->length << " allocated 0x "
                                 ...
                                 << " available 0x " << shared_alloc.a->get_free() << std::dec << dendl;
                            if (alloc_len > 0) {
    ...
    if (!per_pool_stat_collection && !repair && !(actual_statfs == expected_store_statfs)) {
        derr << "fsck error: actual " << actual_statfs << " != expected " << expected_store_statfs << dendl;
        if (repair) {
            repairer.fix_statfs(db, BLUESTORE_GLOBAL_STATFS_KEY, expected_store_statfs);
        }
        ++errors;
    }

    dout(1) << __func__ << " checking pool_statfs" << dendl;
    _fsck_check_pool_statfs(expected_pool_statfs, errors, warnings, repair ? &repairer : nullptr);
    ...
    if (depth != FSCK_SHALLOW) {
            ...
            for (it->lower_bound(string()); it->valid(); it->next()) {
                ...
                if (used_omap_head.count(omap_head) == 0 && omap_head != last_omap_head) {
                    fsck_derr(errors, MAX_FSCK_ERROR_LINES)
                        ...
                        << last_omap_head << " " << used_omap_head.count(omap_head) << fsck_dendl;
                    last_omap_head = omap_head;
                    ++errors;
                }
            }
        ...
        if (it) {
            ...
            for (it->lower_bound(string()); it->valid(); it->next()) {
                ...
                if (used_omap_head.count(omap_head) == 0 && omap_head != last_omap_head) {
                    fsck_derr(errors, MAX_FSCK_ERROR_LINES)
                        << "fsck error: found stray (per-pg) omap data on omap_head " << omap_head << " "
                        << last_omap_head << " " << used_omap_head.count(omap_head) << fsck_dendl;
                    ++errors;
                    last_omap_head = omap_head;
                }
                        ...
                        if (bs.test(pos) && !bluefs_used_blocks.test(pos)) {
                            if (offset == SUPER_RESERVED && length == min_alloc_size - SUPER_RESERVED) {
                                ...
                                dout(10) << __func__ << " ignoring free extent between SUPER_RESERVED"
                                         << " and min_alloc_size, 0x" << std::hex << offset << "~" << length << std::dec
                                         << dendl;
                            }
                            else {
                                intersects = true;
                ...
                while (start != decltype(used_blocks)::npos) {
                    ...
                    while (true) {
                        ...
                        if (next != cur + 1) {
                            ...
                            if (repair) {
                                repairer.fix_leaked(db, fm, start * min_alloc_size, (cur + 1 - start) * min_alloc_size);
                            }
                            start = next;
                            break;
                        }
...
void BlueStore::inject_leaked(uint64_t len)
{
    ...
    PExtentVector exts;
    int64_t alloc_len = shared_alloc.a->allocate(len, min_alloc_size, min_alloc_size * 256, 0, &exts);
...
int BlueStore::_prepare_read_ioc(blobs2read_t& blobs2read, vector<bufferlist>* compressed_blob_bls, IOContext* ioc)
{
    for (auto& p : blobs2read) {
        ...
        dout(20) << __func__ << "  blob " << *bptr << std::hex << " need " << r2r << std::dec << dendl;
                                        ...
                                        bool buffered, bool* csum_error, bufferlist& bl)
{
    ...
    while (b2r_it != blobs2read.end()) {
        ...
        dout(20) << __func__ << "  blob " << *bptr << std::hex << " need 0x" << r2r << std::dec << dendl;
        if (bptr->get_blob().is_compressed()) {
                        ...
                        uint64_t retry_count)
{
    ...
    r = _generate_read_result_bl(
        o, offset, length, ready_regions, compressed_blob_bls, blobs2read, buffered, &csum_error, bl);
    if (csum_error) {
...
int BlueStore::getattrs(CollectionHandle& c_, const ghobject_t& oid, map<string, bufferptr>& aset)
{
    Collection* c = static_cast<Collection*>(c_.get());
    dout(15) << __func__ << " " << c->cid << " " << oid << dendl;
    if (!c->exists) return -ENOENT;
...
int BlueStore::_zoned_check_config_settings()
{
    if (cct->_conf->bluestore_allocator != "zoned") {
        dout(1) << __func__ << " The drive is HM-SMR but " << cct->_conf->bluestore_allocator
    ...
    if (min_alloc_size < 64 * 1024) {
        dout(1) << __func__ << " The drive is HM-SMR but min_alloc_size is " << min_alloc_size << ". "
    ...
    if (prefer_deferred_size) {
        dout(1) << __func__ << " The drive is HM-SMR but prefer_deferred_size is " << prefer_deferred_size << ". "
...
void BlueStore::_kv_finalize_thread()
{
    ...
    while (true) {
        ...
        if (kv_committing_to_finalize.empty() && deferred_stable_to_finalize.empty()) {
            ...
            logger->set(l_bluestore_fragmentation, (uint64_t)(shared_alloc.a->get_fragmentation() * 1000));
        ...
        if (prev_ep != end && prev_ep->logical_offset >= min_off) {
            ...
            if (b->can_reuse_blob(min_alloc_size, max_bsize, offset0 - bstart, &alloc_len)) {
                ...
                if (!wctx->has_conflict(b, offset0, offset0 + alloc_len, min_alloc_size)) {
                    ...
                    dout(20) << __func__ << " reuse blob " << *b << std::hex << " (0x" << b_off0 << "~" << bl.length()
                             << ")"
                             << " (0x" << b_off << "~" << length << ")" << std::dec << dendl;
...
int BlueStore::_do_alloc_write(TransContext* txc, CollectionRef coll, OnodeRef& o, WriteContext* wctx)
{
    ...
    if (prealloc_left < 0 || prealloc_left < (int64_t)need) {
        derr << __func__ << " failed to allocate 0x" << std::hex << need << " allocated 0x "
             ...
             << shared_alloc.a->get_free() << std::dec << dendl;
        if (prealloc.size()) {
...
void BlueStore::DBHistogram::update_hist_entry(map<string, map<int, struct key_dist>>& key_hist, const string& prefix,
                                               size_t key_size, size_t value_size)
{
    uint32_t key_slab = get_key_slab(key_size);
    uint32_t value_slab = get_value_slab(value_size);
    key_hist[prefix][key_slab].count++;
    key_hist[prefix][key_slab].max_len = std::max<size_t>(key_size, key_hist[prefix][key_slab].max_len);
    key_hist[prefix][key_slab].val_map[value_slab].count++;
    key_hist[prefix][key_slab].val_map[value_slab].max_len =
        std::max<size_t>(value_size, key_hist[prefix][key_slab].val_map[value_slab].max_len);
}
...
void BlueStore::_collect_allocation_stats(uint64_t need, uint32_t alloc_size, size_t extents)
{
    alloc_stats_count++;
