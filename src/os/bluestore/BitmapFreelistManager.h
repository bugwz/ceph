...
class BitmapFreelistManager : public FreelistManager
{
    ...
    uint64_t _get_offset(uint64_t key_off, int bit) { return key_off + bit * bytes_per_block; }
...
public:
    BitmapFreelistManager(CephContext* cct, std::string meta_prefix, std::string bitmap_prefix);
