...
protected:
    ...
    {}
    MDiscover(inodeno_t base_ino_, frag_t base_frag_, snapid_t s, filepath& want_path_, bool want_base_dir_ = true,
...
public:
    ...
    {
        out << "discover(" << header.tid << " " << base_ino << "." << base_dir_frag << " " << want << ")";
    }
