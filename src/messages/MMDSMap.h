...
public:
    ...
    void print(std::ostream& out) const override { out << "mdsmap(e " << epoch << ")"; }
    ...
    void encode_payload(uint64_t features) override
    {
        ...
        if ((features & CEPH_FEATURE_PGID64) == 0 || (features & CEPH_FEATURE_MDSENC) == 0 ||
            (features & CEPH_FEATURE_MSG_ADDR2) == 0 || !HAVE_FEATURE(features, SERVER_NAUTILUS)) {
