...
protected:
    MMDSPing()
        : MMDSOp(MSG_MDS_PING, HEAD_VERSION, COMPAT_VERSION)
    {}
...
public:
    std::string_view get_type_name() const override { return "mdsping"; }

    void print(std::ostream& out) const override { out << "mdsping"; }
