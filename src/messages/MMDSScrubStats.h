...
public:
    ...
    void print(std::ostream& o) const override
    {
        ...
        if (update_scrubbing) o << " [" << scrubbing_tags << "]";
        if (aborting) o << " aborting";
        o << ")";
    }
    ...
    bool is_finished(const std::string& tag) const { return update_scrubbing && !scrubbing_tags.count(tag); }
