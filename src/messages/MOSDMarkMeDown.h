...
public:
    ...
    {}
    MOSDMarkMeDown(const uuid_d& fs, int osd, const entity_addrvec_t& av, epoch_t e, bool request_ack)
...
public:
    ...
    void decode_payload() override
    {
        ...
        if (header.version >= 4) decode(down_and_dead, p);
    }
    ...
    {
        out << "MOSDMarkMeDown("
            << "request_ack=" << request_ack << ", down_and_dead=" << down_and_dead << ", osd." << target_osd << ", "
