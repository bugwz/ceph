...
private:
    ...
    ceph::mutex policy_lock = ceph::make_mutex("SimplePolicyMessenger::policy_lock");
...
public:
     ...
     */
    void set_policy_throttlers(int type, Throttle* byte_throttle, Throttle* msg_throttle) override
    {
        std::lock_guard l{policy_lock};
