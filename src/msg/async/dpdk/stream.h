...
public:
    ...
    // stream.
    subscription<T...> listen() { return subscription<T...>(this); }
    ...
    // a previous produce() is ready.  No functions may be called
    // after this.
    void set_exception(int error) { done = error; }
