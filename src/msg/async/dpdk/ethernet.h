...
struct ethernet_address
{
    ...
    ethernet_address(const uint8_t* eaddr) { std::copy(eaddr, eaddr + 6, mac.begin()); }
    ...
    ethernet_address ntoh() { return *this; }
    ethernet_address hton() { return *this; }
...
struct ethernet
{
    ...
    static address broadcast_address() { return {0xff, 0xff, 0xff, 0xff, 0xff, 0xff}; }
