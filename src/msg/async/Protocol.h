...
private:
    ...
    template<std::size_t... Is> inline Ct<C>* _call(C* foo, std::index_sequence<Is...>) const
    {
...
public:
    ...
    inline Ct<C>* call(C* foo) const override { return _call(foo, std::index_sequence_for<Args...>()); }
};
...
public:
    ...
    inline Ct<C>* call(C* foo) const override { return (foo->*_f)(std::move(node), r); }
};
...
public:
    ...
    int get_con_mode() const { return auth_meta->con_mode; }
};
