...
// TODO
template<typename T> class always_aligned_t
{
    T val;
...
struct TxHandler
{
    ...
    virtual void authenticated_encrypt_update(const ceph::bufferlist& plaintext) = 0;
...
struct rxtx_t
{
    ...
    static rxtx_t create_handler_pair(CephContext* ctx, const class AuthConnectionMeta& auth_meta,
