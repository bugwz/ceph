...
static inline void* maybe_inline_memcpy(void* dest, const void* src, size_t l, size_t inline_len)
...
void* maybe_inline_memcpy(void* dest, const void* src, size_t l, size_t inline_len)
{
    ...
    switch (l) {
    case 8: return __builtin_memcpy(dest, src, 8);
    case 4: return __builtin_memcpy(dest, src, 4);
    case 3: return __builtin_memcpy(dest, src, 3);
    case 2: return __builtin_memcpy(dest, src, 2);
    case 1: return __builtin_memcpy(dest, src, 1);
    default:
        int cursor = 0;
...
static inline bool mem_is_zero(const char* data, size_t len) __attribute__((always_inline));
