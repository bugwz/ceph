...
struct object_id_t
{
    ...
    snap_t snap = 0;
    object_id_t() = default;
    object_id_t(const std::string& name, const std::string& nspace, const std::string& locator, snap_t snap)
        : name(name)
        , nspace(nspace)
        , locator(locator)
        , snap(snap)
...
struct err_t
{
    ...
    uint64_t errors = 0;
    static constexpr uint64_t SHALLOW_ERRORS = SHARD_MISSING | SHARD_STAT_ERR | SIZE_MISMATCH_INFO | INFO_MISSING |
                                               INFO_CORRUPTED | SNAPSET_MISSING | SNAPSET_CORRUPTED |
                                               OBJ_SIZE_INFO_MISMATCH | HINFO_MISSING | HINFO_CORRUPTED;
    static constexpr uint64_t DEEP_ERRORS = SHARD_READ_ERR | DATA_DIGEST_MISMATCH_INFO | OMAP_DIGEST_MISMATCH_INFO |
                                            SHARD_EC_HASH_MISMATCH | SHARD_EC_SIZE_MISMATCH;
    bool has_shard_missing() const { return errors & SHARD_MISSING; }
    bool has_stat_error() const { return errors & SHARD_STAT_ERR; }
    bool has_read_error() const { return errors & SHARD_READ_ERR; }
    bool has_data_digest_mismatch_oi() const
    {   // Compatibility
        return errors & DATA_DIGEST_MISMATCH_OI;
    }
    bool has_data_digest_mismatch_info() const { return errors & DATA_DIGEST_MISMATCH_INFO; }
    bool has_omap_digest_mismatch_oi() const
    {   // Compatibility
        return errors & OMAP_DIGEST_MISMATCH_OI;
    }
    bool has_omap_digest_mismatch_info() const { return errors & OMAP_DIGEST_MISMATCH_INFO; }
    bool has_size_mismatch_oi() const
    {   // Compatibility
        return errors & SIZE_MISMATCH_OI;
    }
    bool has_size_mismatch_info() const { return errors & SIZE_MISMATCH_INFO; }
    bool has_ec_hash_error() const { return errors & SHARD_EC_HASH_MISMATCH; }
    bool has_ec_size_error() const { return errors & SHARD_EC_SIZE_MISMATCH; }
    bool has_oi_attr_missing() const
    {   // Compatibility
        return errors & OI_ATTR_MISSING;
    }
    bool has_info_missing() const { return errors & INFO_MISSING; }
    bool has_oi_attr_corrupted() const
    {   // Compatibility
        return errors & OI_ATTR_CORRUPTED;
    }
    bool has_info_corrupted() const { return errors & INFO_CORRUPTED; }
    bool has_ss_attr_missing() const
    {   // Compatibility
        return errors & SS_ATTR_MISSING;
    }
    bool has_snapset_missing() const { return errors & SNAPSET_MISSING; }
    bool has_ss_attr_corrupted() const
    {   // Compatibility
        return errors & SS_ATTR_CORRUPTED;
    }
    bool has_snapset_corrupted() const { return errors & SNAPSET_CORRUPTED; }
    bool has_shallow_errors() const { return errors & SHALLOW_ERRORS; }
    bool has_deep_errors() const { return errors & DEEP_ERRORS; }
    bool has_obj_size_oi_mismatch() const
    {   // Compatibility
        return errors & OBJ_SIZE_OI_MISMATCH;
    }
    bool has_obj_size_info_mismatch() const { return errors & OBJ_SIZE_INFO_MISMATCH; }
    bool has_hinfo_missing() const { return errors & HINFO_MISSING; }
    bool has_hinfo_corrupted() const { return errors & HINFO_CORRUPTED; }
};
...
struct obj_err_t
{
    ...
    static constexpr uint64_t SHALLOW_ERRORS = OBJECT_INFO_INCONSISTENCY | SIZE_MISMATCH | ATTR_VALUE_MISMATCH |
                                               ATTR_NAME_MISMATCH | SNAPSET_INCONSISTENCY | HINFO_INCONSISTENCY |
                                               SIZE_TOO_LARGE;
    static constexpr uint64_t DEEP_ERRORS = DATA_DIGEST_MISMATCH | OMAP_DIGEST_MISMATCH;
    bool has_object_info_inconsistency() const { return errors & OBJECT_INFO_INCONSISTENCY; }
    bool has_data_digest_mismatch() const { return errors & DATA_DIGEST_MISMATCH; }
    ...
    bool has_attr_value_mismatch() const { return errors & ATTR_VALUE_MISMATCH; }
    bool has_attr_name_mismatch() const { return errors & ATTR_NAME_MISMATCH; }
    bool has_shallow_errors() const { return errors & SHALLOW_ERRORS; }
    bool has_deep_errors() const { return errors & DEEP_ERRORS; }
    bool has_snapset_inconsistency() const { return errors & SNAPSET_INCONSISTENCY; }
    bool has_hinfo_inconsistency() const { return errors & HINFO_INCONSISTENCY; }
    bool has_size_too_large() const { return errors & SIZE_TOO_LARGE; }
};
...
struct inconsistent_snapset_t
{
    ...
    bool snapset_missing() const { return errors & SNAPSET_MISSING; }
    bool ss_attr_corrupted() const
    {   // Compatibility
        return errors & SNAPSET_CORRUPTED;
    }
    bool snapset_corrupted() const { return errors & SNAPSET_CORRUPTED; }
    bool clone_missing() const { return errors & CLONE_MISSING; }
    bool snapset_mismatch() const
    {   // Compatibility
        return errors & SNAP_ERROR;
    }
    bool snapset_error() const { return errors & SNAP_ERROR; }
    bool head_mismatch() const
    {   // Compatibility
        return false;
    }
    bool headless() const { return errors & HEADLESS_CLONE; }
    bool size_mismatch() const { return errors & SIZE_MISMATCH; }
    bool oi_attr_missing() const
    {   // Compatibility
        return errors & OI_MISSING;
    }
    bool info_missing() const { return errors & INFO_MISSING; }
    bool oi_attr_corrupted() const
    {   // Compatibility
        return errors & OI_CORRUPTED;
    }
    bool info_corrupted() const { return errors & INFO_CORRUPTED; }
    bool extra_clones() const { return errors & EXTRA_CLONES; }
};
