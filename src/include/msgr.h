...
#define DEFINE_MSGR2_FEATURE(bit, incarnation, name)                 \
    ...
    const static uint64_t CEPH_MSGR2_FEATUREMASK_##name = (1ULL << bit | CEPH_MSGR2_INCARNATION_##incarnation);

#define HAVE_MSGR2_FEATURE(x, name) (((x) & (CEPH_MSGR2_FEATUREMASK_##name)) == (CEPH_MSGR2_FEATUREMASK_##name))
 ...
 */
#define CEPH_MSGR2_SUPPORTED_FEATURES (CEPH_MSGR2_FEATURE_REVISION_1 | CEPH_MSGR2_FEATURE_COMPRESSION | 0ULL)
