...
#define CEPH_MDSMAP_ALLOW_MULTIMDS_SNAPS                                                 \
    (1 << 4)                                      /* cluster alllowed to enable MULTIMDS \
                                                     and SNAPS at the same time */
#define CEPH_MDSMAP_ALLOW_STANDBY_REPLAY (1 << 5) /* cluster alllowed to enable MULTIMDS */
#define CEPH_MDSMAP_REFUSE_CLIENT_SESSION                \
    (1 << 6) /* cluster allowed to refuse client session \
                request */
#define CEPH_MDSMAP_DEFAULTS (CEPH_MDSMAP_ALLOW_SNAPS | CEPH_MDSMAP_ALLOW_MULTIMDS_SNAPS)
...
#define IS_CEPH_MDS_OP_NEWINODE(op) \
    (op == CEPH_MDS_OP_CREATE || op == CEPH_MDS_OP_MKNOD || op == CEPH_MDS_OP_MKDIR || op == CEPH_MDS_OP_SYMLINK)
...
static inline void copy_from_legacy_head(struct ceph_mds_request_head* head,
...
static inline void copy_to_legacy_head(struct ceph_mds_request_head_legacy* legacy, struct ceph_mds_request_head* head)
{
    struct ceph_mds_request_head_legacy* embedded_legacy =
        (struct ceph_mds_request_head_legacy*)&head->oldest_client_tid;
...
#define CEPH_STAT_CAP_INODE_ALL \
    (CEPH_CAP_PIN | CEPH_CAP_AUTH_SHARED | CEPH_CAP_LINK_SHARED | CEPH_CAP_FILE_SHARED | CEPH_CAP_XATTR_SHARED)
#define CEPH_STAT_CAP_INLINE_DATA (CEPH_CAP_FILE_SHARED | CEPH_CAP_FILE_RD)
#define CEPH_STAT_RSTAT           CEPH_CAP_FILE_WREXTEND

#define CEPH_CAP_ANY_SHARED (CEPH_CAP_AUTH_SHARED | CEPH_CAP_LINK_SHARED | CEPH_CAP_XATTR_SHARED | CEPH_CAP_FILE_SHARED)
#define CEPH_CAP_ANY_RD     (CEPH_CAP_ANY_SHARED | CEPH_CAP_FILE_RD | CEPH_CAP_FILE_CACHE)

#define CEPH_CAP_ANY_EXCL    (CEPH_CAP_AUTH_EXCL | CEPH_CAP_LINK_EXCL | CEPH_CAP_XATTR_EXCL | CEPH_CAP_FILE_EXCL)
#define CEPH_CAP_ANY_FILE_RD (CEPH_CAP_FILE_RD | CEPH_CAP_FILE_CACHE | CEPH_CAP_FILE_SHARED)
#define CEPH_CAP_ANY_FILE_WR (CEPH_CAP_FILE_WR | CEPH_CAP_FILE_BUFFER | CEPH_CAP_FILE_EXCL)
#define CEPH_CAP_ANY_WR      (CEPH_CAP_ANY_EXCL | CEPH_CAP_ANY_FILE_WR)
#define CEPH_CAP_ANY         (CEPH_CAP_ANY_RD | CEPH_CAP_ANY_EXCL | CEPH_CAP_ANY_FILE_WR | CEPH_CAP_FILE_LAZYIO | CEPH_CAP_PIN)
...
#define CEPH_CAP_ANY_DIR_OPS (CEPH_CAP_FILE_CACHE | CEPH_CAP_FILE_RD | CEPH_CAP_FILE_WREXTEND | CEPH_CAP_FILE_LAZYIO)
