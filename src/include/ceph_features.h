...
#define DEFINE_CEPH_FEATURE(bit, incarnation, name)            \
    ...
    const static uint64_t CEPH_FEATUREMASK_##name = (1ULL << bit | CEPH_FEATURE_INCARNATION_##incarnation);

// this bit is ignored but still advertised by release *when*
#define DEFINE_CEPH_FEATURE_DEPRECATED(bit, incarnation, name, when)      \
    const static uint64_t DEPRECATED_CEPH_FEATURE_##name = (1ULL << bit); \
    const static uint64_t DEPRECATED_CEPH_FEATUREMASK_##name = (1ULL << bit | CEPH_FEATURE_INCARNATION_##incarnation);
...
#define HAVE_FEATURE(x, name) (((x) & (CEPH_FEATUREMASK_##name)) == (CEPH_FEATUREMASK_##name))
...
#define CEPH_FEATURES_ALL                                                                                            \
    (CEPH_FEATURE_UID | CEPH_FEATURE_NOSRCADDR | CEPH_FEATURE_FLOCK | CEPH_FEATURE_SUBSCRIBE2 |                      \
     CEPH_FEATURE_MONNAMES | CEPH_FEATURE_RECONNECT_SEQ | CEPH_FEATURE_DIRLAYOUTHASH | CEPH_FEATURE_OBJECTLOCATOR |  \
     CEPH_FEATURE_PGID64 | CEPH_FEATURE_INCSUBOSDMAP | CEPH_FEATURE_PGPOOL3 | CEPH_FEATURE_OSDREPLYMUX |             \
     CEPH_FEATURE_OSDENC | CEPH_FEATURE_MONENC | CEPH_FEATURE_CRUSH_TUNABLES | CEPH_FEATURE_MSG_AUTH |               \
     CEPH_FEATURE_CRUSH_TUNABLES2 | CEPH_FEATURE_CREATEPOOLID | CEPH_FEATURE_REPLY_CREATE_INODE |                    \
     CEPH_FEATURE_MDSENC | CEPH_FEATURE_OSDHASHPSPOOL | CEPH_FEATURE_NEW_OSDOP_ENCODING |                            \
     CEPH_FEATURE_NEW_OSDOPREPLY_ENCODING | CEPH_FEATURE_OSD_CACHEPOOL | CEPH_FEATURE_CRUSH_V2 |                     \
     CEPH_FEATURE_EXPORT_PEER | CEPH_FEATURE_OSDMAP_ENC | CEPH_FEATURE_MDS_INLINE_DATA |                             \
     CEPH_FEATURE_CRUSH_TUNABLES3 | CEPH_FEATURE_OSD_PRIMARY_AFFINITY | CEPH_FEATURE_MSGR_KEEPALIVE2 |               \
     CEPH_FEATURE_OSD_POOLRESEND | CEPH_FEATURE_OSD_FADVISE_FLAGS | CEPH_FEATURE_MDS_QUOTA | CEPH_FEATURE_CRUSH_V4 | \
     CEPH_FEATURE_MON_STATEFUL_SUB | CEPH_FEATURE_CRUSH_TUNABLES5 | CEPH_FEATURE_SERVER_JEWEL |                      \
     CEPH_FEATURE_FS_FILE_LAYOUT_V2 | CEPH_FEATURE_SERVER_KRAKEN | CEPH_FEATURE_FS_BTIME |                           \
     CEPH_FEATURE_FS_CHANGE_ATTR | CEPH_FEATURE_MSG_ADDR2 | CEPH_FEATURE_SERVER_LUMINOUS |                           \
     CEPH_FEATURE_RESEND_ON_SPLIT | CEPH_FEATURE_RADOS_BACKOFF | CEPH_FEATURE_OSD_RECOVERY_DELETES |                 \
     CEPH_FEATURE_SERVER_MIMIC | CEPH_FEATURE_RECOVERY_RESERVATION_2 | CEPH_FEATURE_SERVER_NAUTILUS |                \
     CEPH_FEATURE_CEPHX_V2 | CEPH_FEATURE_OSD_PGLOG_HARDLIMIT | CEPH_FEATUREMASK_SERVER_OCTOPUS |                    \
     CEPH_FEATUREMASK_STRETCH_MODE | CEPH_FEATUREMASK_OSD_REPOP_MLCOD | CEPH_FEATUREMASK_SERVER_PACIFIC |            \
     CEPH_FEATURE_OSD_FIXED_COLLECTION_LIST | CEPH_FEATUREMASK_SERVER_QUINCY | CEPH_FEATURE_RANGE_BLOCKLIST |        \
     CEPH_FEATUREMASK_SERVER_REEF | 0ULL)
...
#define CEPH_FEATURES_CRUSH                                                                      \
    (CEPH_FEATURE_CRUSH_TUNABLES | CEPH_FEATURE_CRUSH_TUNABLES2 | CEPH_FEATURE_CRUSH_TUNABLES3 | \
     CEPH_FEATURE_CRUSH_TUNABLES5 | CEPH_FEATURE_CRUSH_V2 | CEPH_FEATURE_CRUSH_V4 |              \
