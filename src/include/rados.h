...
static inline int ceph_fsid_compare(const struct ceph_fsid* a, const struct ceph_fsid* b)
{
...
#define CEPH_OSDMAP_SEMIHIDDEN_FLAGS                                                         \
    (CEPH_OSDMAP_REQUIRE_JEWEL | CEPH_OSDMAP_REQUIRE_KRAKEN | CEPH_OSDMAP_REQUIRE_LUMINOUS | \
     CEPH_OSDMAP_RECOVERY_DELETES | CEPH_OSDMAP_SORTBITWISE | CEPH_OSDMAP_PURGED_SNAPDIRS |  \
     CEPH_OSDMAP_PGLOG_HARDLIMIT)
#define CEPH_OSDMAP_LEGACY_REQUIRE_FLAGS \
    (CEPH_OSDMAP_REQUIRE_JEWEL | CEPH_OSDMAP_REQUIRE_KRAKEN | CEPH_OSDMAP_REQUIRE_LUMINOUS)
...
#define __CEPH_OSD_OP1(mode, nr) (CEPH_OSD_OP_MODE_##mode | (nr))

#define __CEPH_OSD_OP(mode, type, nr) (CEPH_OSD_OP_MODE_##mode | CEPH_OSD_OP_TYPE_##type | (nr))

#define __CEPH_FORALL_OSD_OPS(f)                                                                                       \
    /** data **/                                                                                                       \
    /* read */                                                                                                         \
    f(READ, __CEPH_OSD_OP(RD, DATA, 1), "read") f(STAT, __CEPH_OSD_OP(RD, DATA, 2), "stat")                            \
        f(MAPEXT, __CEPH_OSD_OP(RD, DATA, 3), "mapext") f(CHECKSUM, __CEPH_OSD_OP(RD, DATA, 31), "checksum")           \
                                                                                                                       \
        /* fancy read */                                                                                               \
        ...
        f(SYNC_READ, __CEPH_OSD_OP(RD, DATA, 11), "sync_read")                                                         \
                                                                                                                       \
        /* write */                                                                                                    \
        f(WRITE, __CEPH_OSD_OP(WR, DATA, 1), "write") f(WRITEFULL, __CEPH_OSD_OP(WR, DATA, 2), "writefull")            \
            f(TRUNCATE, __CEPH_OSD_OP(WR, DATA, 3), "truncate") f(ZERO, __CEPH_OSD_OP(WR, DATA, 4), "zero")            \
                f(DELETE, __CEPH_OSD_OP(WR, DATA, 5), "delete")                                                        \
                                                                                                                       \
        /* fancy write */                                                                                              \
        f(APPEND, __CEPH_OSD_OP(WR, DATA, 6), "append") f(STARTSYNC, __CEPH_OSD_OP(WR, DATA, 7), "startsync")          \
            f(SETTRUNC, __CEPH_OSD_OP(WR, DATA, 8), "settrunc") f(TRIMTRUNC, __CEPH_OSD_OP(WR, DATA, 9), "trimtrunc")  \
                                                                                                                       \
                f(TMAPUP, __CEPH_OSD_OP(RMW, DATA, 10), "tmapup") f(TMAPPUT, __CEPH_OSD_OP(WR, DATA, 11), "tmapput")   \
        ...
        f(COPY_FROM, __CEPH_OSD_OP(WR, DATA, 26), "copy-from")                                                         \
            f(COPY_FROM2, __CEPH_OSD_OP(WR, DATA, 45), "copy-from2") /* was copy-get-classic */                        \
        f(UNDIRTY, __CEPH_OSD_OP(WR, DATA, 28), "undirty") f(ISDIRTY, __CEPH_OSD_OP(RD, DATA, 29), "isdirty")          \
        ...
        f(CACHE_PIN, __CEPH_OSD_OP(WR, DATA, 36), "cache-pin")                                                         \
            f(CACHE_UNPIN, __CEPH_OSD_OP(WR, DATA, 37), "cache-unpin")                                                 \
                                                                                                                       \
        /* ESX/SCSI */                                                                                                 \
        f(WRITESAME, __CEPH_OSD_OP(WR, DATA, 38), "write-same") f(CMPEXT, __CEPH_OSD_OP(RD, DATA, 32), "cmpext")       \
                                                                                                                       \
        /* Extensible */                                                                                               \
                    ...
                    f(UNSET_MANIFEST, __CEPH_OSD_OP(WR, DATA, 42), "unset-manifest")                                   \
                        f(TIER_FLUSH, __CEPH_OSD_OP(CACHE, DATA, 43), "tier-flush")                                    \
                            f(TIER_EVICT, __CEPH_OSD_OP(CACHE, DATA, 44), "tier-evict")                                \
                                                                                                                       \
        /** attrs **/ /* read */                                                                                       \
        f(GETXATTR, __CEPH_OSD_OP(RD, ATTR, 1), "getxattr") f(GETXATTRS, __CEPH_OSD_OP(RD, ATTR, 2), "getxattrs")      \
            f(CMPXATTR, __CEPH_OSD_OP(RD, ATTR, 3), "cmpxattr")                                                        \
                                                                                                                       \
        /* write */                                                                                                    \
        f(SETXATTR, __CEPH_OSD_OP(WR, ATTR, 1), "setxattr") f(SETXATTRS, __CEPH_OSD_OP(WR, ATTR, 2), "setxattrs")      \
            f(RESETXATTRS, __CEPH_OSD_OP(WR, ATTR, 3), "resetxattrs")                                                  \
                f(RMXATTR, __CEPH_OSD_OP(WR, ATTR, 4), "rmxattr")                                                      \
                                                                                                                       \
        /** subop **/                                                                                                  \
        f(PULL, __CEPH_OSD_OP1(SUB, 1), "pull") f(PUSH, __CEPH_OSD_OP1(SUB, 2), "push")                                \
            f(BALANCEREADS, __CEPH_OSD_OP1(SUB, 3), "balance-reads")                                                   \
                f(UNBALANCEREADS, __CEPH_OSD_OP1(SUB, 4), "unbalance-reads") f(SCRUB, __CEPH_OSD_OP1(SUB, 5), "scrub") \
                    f(SCRUB_RESERVE, __CEPH_OSD_OP1(SUB, 6), "scrub-reserve")                                          \
                        f(SCRUB_UNRESERVE, __CEPH_OSD_OP1(SUB, 7), "scrub-unreserve") /* 8 used to be scrub-stop */    \
        f(SCRUB_MAP, __CEPH_OSD_OP1(SUB, 9), "scrub-map")                                                              \
                                                                                                                       \
        /** exec **/ /* note: the RD bit here is wrong; see special-case below in helper */                            \
        f(CALL, __CEPH_OSD_OP(RD, EXEC, 1), "call")                                                                    \
                                                                                                                       \
        /** pg **/                                                                                                     \
        f(PGLS, __CEPH_OSD_OP(RD, PG, 1), "pgls") f(PGLS_FILTER, __CEPH_OSD_OP(RD, PG, 2), "pgls-filter")              \
...
{
    return (op & CEPH_OSD_OP_MODE_RD) && op != CEPH_OSD_OP_CALL;
}
...
static inline bool ceph_osd_op_uses_extent(int op)
{
    ...
    case CEPH_OSD_OP_CMPEXT: return true;
...
enum
{
    ...
    CEPH_OSD_FLAG_RETURNVEC =
        0x4000000, /* allow overall result >= 0, and return >= 0 and buffer for each op in opvec */
 ...
 */
#ifdef __cplusplus
static_assert(sizeof(ceph_osd_op) == (2 + 4 + (2 * 8 + 8 + 4) + 4), "sizeof(ceph_osd_op) breaks the compatibility");
#endif
