...
#define RBD_FEATURES_DEFAULT                                                                              \
    (RBD_FEATURE_LAYERING | RBD_FEATURE_EXCLUSIVE_LOCK | RBD_FEATURE_OBJECT_MAP | RBD_FEATURE_FAST_DIFF | \
...
#define RBD_FEATURES_INCOMPATIBLE \
    (RBD_FEATURE_LAYERING | RBD_FEATURE_STRIPINGV2 | RBD_FEATURE_DATA_POOL | RBD_FEATURE_DIRTY_CACHE)

/// features that make an image unwritable by clients that don't understand them
#define RBD_FEATURES_RW_INCOMPATIBLE                                                                           \
    (RBD_FEATURES_INCOMPATIBLE | RBD_FEATURE_EXCLUSIVE_LOCK | RBD_FEATURE_OBJECT_MAP | RBD_FEATURE_FAST_DIFF | \
     RBD_FEATURE_DEEP_FLATTEN | RBD_FEATURE_JOURNALING | RBD_FEATURE_OPERATIONS | RBD_FEATURE_MIGRATING |      \
     RBD_FEATURE_NON_PRIMARY)

#define RBD_FEATURES_ALL                                                                                   \
    (RBD_FEATURE_LAYERING | RBD_FEATURE_STRIPINGV2 | RBD_FEATURE_EXCLUSIVE_LOCK | RBD_FEATURE_OBJECT_MAP | \
     RBD_FEATURE_FAST_DIFF | RBD_FEATURE_DEEP_FLATTEN | RBD_FEATURE_JOURNALING | RBD_FEATURE_DATA_POOL |   \
     RBD_FEATURE_OPERATIONS | RBD_FEATURE_MIGRATING | RBD_FEATURE_NON_PRIMARY | RBD_FEATURE_DIRTY_CACHE)

/// features that may be dynamically enabled or disabled
#define RBD_FEATURES_MUTABLE                                                                                \
    (RBD_FEATURE_EXCLUSIVE_LOCK | RBD_FEATURE_OBJECT_MAP | RBD_FEATURE_FAST_DIFF | RBD_FEATURE_JOURNALING | \
     RBD_FEATURE_NON_PRIMARY | RBD_FEATURE_DIRTY_CACHE)

#define RBD_FEATURES_MUTABLE_INTERNAL (RBD_FEATURE_NON_PRIMARY | RBD_FEATURE_DIRTY_CACHE)
...
#define RBD_FEATURES_SINGLE_CLIENT                                                                          \
    (RBD_FEATURE_EXCLUSIVE_LOCK | RBD_FEATURE_OBJECT_MAP | RBD_FEATURE_FAST_DIFF | RBD_FEATURE_JOURNALING | \
     RBD_FEATURE_DIRTY_CACHE)

/// features that will be implicitly enabled
#define RBD_FEATURES_IMPLICIT_ENABLE                                                                   \
    (RBD_FEATURE_STRIPINGV2 | RBD_FEATURE_DATA_POOL | RBD_FEATURE_FAST_DIFF | RBD_FEATURE_OPERATIONS | \
     RBD_FEATURE_MIGRATING | RBD_FEATURE_NON_PRIMARY | RBD_FEATURE_DIRTY_CACHE)

/// features that cannot be controlled by the user
#define RBD_FEATURES_INTERNAL (RBD_FEATURE_OPERATIONS | RBD_FEATURE_MIGRATING)
...
#define RBD_OPERATION_FEATURES_ALL                                                                          \
    (RBD_OPERATION_FEATURE_CLONE_PARENT | RBD_OPERATION_FEATURE_CLONE_CHILD | RBD_OPERATION_FEATURE_GROUP | \
