...
std::list<std::string> get_str_list(const std::string& str, const char* delims = ";,= \t");
 ...
 * @param [out] str_vec Vector modified containing str after it has been split
 **/
void get_str_vec(std::string_view str, const char* delims, std::vector<std::string>& str_vec);

std::vector<std::string> get_str_vec(std::string_view str, const char* delims = ";,= \t");
