...
public:
    ...
    public:
        ...
        friend bool operator==(const iterator& lhs, const iterator& rhs) { return lhs.cur == rhs.cur; }
        friend bool operator!=(const iterator& lhs, const iterator& rhs) { return lhs.cur != rhs.cur; }
    };
    ...
    public:
        ...
        bool end() const { return cur == 0; }
        friend bool operator==(const const_iterator& lhs, const const_iterator& rhs) { return lhs.cur == rhs.cur; }
        friend bool operator!=(const const_iterator& lhs, const const_iterator& rhs) { return lhs.cur != rhs.cur; }
    };
