...
template<typename T, typename U> constexpr inline std::make_unsigned_t<std::common_type_t<T, U>> div_round_up(T n, U d)
{
    return (n + d - 1) / d;
}


template<typename T, typename U> constexpr inline std::make_unsigned_t<std::common_type_t<T, U>> round_up_to(T n, U d)
{
 ...
 */
template<typename T> constexpr inline T p2align(T x, T align)
{
    return x & -align;
}
 ...
 */
template<typename T> constexpr inline T p2phase(T x, T align)
{
    return x & (align - 1);
}
 ...
 */
template<typename T> constexpr inline T p2nphase(T x, T align)
{
    return -x & (align - 1);
}
 ...
 */
template<typename T> constexpr inline T p2roundup(T x, T align)
{
    return -(-x & -align);
}
