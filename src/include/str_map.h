...
template<typename Func> void for_each_pair(std::string_view s, const char* delims, Func&& f)
{
 ...
 */
int get_json_str_map(const std::string& str, std::ostream& ss, str_map_t* str_map, bool fallback_to_plain = true);
 ...
 * @return **0**
 */
int get_str_map(const std::string& str, str_map_t* str_map, const char* delims = CONST_DELIMS);
 ...
 */
std::string get_str_map_value(const str_map_t& str_map, const std::string& key, const std::string* def_val = nullptr);
 ...
 *                    in **str_map**
 */
std::string get_str_map_key(const str_map_t& str_map, const std::string& key,
...
// original "m = { 'VALUE' : '' }".
int get_conf_str_map_helper(const std::string& str, std::ostringstream& oss, str_map_t* str_map,
                            const std::string& default_key);

std::string get_value_via_strmap(const std::string& conf_string, std::string_view default_key);

std::string get_value_via_strmap(const std::string& conf_string, const std::string& key, std::string_view default_key);
