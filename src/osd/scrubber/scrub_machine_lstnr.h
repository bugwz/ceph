...
{
    blocked_range_t(OSDService* osds, ceph::timespan waittime, ScrubMachineListener& scrubber, spg_t pg_id);
    ~blocked_range_t();
...
struct ScrubMachineListener
{
     ...
     */
    [[nodiscard]] virtual MsgAndEpoch prep_replica_map_msg(Scrub::PreemptionNoted was_preempted) = 0;
