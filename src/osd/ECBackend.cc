...
void ECBackend::handle_recovery_push(const PushOp& op, RecoveryMessages* m, bool is_repair)
{
    ...
    if (op.after_progress.data_complete) {
        if ((get_parent()->pgb_is_primary())) {
            ...
            if (get_parent()->pg_is_repair() || is_repair) get_parent()->inc_osd_stat_repaired();
...
void ECBackend::handle_recovery_read_complete(const hobject_t& hoid,
                                              ...
                                              std::optional<map<string, bufferlist, less<>>> attrs, RecoveryMessages* m)
{
...
ECUtil::HashInfoRef ECBackend::get_hash_info(const hobject_t& hoid, bool create,
                                             const map<string, bufferptr, less<>>* attrs)
{
...
int ECBackend::objects_get_attrs(const hobject_t& hoid, map<string, bufferlist, less<>>* out)
{
