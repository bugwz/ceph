...
struct BackfillInterval
{
    ...
    /// clear content
    void clear() { *this = BackfillInterval(); }
    ...
    bool extends_to_end() const { return end.is_max(); }
    ...
    void dump(ceph::Formatter* f) const
    {
        ...
        for (std::map<hobject_t, eversion_t>::const_iterator i = objects.begin(); i != objects.end(); ++i) {
