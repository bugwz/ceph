...
struct FuturizedStoreLogReader
{
    ...
    seastar::future<> read(crimson::os::CollectionRef ch, ghobject_t pgmeta_oid)
    {
        ...
        return store.get_omap_iterator(ch, pgmeta_oid)
            .then([this](auto iter) {
...
seastar::future<> PGLog::read_log_and_missing_crimson(crimson::os::FuturizedStore& store, crimson::os::CollectionRef ch,
                                                      ...
                                                      const DoutPrefixProvider* dpp)
{
    ...
    return seastar::do_with(FuturizedStoreLogReader{store, info, log, log_keys_debug, missing, dpp},
                            [ch, pgmeta_oid](FuturizedStoreLogReader& reader) { return reader.read(ch, pgmeta_oid); });
}
