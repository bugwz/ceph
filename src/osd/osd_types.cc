...
bool operator==(const pg_stat_t& l, const pg_stat_t& r)
{
    return l.version == r.version && l.reported_seq == r.reported_seq && l.reported_epoch == r.reported_epoch &&
           ...
           l.ondisk_log_size == r.ondisk_log_size && l.up == r.up && l.acting == r.acting &&
           l.avail_no_missing == r.avail_no_missing && l.object_location_counts == r.object_location_counts &&
           l.mapping_epoch == r.mapping_epoch && l.blocked_by == r.blocked_by &&
           l.last_became_active == r.last_became_active && l.last_became_peered == r.last_became_peered &&
           l.dirty_stats_invalid == r.dirty_stats_invalid && l.omap_stats_invalid == r.omap_stats_invalid &&
...
void object_info_t::dump(Formatter* f) const
{
    ...
    for (auto str : sv) f->dump_string("flags", str);
    f->close_section();
