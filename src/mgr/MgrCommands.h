...
COMMAND("pg dump_json "
        ...
        "show human-readable version of pg map in json only", "pg", "r")
COMMAND("pg dump_pools_json", "show pg pools info in json only", "pg", "r")
...
COMMAND("pg dump_stuck "
        ...
        "show information about stuck pgs", "pg", "r")
COMMAND("pg debug "
        "name=debugop,type=CephChoices,strings=unfound_objects_exist|degraded_pgs_exist",
        "show debug info about pgs", "pg", "r")

COMMAND("pg scrub name=pgid,type=CephPgid", "start scrub on <pgid>", "pg", "rw")
COMMAND("pg deep-scrub name=pgid,type=CephPgid", "start deep-scrub on <pgid>", "pg", "rw")
COMMAND("pg repair name=pgid,type=CephPgid", "start repair on <pgid>", "pg", "rw")

COMMAND("pg force-recovery name=pgid,type=CephPgid,n=N", "force recovery of <pgid> first", "pg", "rw")
COMMAND("pg force-backfill name=pgid,type=CephPgid,n=N", "force backfill of <pgid> first", "pg", "rw")
COMMAND("pg cancel-force-recovery name=pgid,type=CephPgid,n=N", "restore normal recovery priority of <pgid>", "pg",
        "rw")
COMMAND("pg cancel-force-backfill name=pgid,type=CephPgid,n=N", "restore normal backfill priority of <pgid>", "pg",
        "rw")
...
COMMAND("osd blocked-by", "print histogram of which OSDs are blocking their peers", "osd", "r")
COMMAND("osd pool stats "
        "name=pool_name,type=CephPoolname,req=false",
        "obtain stats from all pools, or from specified pool", "osd", "r")
COMMAND("osd pool scrub "
        "name=who,type=CephPoolname,n=N",
        "initiate scrub on pool <who>", "osd", "rw")
COMMAND("osd pool deep-scrub "
        "name=who,type=CephPoolname,n=N",
        "initiate deep-scrub on pool <who>", "osd", "rw")
COMMAND("osd pool repair "
        "name=who,type=CephPoolname,n=N",
        "initiate repair on pool <who>", "osd", "rw")
COMMAND("osd pool force-recovery "
        "name=who,type=CephPoolname,n=N",
        "force recovery of specified pool <who> first", "osd", "rw")
COMMAND("osd pool force-backfill "
        "name=who,type=CephPoolname,n=N",
        "force backfill of specified pool <who> first", "osd", "rw")
COMMAND("osd pool cancel-force-recovery "
        "name=who,type=CephPoolname,n=N",
        "restore normal recovery priority of specified pool <who>", "osd", "rw")
...
COMMAND("osd reweight-by-utilization "
        ...
        "reweight OSDs by utilization [overload-percentage-for-consideration, default 120]", "osd", "rw")
COMMAND("osd test-reweight-by-utilization "
        "name=oload,type=CephInt,req=false "
        "name=max_change,type=CephFloat,req=false "
        "name=max_osds,type=CephInt,req=false "
        "name=no_increasing,type=CephBool,req=false",
        "dry run of reweight OSDs by utilization [overload-percentage-for-consideration, default 120]", "osd", "r")
COMMAND("osd reweight-by-pg "
        "name=oload,type=CephInt,req=false "
        "name=max_change,type=CephFloat,req=false "
        "name=max_osds,type=CephInt,req=false "
        "name=pools,type=CephPoolname,n=N,req=false",
        "reweight OSDs by PG distribution [overload-percentage-for-consideration, default 120]", "osd", "rw")
COMMAND("osd test-reweight-by-pg "
        "name=oload,type=CephInt,req=false "
        "name=max_change,type=CephFloat,req=false "
        "name=max_osds,type=CephInt,req=false "
        "name=pools,type=CephPoolname,n=N,req=false",
        "dry run of reweight OSDs by PG distribution [overload-percentage-for-consideration, default 120]", "osd", "r")
...
COMMAND("osd safe-to-destroy name=ids,type=CephString,n=N",
        "check whether osd(s) can be safely destroyed without reducing data durability", "osd", "r")
...
COMMAND("osd scrub "
        ...
        "initiate scrub on osd <who>, or use <all|any> to scrub all", "osd", "rw")
COMMAND("osd deep-scrub "
        "name=who,type=CephString",
        "initiate deep scrub on osd <who>, or use <all|any> to deep scrub all", "osd", "rw")
COMMAND("osd repair "
        "name=who,type=CephString",
        "initiate repair on osd <who>, or use <all|any> to repair all", "osd", "rw")

COMMAND("service dump", "dump service map", "service", "r")
COMMAND("service status", "dump service state", "service", "r")

COMMAND("config show "
        "name=who,type=CephString name=key,type=CephString,req=false",
        "Show running configuration", "mgr", "r")
COMMAND("config show-with-defaults "
        "name=who,type=CephString",
        "Show running configuration (including compiled-in defaults)", "mgr", "r")

COMMAND("device ls", "Show devices", "mgr", "r")
COMMAND("device info name=devid,type=CephString", "Show information about a device", "mgr", "r")
COMMAND("device ls-by-daemon name=who,type=CephString", "Show devices associated with a daemon", "mgr", "r")
COMMAND("device ls-by-host name=host,type=CephString", "Show devices on a host", "mgr", "r")
COMMAND("device set-life-expectancy name=devid,type=CephString "
        "name=from,type=CephString "
        "name=to,type=CephString,req=false",
        "Set predicted device life expectancy", "mgr", "rw")
COMMAND("device rm-life-expectancy name=devid,type=CephString", "Clear predicted device life expectancy", "mgr", "rw")
