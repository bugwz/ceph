...
public:
    ActivePyModule(const PyModuleRef& py_module_, LogChannelRef clog_)
    ...
    PyObject* dispatch_remote(const std::string& method, PyObject* args, PyObject* kwargs, std::string* err);
    ...
    void set_uri(const std::string& str) { uri = str; }

    std::string get_uri() const { return uri; }

    std::string get_fin_thread_name() const { return fin_thread_name; }
