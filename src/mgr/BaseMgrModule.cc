...
static PyObject* ceph_set_health_checks(BaseMgrModule* self, PyObject* args)
{
    ...
    *_dout << dendl;
    ...
    PyThreadState* tstate = PyEval_SaveThread();
    self->py_modules->set_health_checks(self->this_module->get_name(), std::move(out_checks));
    PyEval_RestoreThread(tstate);
...
PyMethodDef BaseMgrModule_methods[] = {
    ...
    {"_ceph_add_mds_perf_query", (PyCFunction)ceph_add_mds_perf_query, METH_VARARGS, "Add an osd perf query"},
    ...
    {"_ceph_get_mds_perf_counters", (PyCFunction)ceph_get_mds_perf_counters, METH_VARARGS, "Get osd perf counters"},
