...
for i in $(seq 1 10); do
    for DELAY in 0 1000; do
        for OPS in 1000 10000; do
            for OBJECTS in 10 50 100; do
                for READS in 0.90 0.50 0.10; do
                    for OP_SIZE in 4096 131072 1048576; do
                        for MAX_DIRTY in 0 25165824; do
